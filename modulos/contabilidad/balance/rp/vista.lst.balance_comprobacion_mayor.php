...
if(isset($_GET[fecha]))
{
	...
	$where="where	saldo_contable.ano=$ayo
			and	cuenta_contable_contabilidad.tipo='t'
	";	
}
else
{
	...
	//************************************************************************
				class PDF extends PDF_Code128
				{
					...
					{	
						...
						$this->Cell(0,10,'LIBRO MAYOR AL'."  "."AL"." ".$fecha ,0,0,'C');
						$this->Ln(10);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$row->MoveNext();
		...
		$pdf->SetFont('arial','B',6);
		$pdf->Cell(73,6,'TOTAL MOVIMIENTO DEL MES ',					0,0,'L',1);
		$pdf->SetFont('arial','',6);
		$pdf->Cell(24,6,				number_format($as,2,",","."),0,0,'R',1);
