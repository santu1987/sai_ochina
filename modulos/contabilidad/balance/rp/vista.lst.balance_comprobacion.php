...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
	...
	$med3=$med3-2;
	$saldo_inicio=substr($row->fields("saldo_inicio"),1,$med3);
	...
	*///-
	...
	$saldo_vector2=$saldo_vector[$mes_ant];
	if(($row->fields("codigo")=='P   ') ||($row->fields("codigo")=='PAT ')or($row->fields("codigo")=='I   '))
		{
			//$total_cuenta_debe_haber=$haber_total-$debe_total;
			//las variables q sean pasivos deben ir negativas en el balance modificacion:15/02/2012
	...
	//calculando el monto del debito y credito del mes	
		...
		$debe_total2=$debe_vector[$mes_ant];
		$haber_total2=$haber_vector[$mes_ant];
	...
	$valor_comparacion=$debe_total2+$haber_total2+$saldo_vector2;	
	//	$saldo_mes=$debe_total2-$haber_total2;
		//FALTA CC,CO 
	//-	SALDO ACTUAL
...
$suma=0;
//
	if(($row->fields("cuenta_contable")=='199999999')and($row->fields("cuenta_contable")=='3999999999')and($row->fields("cuenta_contable")=='599999999')and($row->fields("cuenta_contable")=='699999999'))
	{
	/// CREANDO EL total cuadre detalle: acumulando los valores por columna
	$as=$as+$saldo_vector2;
	$as2=$as2+$debe_total2;
	$as3=$as3+$haber_total2;
	$as4=$as4+$saldo_mes;
	$as5=$as5+$saldo_actual;
	//////
	}
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$suma=0;
	$valor_comparacion=0;
	//si el tipo de comprobante es de total no mostrar cuenta
	$tipo_cuenta_cnt=$row->fields("tipo");
	//desbloquear
	if($tipo_cuenta_cnt=='t')
	{
		$cuenta_cont="";
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/}
	...
	$row->MoveNext();
		...
		/* TOTAL CUADRE DETALLE*/
		$pdf->SetFont('Times','B',6);
		$pdf->Cell(73,6,'TOTAL CUADRE DETALLE',					0,0,'L',1);
		$pdf->SetFont('Times','',6);
		$pdf->Cell(23,6,				number_format($as,2,",","."),0,0,'R',1);
		$pdf->Cell(24,6,				number_format($as2,2,",","."),	0,0,'R',1);
		$pdf->Cell(24,6,				number_format($as3,2,",","."),	0,0,'R',1);
		$pdf->Cell(24,6,				number_format($as4,2,",","."),	0,0,'R',1);
		$pdf->Cell(23,6,				number_format($as5,2,",",".")	,	0,0,'R',1);
