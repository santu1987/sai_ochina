...
//-
	...
	///proceso para ubicar en las columnas  los valores
	if($tipos=='t')
	{
		$sub_total=$total_cuenta_debe_haber;
		$total_cuenta_debe_haber="";
		$total="";
	}
...
////////////////////////////////////////////////////
	...
	{*/	
		...
		$pdf->Cell(40,6,				$total_cuenta_debe_haber,	0,0,'L',1);
		$pdf->Cell(40,6,				$sub_total,	0,0,'L',1);
		$pdf->Cell(40,6,				$total,	0,0,'L',1);
	//}	
