	...
	//************************************************************************
				class PDF extends PDF_Code128
				{
					...
					{	
						...
						$this->Cell(0,10,'BALANCE DE SALDOS'."  "."AL"." ".$fecha ,0,0,'C');
						$this->Ln(10);
						...
						$this->Cell(110,6,		     'DESCRIPCION',			0,0,'L',1);
						$this->Cell(40,6,			 'SALDO ACTUAL',		0,0,'L',1);
...
////////////////////////////////////////////////////
	...
	{*/	
		...
		$pdf->Cell(110,6,				substr(strtoupper($row->fields("nombre")),0,80),					0,0,'L',1);
