...
///// consulta1
$sql_estatus="SELECT 
distinct(movimientos_contables.numero_comprobante),estatus,movimientos_contables.id_movimientos_contables,id_tipo_comprobante,fecha_comprobante
										...
										$row_sumas=& $conn->Execute($sql_sumas);
										   ...
										   {	
												...
												and
															movimientos_contables.estatus!='3'	
												ORDER BY 
													 movimientos_contables.id_movimientos_contables";//die($sql_tipo);
			...
			$.ajax ({
						...
						success: function(html)
						{
							...
							if((recordset[0]!="error")&&(recordset[0]!="vacio"))
							{
								...
								comprobante=getObj('contabilidad_comp_pr_tipo').value+getObj('contabilidad_comp_pr_numero_comprobante').value;
	...
	(
		{
			...
			function(data)
			{
							...
							jQuery("#list_grid_"+nd).jqGrid
	 						({
								...
								colModel:[
										...
										{name:'numero_comprobante2',index:'numero_comprobante2', width:20,hidden:true},
										...
										{name:'resta',index:'resta',width:50},
				...
				getObj('contabilidad_comp_pr_numero_comprobante').value =ret.numero_comprobante2;
				numero_Comprobante=ret.numero_comprobante;
...
$("#contabilidad_movimientos_contables_rp_imprimir").click(function()
 {
		...
		desde_numero=getObj('contabilidad_comp_pr_tipo').value+getObj('contabilidad_comp_pr_numero_comprobante').value;
		hasta_numero=getObj('contabilidad_comp_pr_tipo').value+getObj('contabilidad_comp_pr_numero_comprobante').value;
...
-->			 </li>
	...
	<tr>
		...
		<tr>
			...
			jvalkey="{valid:/[0-9a-zA-Z_]/, cFunc:'alert', cArgs:['Clave: '+$(this).val()]}" />
	...
	<table  cols="4" class="cuerpo_formulario" width="100%" border="0">
				...
				<tr>
					...
					<ul class="input_con_emergente">
					 <li>	
					<input name="contabilidad_comp_pr_auxiliar" type="text" id="contabilidad_comp_pr_auxiliar"   value="" size="12" maxlength="12" message="Introduzca el c&oacute;digo del auxiliar' "   onblur="auxiliares_consulta_mov()"
					/> 
				...
				<tr>
					...
					<ul class="input_con_emergente">
					<li>
					<input name="contabilidad_comp_pr_centro_costo" type="text" id="contabilidad_comp_pr_centro_costo"   value="" size="12" maxlength="12" message="Introduzca el centro de costo' "   onblur="consulta_proyecto_mov();"
										/>	
				...
				<li id="contabilidad_comprobante_btn_consultar_utf" class="btn_consulta_emergente"></li>
					...
					<ul class="input_con_emergente">
					<li>
					  <input name="contabilidad_comp_pr_acc" type="text" id="contabilidad_comp_pr_acc"   value="" size="12" maxlength="12" message="Introduzca el c&oacute;digo de Utilizaci&oacute;n de fondos'" onblur="consulta_acc_mov()" 
										/>
					...
					<td>
						 <input  type="text" name="contabilidad_comp_pr_dif" id="contabilidad_comp_pr_dif"  readonly="readonly" size="12" maxlength="12"  value="<? echo($resta);?>"/>
					</td>
		</tr>
