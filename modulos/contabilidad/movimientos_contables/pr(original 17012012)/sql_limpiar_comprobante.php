...
/////////////////////////////////////////////////////////////
				...
				if(!$sidx) $sidx =1;
					...
					$sql_estatus="SELECT 
									movimientos_contables.estatus,movimientos_contables.numero_comprobante,movimientos_contables.id_tipo_comprobante,codigo_tipo_comprobante,mes_comprobante				
								FROM 
...
//die($row->fields("estatus"));
						if($row->fields("estatus")=='0')
						{
							...
							and	
								mes_comprobante='$mes_comprobante'
							and
								estatus!='3'
				...
				////////////////////////////////--------------------------------------------------------------------------
					if($compro!='0')
						{	
							...
							$responce=$comprobante2."*".$debe."*".$haber."*".$tipo."*".$codigo_tipo."*".$resta."*".$descripcion."*".$fecha."*".$comprobante;
