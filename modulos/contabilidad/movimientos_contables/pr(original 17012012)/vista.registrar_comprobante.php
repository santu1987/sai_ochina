...
<input type="hidden" id="contabilidad_comp_pr_activo" name="contabilidad_comp_pr_activo"  value="0"/>
 ...
 <input type="hidden" id="contabilidad_comp_pr_activo3" name="contabilidad_comp_pr_activo3" value="0"/>
  ...
  <table   class="cuerpo_formulario">
	<tr>
	<th class="titulo_frame" colspan="4"><img src="imagenes/iconos/desktop24x24.png" style=" padding-right:5px;" align="absmiddle" />Mantenimiento Comprobante
...
-->			 </li>
	...
	<table  cols="4" class="cuerpo_formulario" width="100%" border="0">
		...
		<tr style="display:none">
				...
				<td colspan="3">
					<input type="text" name="contabilidad_comp_filtrar" id="contabilidad_comp_filtrar" disabled="disabled" />
				</td>
		</tr>			
	</table>
