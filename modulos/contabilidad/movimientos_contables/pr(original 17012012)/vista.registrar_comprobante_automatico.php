						...
						function crear_grid()
						{
							jQuery("#list_grid_"+nd).jqGrid
	 						({
								...
								datatype: "json",
								colNames:['Id','Organismo','A&ntilde;o','Mes','tipo','Comprobante','Secuencia','Comentarios','Cuenta Contable','Desc2','Desc','REF','Debito','Credito','Fecha Comprobante','CodAux','CodUbic','Codcost','CodUFondos','codigo_tipo_comp','id_cc','ejecutora','utf','auxiliar','codigo_proyecto','id_acc','cod_acc','r_aux','r_ejec','r_proy','r_uft','monto_dif','nocomp2'],
								colModel:[
