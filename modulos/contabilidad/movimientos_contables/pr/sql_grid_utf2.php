...
$sidx = $_GET['sidx'];
$sord = $_GET['sord'];
$codigo_utf=$_POST[contabilidad_comprobante_pr_utf];
//************************************************************************
...
$limit = 15;
$where="AND cuenta_utilizacion_fondos='$codigo_utf'";
if(!$sidx) $sidx =1;
...
$responce =$row->fields("id_utilizacion_fondos")."*".$row->fields("cuenta_utilizacion_fondos")."*".strtoupper($row->fields("nombre"));	
}else
$responce="vacio";
