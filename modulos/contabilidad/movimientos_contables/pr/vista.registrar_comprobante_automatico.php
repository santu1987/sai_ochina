	...
	(
		{
			...
			function(data)
			{
				...
				{ 
					...
					var tipo=getObj('consulta_comprobante_tipo').value;
				jQuery("#list_grid_"+nd).setGridParam({url:"modulos/contabilidad/movimientos_contables/pr/cmb.sql_movimientos_contables.php?busq_cuenta="+busq_cuenta+"&ano="+ano+"&tipo="+tipo,page:1}).trigger("reloadGrid"); 
				}					
				crear_grid();
				var timeoutHnd; 
				var flAuto = true;
				...
				{
					var busq_cuenta= $("#consulta_comprobante").val();
					var ano=getObj('consulta_ano_comp').value;
					var tipo=getObj('consulta_comprobante_tipo').value;
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/contabilidad/movimientos_contables/pr/cmb.sql_movimientos_contables.php?busq_cuenta="+busq_cuenta+"&ano="+ano+"&tipo="+tipo,page:1}).trigger("reloadGrid");					
					url="modulos/contabilidad/movimientos_contables/pr/cmb.sql_movimientos_contables.php?busq_cuenta="+busq_cuenta+"&ano="+ano+"&tipo="+tipo;
              //    alert(url);				
				}
			}
		}
						...
						function crear_grid()
						{
							jQuery("#list_grid_"+nd).jqGrid
	 						({
								...
								datatype: "json",
								colNames:['Id','Organismo','A&ntilde;o','Mes','tipo','Comprobante','Secuencia','Comentarios','Cuenta Contable','Desc2','Desc','REF','Debito','Credito','Fecha Comprobante','CodAux','CodUbic','Codcost','CodUFondos','codigo_tipo_comp','id_cc','ejecutora','utf','auxiliar','codigo_proyecto','id_acc','cod_acc','r_aux','r_ejec','r_proy','r_uft','monto_dif','nocomp2','cta_nombre','nom_ejecutora','nom_utf','aux_nom','nom_proy','nom_acc'],
								...
								colModel:[
										...
										{name:'cta_nombre',index:'cta_nombre',width:50,hidden:true},
										{name:'nom_ejecutora',index:'nom_ejecutora',width:50,hidden:true},
										{name:'nom_utf',index:'nom_utf',width:50,hidden:true},
										{name:'aux_nom',index:'aux_nom',width:50,hidden:true},
										{name:'nom_proy',index:'nom_proy',width:50,hidden:true},
										{name:'nom_acc',index:'nom_acc',width:50}
								],
				...
				getObj('contabilidad_comprobante_pr_numero_comprobante_oculto').value=ret.ncomp2;
				getObj('contabilidad_comprobante_pr_cuenta_contable').value=ret.cuenta_contable;
				getObj('contabilidad_comprobante_pr_desc_cuenta').value=ret.cta_nombre;
				...
				getObj('contabilidad_comprobante_pr_ubicacion_desc').value=ret.nom_ejecutora;
				getObj('contabilidad_comprobante_pr_utf_desc').value=ret.nom_utf;
				getObj('contabilidad_comprobante_pr_centro_costo_desc').value=ret.nom_proy;
				getObj('contabilidad_comprobante_pr_acc_desc').value=ret.nom_acc;
				getObj('contabilidad_comprobante_pr_auxiliar_desc').value=ret.aux_nom;
						...
						function crear_grid()
						{
							...
							({
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									getObj('contabilidad_comprobante_pr_centro_costo_desc').value = ret.denominacion;
									getObj('contabilidad_comprobante_pr_acc').value ="0";
									getObj('contabilidad_comprobante_pr_acc_desc').value ="NO APLICA";
	...
	(
		{
			...
			function(data)
			{
				...
				function gridReload()
				{
	    			var busq_nom= $("#consulta-auxiliar-contable-busqueda2").val();
					var busq_cuenta= $("#consulta-auxiliar-contable-busqueda-nombre").val();
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/contabilidad/movimientos_contables/pr/cmb.sql_auxiliares.php?busq_cuenta="+busq_cuenta+"&busq_nombre="+busq_nom+"&cuenta="+getObj('contabilidad_comprobante_db_id_cuenta').value,page:1}).trigger("reloadGrid");					
					url="modulos/contabilidad/movimientos_contables/pr/cmb.sql_auxiliares.php?busq_cuenta="+busq_cuenta+"&busq_nombre="+busq_nom+"&cuenta="+getObj('contabilidad_comprobante_db_id_cuenta').value;
                // alert(url);				
				}
			}
		}
									...
									function crear_grid()
									{
										...
										({
											...
											var ret = jQuery("#list_grid_"+nd).getRowData(id);
												...
												$('#contabilidad_comprobante_pr_auxiliar_desc').val(ret.denominacion);
												dialog.hideAndUnload();
											},
											loadComplete:function (id){
												setBarraEstado("");
									...
									function crear_grid()
									{
										...
										({
											...
											var ret = jQuery("#list_grid_"+nd).getRowData(id);
												...
												$('#contabilidad_comprobante_pr_ubicacion_desc').val(ret.unidad);
												dialog.hideAndUnload();
											},
											loadComplete:function (id){
												setBarraEstado("");
										...
										function crear_grid()
										{
											...
											({
												...
												var ret = jQuery("#list_grid_"+nd).getRowData(id);
													...
													$('#contabilidad_comprobante_pr_utf_desc').val(ret.unidad);
													dialog.hideAndUnload();
												},
												loadComplete:function (id){
													setBarraEstado("");
	...
	(
		{
			...
			function(data)
			{
				dialog=new Boxy(data,{ title: 'Consulta Emergente de Acci&oacute;n central', modal: true,center:false,x:0,y:0,show:false});
				dialog_reload=function gridReload()
				{ 
						...
						function crear_grid()
						{
							...
							({
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									getObj('contabilidad_comprobante_pr_acc_desc').value = ret.denominacion;
									getObj('contabilidad_comprobante_pr_centro_costo').value = "0";									
									getObj('contabilidad_pr_centro_costo_id').value = "";
									getObj('contabilidad_comprobante_pr_centro_costo_desc').value="NO APLICA";
									dialog.hideAndUnload();
					 			},
								loadComplete:function (id){
									setBarraEstado("");
			...
			$.ajax({
						...
						//	alert(html);
							if((recordset)&&(recordset!='vacio'))
							{
								...
								getObj('contabilidad_comprobante_pr_auxiliar_desc').value=recordset[4];
							}
							else
							if(recordset=='vacio')
							{	
								...
								getObj('contabilidad_comprobante_pr_auxiliar_desc').value='';
			 ...
			 success:function(html)
			 {
				...
				///alert(html);
					if(html!="vacio")
					{
						...
						$('#contabilidad_comprobante_pr_acc_desc').val(recordset[2]);
						getObj('contabilidad_comprobante_pr_centro_costo').value='0';
						getObj('contabilidad_comprobante_pr_centro_costo_desc').value='NO APLICA';
						getObj('contabilidad_pr_centro_costo_id').value='';
					...
					if(html!="vacio")
					{
						...
						getObj('#contabilidad_comprobante_pr_acc_id').value="";
						getObj('#contabilidad_comprobante_pr_acc_desc').value="";
					}
			 }
		});	 	 
						...
						cache: false,
						 success:function(html)
						 {
							...
							if((recordset)&&(recordset!='vacio'))
							{
								...
								getObj('contabilidad_comprobante_pr_centro_costo_desc').value=recordset[2];
								getObj('contabilidad_comprobante_pr_acc').value='0';
								getObj('contabilidad_comprobante_pr_acc_desc').value='NO APLICA';
								getObj('contabilidad_comprobante_pr_acc_id').value = "";
							}
							...
							cache: false,
							 success:function(html)
							 {
								...
								if((recordset)&&(recordset!='vacio'))
								{
									...
									getObj('contabilidad_comprobante_pr_ubicacion_desc').value=recordset[2];
								}
								else
								if(recordset=='vacio')
								{	
									...
									getObj('contabilidad_comprobante_pr_ubicacion_desc').value='';
				...
				$.ajax({
							...
							//	alert(html);
								if((recordset)&&(recordset!='vacio'))
								{
									...
									getObj('contabilidad_comprobante_pr_utf_desc').value=recordset[2];
								}
								else
								if(recordset=='vacio')
								{	
									...
									getObj('contabilidad_comprobante_pr_utf_desc').value='';
...
//por notificacion dada por los usuarios se habiltan estos campos para su modificacion fecha:141/02/2012
...
//	+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value
	datatype: "json",
	colNames:['Id','Organismo','Ano','Mes','tipo','Comprobante','Secuencia','Comentarios','Cuenta Contable','Cuenta Contable','Desc','REF','Debe','Haber','Fecha Comprobante','CodAux','CodUbic','Codcost','CodUFondos','id_cc'],
   	colModel:[
	   		{name:'id',index:'id', width:20,hidden:true},
			...
			{name:'cuenta_contable2',index:'cuenta_contable',width:45},
			{name:'cuenta_contable',index:'cuenta_contable',width:45,hidden:true},
		...
		$.ajax({
			 ...
			 success:function(html)
		 {
			 ...
			 // alert(html);
				...
				recordset = recordset.split("*");
				getObj('contabilidad_vista_id_comprobante').value = recordset[0];
				numero_comp_sub=recordset[5];
				getObj('contabilidad_comprobante_pr_numero_comprobante').value =numero_comp_sub.substr(10);
				...
				getObj('contabilidad_comprobante_pr_tipo').value=recordset[18];
				getObj('contabilidad_comprobante_pr_tipo_id').value=recordset[4];
				getObj('contabilidad_comprobante_pr_ubicacion_desc').value=recordset[29];
				getObj('contabilidad_comprobante_pr_utf_desc').value=recordset[30];
				getObj('contabilidad_comprobante_pr_auxiliar_desc').value=recordset[31];
				getObj('contabilidad_comprobante_pr_centro_costo_desc').value=recordset[32];
				getObj('contabilidad_comprobante_pr_acc_desc').value=recordset[33];
...
function valDia(oTxt){
 ...
 function v_fecha(oTxt){
  fech=new Date(); 
  oTxt=getObj('contabilidad_comprobante_pr_fecha');
  var bOk = true;
  if (oTxt.value != ""){
   bOk = bOk && (valAno(oTxt));
   bOk = bOk && (valMes(oTxt));
...
<tr>
		...
		<td width="124">
		            <input alt="date" type="text" name="contabilidad_comprobante_pr_fecha" id="contabilidad_comprobante_pr_fecha" size="7" value="<? echo($fecha);?>" jval="{valid:/^[0-9/-]{1,60}$/, message:'Fecha Invalida', styleType:'cover'}" onchange="v_fecha();"
	...
	<tr>
		...
		<!-- <ul class="input_con_emergente">
		 <li>-->
				...
				jvalkey="{valid:/[0-9]/, cFunc:'alert', cArgs:['Codigo: '+$(this).val()]}"/>
				<input type="text" name="contabilidad_comprobante_pr_desc_cuenta" id="contabilidad_comprobante_pr_desc_cuenta" size="35" />
	...
	<table  cols="4" class="cuerpo_formulario" width="100%" border="0">
				...
				<tr>
					...
					<input name="contabilidad_comprobante_pr_auxiliar" type="text" id="contabilidad_comprobante_pr_auxiliar"   value="" size="12" maxlength="12" message="Introduzca el c&iacute;digo del auxiliar' "  onblur="consulta_auxiliar_auto_mov()"
							...
							jvalkey="{valid:/[0-9]/, cFunc:'alert', cArgs:['Codigo: '+$(this).val()]}"/> 						<input type="text" name="contabilidad_comprobante_pr_auxiliar_desc" id="contabilidad_comprobante_pr_auxiliar_desc"  size="35" />
 ...
 />	
 <input type="text" name="contabilidad_comprobante_pr_centro_costo_desc" id="contabilidad_comprobante_pr_centro_costo_desc"  size="35" />
		...
		<th>Acci&oacute;n Centralizada</th>
					...
					<li>
					  <input name="contabilidad_comprobante_pr_acc" type="text" id="contabilidad_comprobante_pr_acc"   value="" size="12" maxlength="12" message="Introduzca el c&oacute;digo de Utilización de fondos' "  onblur="consulta_acc_mov()"
										jval="{valid:/^[0-9]{1,12}$/, message:'C&oacute;digo Invalido', styleType:'cover'}"
							jvalkey="{valid:/[0-9]/, cFunc:'alert', cArgs:['Codigo: '+$(this).val()]}"/>
					  <input type="text" name="contabilidad_comprobante_pr_acc_desc" id="contabilidad_comprobante_pr_acc_desc"  size="35" />
		...
		<tr>
			<th>Ubicaci&oacute;n:</th>
					...
					<li>
							...
							jval="{valid:/^[0-9]{1,12}$/, message:'Codigo Invalido', styleType:'cover'}"
							jvalkey="{valid:/[0-9]/, cFunc:'alert', cArgs:['Codigo: '+$(this).val()]}"/>
						  <input type="text" name="contabilidad_comprobante_pr_ubicacion_desc" id="contabilidad_comprobante_pr_ubicacion_desc" size="35" />
				...
				<th>Utilizaci&oacute;n Fondos</th>
					...
					<li>
					  <input name="contabilidad_comprobante_pr_utf" type="text" id="contabilidad_comprobante_pr_utf"   value="" size="12" maxlength="12" message="Introduzca el c&oacute;digo de Utilizaci&oacute;n de fondos' " onblur="consulta_utf_mov()"
										jval="{valid:/^[0-9]{1,12}$/, message:'Codigo Invalido', styleType:'cover'}"
							jvalkey="{valid:/[0-9]/, cFunc:'alert', cArgs:['Codigo: '+$(this).val()]}"/>
					  <input type="text" name="contabilidad_comprobante_pr_utf_desc" id="contabilidad_comprobante_pr_utf_desc" size="35" />
