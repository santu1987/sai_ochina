...
////////////////////////////////////////////////////////////////////////
//VERIFICANDO QUE NO ESTE RELACIONADO A UNA FACTURA
$sql_factura="SELECT * FROM documentos_cxp WHERE numero_comprobante='$comprobante_x'";
$row_comprobante_f=& $conn->Execute($sql_factura);
if(!$row_comprobante_f->EOF)
{
	die("tiene_factura");	
}
//
...
//redondeo
$saldo_inicia=round($saldo_inicia,2);																																																																													$sql_saldo_inicial_suma="
																													update
																														saldo_contable
																													SET 
																															saldo_inicio[".$mes."]= '$saldo_inicia'
