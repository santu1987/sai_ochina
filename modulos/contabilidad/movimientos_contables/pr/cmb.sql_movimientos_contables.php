...
if($comprobante!="")
	...
	$where.="and substr(integracion_contable.numero_comprobante::varchar,11)like '%$comprobante%'";
}
if(isset($_GET[tipo]))
{
$tipo=$_GET[tipo];
if($tipo!="")
	...
	$where.="and substr(integracion_contable.numero_comprobante::varchar,9,2)like '%$tipo%'";
}
if(isset($_GET[ano]))
{
	if($ano!="")
	...
	*/
	...
	while (!$row_int->EOF) 
	{
		...
		$Sql3="SELECT 
					...
					cuenta_contable_contabilidad.nombre as cuenta_nombre,
