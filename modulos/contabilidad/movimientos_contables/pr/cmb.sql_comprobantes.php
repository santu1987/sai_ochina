...
{
	if($comprobante!="")
	$where.="and substring(movimientos_contables.numero_comprobante::varchar,11) like'%$comprobante%'";
}
if(isset($_GET[ano]))
{
	$ano=$_GET[ano];
...
/*	$Sql_int="
		...
		$Sql_int="
				SELECT distinct
					...
					movimientos_contables.numero_comprobante, movimientos_contables.id_tipo_comprobante,substr(movimientos_contables.numero_comprobante::varchar,9,6)::integer as dos,
				...
				ORDER BY 
					codigo_tipo,
					substr(movimientos_contables.numero_comprobante::varchar,9,6)::integer
				LIMIT 
					$limit 
				OFFSET 
					$start	 
...
/*
ORDER BY
					substr(movimientos_contables.numero_comprobante::varchar,8)::integer

LIMIT 
					$limit 
				OFFSET 
					$start						  movimientos_contables.numero_comprobante, movimientos_contables.id_movimientos_contables movimientos_contables.id_tipo_comprobante
 */
		...
		//////////////////////////////////////////////////////////////////	 
			//$id_proyecto=$row3->fields("id_proyecto");
			$codigo_tipo=$row3->fields("codigo_tipo");
