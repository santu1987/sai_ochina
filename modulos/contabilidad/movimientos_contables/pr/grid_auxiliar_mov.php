...
<td align="center"><strong> Cuenta Auxiliar:</strong></td>
<input type="text" id="consulta-auxiliar-contable-busqueda-nombre" maxlength="30"  
  sage="Introduzca la cuenta contable" 
					jval="{valid:/^[0-9]{1,6}$/}"
					jvalkey="{valid:/[0-9]/}"/>	
<td align="center"><strong> Denominaci&oacute;n:</strong></td>
<input type="text" id="consulta-auxiliar-contable-busqueda2" maxlength="30"  
