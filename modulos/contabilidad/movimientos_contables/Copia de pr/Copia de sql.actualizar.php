...
////////////////////////////////////////////////////-CASO2 :actualizando EN LAS TABLAS DE SALDO AUXILIARES//////////////////////////////////////////////////////////////////////////////////////////////////////
											...
											$id_aux2=$_POST[contabilidad_comp_contabilidad_id2];
										//	echo($id_aux."!=".$id_aux2);	
											if(($id_aux!="")&&($id_aux2!=""))
											{
												//si son dif aux!=aux1
												/*if(($id_aux!=$id_aux2)&&($id_aux!="0")&&($id_aux2!="0"))
															...
															//die($sql_mov2);
																			...
																			if (!$rs_mov2->EOF) 
																			{
																				...
																				if($rs_mov2->fields("haber")!=0)
																					...
																					$monto_haber4=0;
																				$monto_debe_a =$monto_debe4;
																				$monto_haber_a =$monto_haber4;
																				if($tipo_saldo=='10')
																				{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
												...
												$sql_mov2="SELECT  
															...
															//die($sql_mov2);
																			...
																			{
																				//
																				$debe_ant2_dif=$row_comprobante->fields("monto_debito");
																				$haber_ant2_dif=$row_comprobante->fields("monto_credito");
																				//
																				if($rs_mov2->fields("debe")!=0)
																					$monto_debe4_dif= $rs_mov2->fields("debe");
																				else
																					 $monto_debe4_dif=0;
																				if($rs_mov2->fields("haber")!=0)
																					$monto_haber4_dif= $rs_mov2->fields("haber");
																				else
																					$monto_haber4=0;
																				$monto_debe_a_dif=$monto_debe4_dif+$monto_debito;
																				$monto_haber_a_dif=$monto_haber4_dif+$monto_credito;
																				if($tipo_saldo=='10')
																				{
																					if(($monto_debe_a_dif!="0")&&($monto_haber_a_dif=="0"))
																					{
																						$monto_saldo_aux=$monto_debe_a_dif;	
																						$monto_saldo_aux_ant=$monto_debe4_dif;	
							
																					}
																					if(($monto_haber_a_dif!="0")&&($monto_debe_a_dif=="0"))
																					{
																						$monto_saldo_aux_dif=$monto_haber_a_dif;
																						$monto_saldo_aux_ant=$monto_haber4_dif;	
																			...
																			if(($monto_haber_a_dif!="0")&&($monto_debe_a_dif!="0"))
																			{
																				if(($codigo=='A   ')||($codigo=='G   '))
																				{
																					$monto_saldo_aux_dif=$monto_debe_a_dif-$monto_haber_a_dif;
																					$monto_saldo_aux_ant=$monto_debe4_dif-$monto_haber4_dif;	
							
																				}
																				else
																				if(($codigo=='P   ') ||($codigo=='PAT ')or($codigo=='I   '))
																				{
																					$monto_saldo_aux_dif=$monto_haber_a_dif-$monto_debe_a_dif;
																					$monto_saldo_aux_ant=$monto_haber4_dif-$monto_debe4_dif;	
																				...
																				$sql_saldo_inicial_aux_dif2="
																										update
																												saldo_auxiliares
																											SET 
																													saldo_inicio[".$mes."]= '$monto_saldo_aux_dif'
																											WHERE
																			...
																			else	
																			{
																				...
																				$sql_mod4="update
																					saldo_auxiliares
																				SET 
																						debe[".$mes."]= '$monto_debe_a_dif',
																						haber[".$mes."]= '$monto_haber_a_dif'
																				WHERE
																					cuenta_auxiliar='$id_aux'
																				AND
																					ano='$ano'
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
												...
												$sql_dos="UPDATE	
														...
														set
															...
															monto_debito=$monto_debe_a,
															monto_credito=$monto_haber_a,
														...
														set
															...
															referencia='$_POST[contabilidad_comp_pr_ref]',
															debito_credito='$debe_haber',
															monto_debito=$monto_debe_a_dif,
															monto_credito=$monto_haber_a_dif,
															id_unidad_ejecutora=$contabilidad_comp_pr_ubicacion,
															id_proyecto=$contabilidad_comp_pr_centro_costo,
															id_accion_central=$contabilidad_comp_pr_acc,
															id_utilizacion_fondos=$contabilidad_comp_pr_utf,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////														
	...
	//die($monto_debe4."+".$monto_debito);
																			...
																			//$monto_haber4+
																			//die($monto_haber_a."+".$monto_credito_a);
