...
var nd=new Date().getTime();
	...
	function crear_grid()
	{
		...
		({
			...
			recordtext:"Registro(s)",
			loadtext: "Recuperando InformaciÛn del Servidor",		
			url:'modulos/contabilidad/movimientos_contables/pr/sql_grid_numero_comprobante.php?nd='+nd,
			datatype: "json",
	...
	<th>N&uacute;mero Comprobante:</th>
		...
		<ul class="input_con_emergente">
		  <li>
			...
			<input type="text" id="contabilidad_recuve_pr_numero_comprobante2" name="contabilidad_recuve_pr_numero_comprobante2"    message="Introduzca n comprobante" size="12" maxlength="50" onblur="consulta_manual_mov_contables();"  />	
