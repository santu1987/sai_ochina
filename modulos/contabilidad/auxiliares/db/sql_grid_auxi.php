...
$sord = $_GET['sord'];
//************************************************************************
$aux=$_POST[contabilidad_auxiliares_db_cuenta_auxiliar];
if($aux!="")
{
...
$responce =$row->fields("id_auxiliares")."*".$row->fields("cuenta_auxiliar")."*".$row->fields("nombre")."*".$row->fields("comentarios");	
}else
$responce="vacio";
