...
$cuenta=$_POST[contabilidad_cuentas_contables_db_cuenta_suma];
$where = "WHERE 1=1";
...
$i=0;
			if (!$row->EOF) 
			{
						...
						$responce =$row->fields("id")."*".$row->fields("cuenta_contable")."*".strtoupper($row->fields("nombre"))."*".$row->fields("requiere_auxiliar")."*".$row->fields("requiere_proyecto")."*".$row->fields("requiere_unidad_ejecutora")."*".$row->fields("requiere_utilizacion_fondos");
