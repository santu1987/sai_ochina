...
$where = " WHERE 1=1 ";
if ($busq_nombre!='')
$where.= " AND lower(clasificador_presupuestario.denominacion) like '%$busq_nombre%' ";
if (isset($_GET['busq_partida']))
$busq_partida = strtolower($_GET['busq_partida']);
if ($busq_partida!='')
$where.= " AND lower(clasificador_presupuestario.partida ) like '%$busq_partida%' ";
$limit = 15;
if(!$sidx) $sidx =1;
...
$Sql="
			...
			FROM 
				clasificador_presupuestario".$where;
