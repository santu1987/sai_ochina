...
$where = " WHERE 1 = 1 ";
if ($busq_codigo!='')
$where.= " AND lower(detalle_demanda.codigo_detalle_demanda) like '%$busq_codigo%' ";
if ($busq_nombre!='')
$where.= " AND lower(detalle_demanda.nombre) like '%$busq_nombre%' ";
$limit = 15;
if(!$sidx) $sidx =1;
...
$Sql="
			...
			INNER JOIN
				demanda
			ON
				demanda.id_demanda = detalle_demanda.id_demanda ".$where."
			ORDER BY 
				$sidx $sord 
			LIMIT 
				$limit 
