...
{ 
	...
	class PDF extends FPDF
	{
		...
		{		
			...
			$this->SetFont('Arial','',10);
			$this->Cell(0,10,$codigo_unidad." ".$unidad_ejecutora,'TBR',0,'L');
			$this->Ln(10);
			$this->SetFont('Arial','B',10);
			$this->Cell(33,10,'Proyecto/A.C.','LB',0,'L');
			$this->SetFont('Arial','',10);
			$this->Cell(0,10,$codigo_proyecto_accion." ".$proyecto_accion,'BR',0,'L');
			$this->Ln(10);
			$this->SetFont('Arial','B',10);
			$this->Cell(33,10,'Accion Especifica','LB',0,'L');
			$this->SetFont('Arial','',10);
			$this->Cell(0,10,$codigo_especifica." ".$AccionE,'BR',0,'L');
			$this->Ln(10);
			$this->SetFont('Arial','B',10);
			$this->Cell(33,10,'Asunto  ','LB',0,'L');
			$this->SetFont('Arial','',10);
			$this->Cell(0,10,$asunto,'BR',0,'L');
			$this->Ln(10);
			$this->SetFont('Arial','B',10);
		...
		function Footer()
		{
			...
			$this->Ln(10);
			$this->Cell(65,3,strtoupper( $_SESSION[nombre].' '.$_SESSION[apellido])  ,0,0,'C');
			...
			$this->Cell(65,3,'Jefe de la '.$unidad_ejecutora ,0,0,'C');
	...
	$i++;
		...
		$pdf->Cell(25,		6,$rowRequiDetalle->fields("nombre"),			0,0,'C',1);
		$pdf->MultiCell(125,6,$rowRequiDetalle->fields("descripcion"),		0,'L',0);
		$pdf->Ln(6);
