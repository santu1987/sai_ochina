...
$proyecto = $_POST['requisiones_pr_proyecto_id'];
$accion_central = $_POST['requisiones_pr_accion_central_id'];
...
$Sql="
			...
			$sqll
			AND	
				(accion_especifica.codigo_accion_especifica ='". $_POST['requisiciones_pr_accion_especifica_codigo']."')
			AND	
