...
if (!$row->EOF) 
{
	...
	$responce =$row->fields("numero_cotizacion")."*".  $row->fields("id_proveedor")."*".  $row->fields("proveedor")."*".  $row->fields("id_unidad_ejecutora")."*".  $row->fields("unidad_ejecutora")."*".  $row->fields("numero_precompromiso");
echo ($responce);
