...
$row_firma=& $conn->Execute($sql_firma);
	...
	$misnistro =$row_firma->fields("cargo_ministro_defensa")." ".$row_firma->fields("nombre_ministro_defensa");
	...
	class PDF extends FPDF
	{
		...
		{		
			...
			global $telefono,$titulo,$comentarios,$tipo_ordn;
