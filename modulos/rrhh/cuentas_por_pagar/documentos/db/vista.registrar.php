				...
				$("#cuentas_por_pagar_db_fecha_vencimiento_consulta").focus(function()
				{
						...
						/*function consulta_doc_dosearch()
					{
						...
						function consulta_benef_gridReload()
						{
							...
							url="modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?benef="+benef;
							//alert(url);
							setBarraEstado(url);
						}
				...
				function crear_grid()
						{
							...
							({
								...
								colModel:[
									...
									{name:'fecha_comp',index:'fecha_comp', width:60,sortable:false,resizable:false}
...
*/
							...
							if((ret.contador!=0) &&((ret.tipo_documento_cxp1!=getObj('cuentas_por_pagar_db_anticipos').value))
								...
								fecha=getObj('fecha_oculta').value;
								...
								url="modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+fecha+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value;
								//alert(url)
								getObj('partida_celdas').style.display='';
								getObj('celdas_2').style.display='';
								getObj('cuentas_por_pagar_db_monto_bruto').disabled='true';	
...
$("#list_integracion").jqGrid({
	...
	recordtext:"Consulta(s)",
	loadtext: "Recuperando Información del Servidor",
	url:'modulos/cuentas_por_pagar/documentos/pr/cmb.sql_integracion_contable.php?nd='+new Date().getTime()+'&numero_doc='+getObj('cuentas_por_pagar_db_numero_documento').value,
	datatype: "json",
    ...
    <th colspan="2">
    	<table  class="clear" width="100%" border="0">
			<tr>
			      ...
			      <input type="hidden" name="comprometido" id="comprometido">						 </td>
