...
/*////////////////////////////////////////////////////////////////////////////////////////////////////						
						function crear_grid()
						{
							...
							({
								...
								url:'modulos/cuentas_por_pagar/orden_pago/db/cmb.sql.proveedor_orden.php?nd='+nd+"&opcion="+getObj('cuentas_por_pagar_orden_db_op_oculto').value+"&busq_ano="+getObj('cuentas_por_pagar_db_ayo_orden_pago').value,
...
$("#cuentas_por_pagar_db_orden_btn_imprimir").click(function() {
	if($('#').jVal())
	{
		...
		{
			url="pdf.php?p=modulos/cuentas_por_pagar/orden_pago/rp/vista.lst.orden_pago.php¿prove="+getObj('cuentas_por_pagar_db_orden_proveedor_id').value+"@orden="+getObj('cuentas_por_pagar_db_orden_numero_control').value+"@opcion="+getObj('cuentas_por_pagar_orden_db_op_oculto').value; 
		}
		else
			if(getObj('cuentas_por_pagar_orden_db_op_oculto').value=='2')
		{
			url="pdf.php?p=modulos/cuentas_por_pagar/orden_pago/rp/vista.lst.orden_pago.php¿prove="+getObj('cuentas_por_pagar_orden_db_empleado_codigo').value+"@orden="+getObj('cuentas_por_pagar_db_orden_numero_control').value+"@opcion="+getObj('cuentas_por_pagar_orden_db_op_oculto').value;  
		}
		//alert(url);
		//setBarraEstado(url);
