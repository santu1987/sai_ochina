...
//echo($busq_nombre);
$bus_ced="";
if(isset($_POST['prestamo_pr_trabajador']))
$busq_ced=$_POST['prestamo_pr_trabajador'];
////////////////////////////////
$where = " WHERE 1 = 1 ";
if($busq_nombre!='')
	$where.= " AND (lower(persona.cedula) LIKE '%$busq_nombre%')";
if($busq_ced!='')
	$where.= " AND (lower(persona.cedula) LIKE '%$busq_ced%')";
////////////////////
