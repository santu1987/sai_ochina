...
<td align="center"><strong>Nivel Academico </strong>: </td>                  
	             <select id="curriculum_db_nombre_niv">
	               <option value="">---- Todos ----</option>
	               <?= $opt_nivel?>
    </select>
<td align="center"><strong>Rama </strong>: </td>
<input type="text" id="curriculum_db_nombre" maxlength="30"  
			   jval="{valid:/^[a-zA-Z áéíóúÁÉÍÓÚñ.]{1,60}$/}"
				jvalkey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚñ.]/}"/>
<td align="center"><strong>Cedula </strong>: </td>
<input type="text" id="curriculum_db_ci" maxlength="30"  
			   jval="{valid:/^[0-9]{1,60}$/}"
				jvalkey="{valid:/[0-9]/}" maxlength="10" size="10"/>                
<td align="center"><strong>Nombre </strong>: </td>
<input type="text" id="curriculum_db_nombre_per" maxlength="30"  
			   jval="{valid:/^[a-zA-Z áéíóúÁÉÍÓÚñ.]{1,60}$/}"
				jvalkey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚñ.]/}"/>                
</div>
