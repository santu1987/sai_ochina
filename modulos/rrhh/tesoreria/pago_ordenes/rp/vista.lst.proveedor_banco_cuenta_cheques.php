...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
			$this->Cell(0,10,'RELACIÓN PROVEEDOR/BANCO/CUENTAS CHEQUES REGISTRADOS',0,0,'C');
            $this->ln(5);
			...
			$this->Cell(50,6,		     'ORDENES DE PAGO',			0,0,'R',1);
			$this->Ln(6);
		...
		function Footer()
		{
			...
			$this->Ln();
			$this->SetFillColor(175) ;
			$this->Code128(100,200,strtoupper($_SESSION['usuario']),40,6);		
		}			
	}
	//************************************************************************
	$pdf=new PDF();
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}')&&($row->fields("ordenes")!=''))
					{
						$pdf->Cell(50,6,$row->fields("ordenes"),0,0,'R',1);
						$coordenada++;
