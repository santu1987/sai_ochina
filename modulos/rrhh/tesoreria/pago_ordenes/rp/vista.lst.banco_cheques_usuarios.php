...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $banco;	
			...
			$this->Cell(0,10,'RELACIÓN BANCOS/PREPARADOR CHEQUES EMITIDOS',0,0,'C');
            $this->Ln(5);
			$this->Cell(0,10,strtoupper($nombre_usuario)."  ".strtoupper($nombre_banco).":".$n_cuenta,0,0,'C');
			$this->Ln(5);
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
					{
						...
						$pdf->Cell(35,6,$orden_df,0,0,'R',1);
						$coordenada++;
					}
					else
					{
					$pdf->Cell(35,6,"Sin orden",0,0,'R',1);
					$coordenada++;
					}	
			$pdf->Cell(35,6,strtoupper($nombre_usuario),	0,0,'R',1);
