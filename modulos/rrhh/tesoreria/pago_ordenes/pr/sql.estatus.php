...
if($id_unidad_ejecutora==11)	
{
	...
	if($combo=='1')	
	{
	$sql_where.= " AND  cheques.estado[5]='0'";
	}else if($combo=='2')		
	{
		$sql_where.=" AND  cheques.estado[6]='0'";
	}
	else if($combo=='3')		
	{
		$sql_where.=" AND  cheques.estado[7]='0'";
	}
}else
...
{
	$busq_cuenta=strtoupper($_GET['tesoreria_busqueda_cuenta_estatus']);
	if($busq_cuenta!='')
