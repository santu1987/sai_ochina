...
{	
*/		var nd=new Date().getTime();
url='modulos/tesoreria/cheques/pr/cmb.sql.precheque_manual.php?nd='+nd+"&opcion="+getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value+"&proveedor="+getObj('tesoreria_cheque_manual_pr_proveedor_id').value+"&beneficiario="+getObj('tesoreria_cheque_manual_pr_empleado_codigo').value;
		setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
		$.post("modulos/tesoreria/cheques/pr/grid_cheques.php", { },
							function(data)
                        {								
						...
						function crear_grid()
						{
							...
							({
								...
								colModel:[
									...
									{name:'opcion',index:'opcion', width:100,sortable:false,resizable:false},
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									if(ret.opcion=='1')
									{
											...
											getObj('tesoreria_cheque_manual_db_baseimp').value = ret.base_imponible;
											getObj('tesoreria_cheque_manual_db_islr').value = ret.porcentaje_islr;
											getObj('tesoreria_manual_nombre').value=ret.nombre_proveedor;
											getObj('tr_empleado2').style.display="";
											getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value='1';
