...
monto=getObj('tesoreria_cheque_reimpresion_pr_monto_pagar').value;
	...
	{	*/
 Boxy.ask("<div id='mensaje'><p><img align='absmiddle' src='imagenes/iconos/folder_important.png />	¿Desea reimprimir el cheque nº "+ncheque+" del beneficiario "+beneficiario+" por el siguiente monto: "+monto+"?</p></div>", ["ACEPTAR","CANCELAR"], 
function(val)
 {
	if(val=="ACEPTAR")
	{
