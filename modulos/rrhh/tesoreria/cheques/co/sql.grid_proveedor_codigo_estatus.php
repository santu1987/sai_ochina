...
$opcion=$_POST['tesoreria_cheque_estatus_pr_op_oculto'];
...
if(!$sidx) $sidx =1;
if($opcion=='1')
{		$codigo = $_POST['tesoreria_cheque_estatus_pr_proveedor_codigo'];
...
if($opcion=='2')
{$codigo = $_POST['tesoreria_cheque_estatus_pr_empleado_codigo'];
...
{	
	...
	$responce =$id_proveedor."*". $proveedor."*". $rif;
echo ($responce);
