...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $banco;	
            ...
            $this->Ln(5);
			$this->Cell(0,10,strtoupper($nombre_banco).":".$n_cuenta,0,0,'C');
			$this->Ln(5);
			...
			$this->Cell(35,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(35,6,		     'PROVEEDOR',			0,0,'L',1);
			$this->Cell(40,6,		     'FECHA',			0,0,'C',1);
...
//	$proveedor=strtoupper($row->fields("proveedor"));
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			$pdf->Cell(40,6,$fecha_emitido,	0,0,'C',1);
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
					{
						...
						$pdf->Cell(35,6,$orden_df,0,0,'R',1);						//$pdf->Ln();
						$coordenada++;
					}
					else
					{
				...
				$pdf->Cell(35,6,$nombre_usuario,	0,0,'R',1);
				$pdf->Ln();
