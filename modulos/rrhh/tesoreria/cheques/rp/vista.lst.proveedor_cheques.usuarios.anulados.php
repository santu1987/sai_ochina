...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN USUARIO/PROVEEDOR CHEQUES ANULADOS',0,0,'C');
            $this->ln(5);
			...
			$this->Cell(55,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(55,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(30,6,		     'FECHA',			0,0,'L',1);
			/*$this->Cell(30,6,		     'MONTO',			1,0,'L',1);
	...
	$fecha_emitido = substr($fecha_emitido,8,2)."".substr($fecha_emitido,4,4)."".substr($fecha_emitido,0,4);
			...
			//$n_cheque=$row->fields("numero_cheque");
				...
				$cuenta=$row->fields("cuenta_banco");
					...
					$pdf->Cell(70,6,		  strtoupper($banco_nombre),			0,0,'L',1);
					$pdf->Cell(50,6,		     $n_cuenta,	0,0,'L',1);
					$pdf->Cell(55,6,		     $n_chequera,			0,0,'L',1);
