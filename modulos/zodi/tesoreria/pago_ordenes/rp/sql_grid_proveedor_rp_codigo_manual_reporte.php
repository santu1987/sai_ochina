...
$opcion=$_POST['tesoreria_cheque_manual_rp_op_oculto'];
...
if(!$sidx) $sidx =1;
if($opcion=='1')
{		$codigo = $_POST['tesoreria_cheques_proveedores_rp_codigo'];
...
if($opcion=='2')
{$codigo = $_POST['tesoreria_cheques_manual_rp_empleado_codigo'];
...
{	
	...
	$responce =$id_proveedor."*". $proveedor;
echo ($responce);
