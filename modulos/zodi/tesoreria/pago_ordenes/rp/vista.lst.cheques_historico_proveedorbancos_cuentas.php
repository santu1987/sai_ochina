...
class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN CHEQUES HISTÓRICO/PROVEEDOR',0,0,'C');
            $this->ln(10);
			...
			$this->SetTextColor(0);
			$this->Cell(60,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(65,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(70,6,		     'ESTATUS',			0,0,'L',1);
	...
	{	
				...
				//$n_cheque=$row->fields("numero_cheque");
					...
					$cuenta=$row->fields("cuenta_banco");
						...
						$pdf->Cell(65,6,		     $n_cheque,			        0,0,'L',1);
						$pdf->Cell(70,6,$estatus,	0,0,'L',1);
						$pdf->Cell(65,6,number_format($row->fields("monto_cheque"),2,',','.'),0,0,'C',1);
						$pdf->Cell(65,6,$nombre_usuario,2,',','.'),0,0,'C',1);
