...
//------------------- VERIFICANDO SI LAS ORDENES DE PAGO NO FUERON CANCELADAS POR OTROS CHEQUES//----------------------------//
									...
									while($i < $contador)
									{
											...
											if(($row_orden->fields("cheque")!=$_POST['tesoreria_cheques_manual_orden_db_n_precheque']) AND ($row_orden->fields("cheque")!=0))	
														die ('Error-orden');
					...
					$sql_cheque = "SELECT id_chequeras FROM chequeras WHERE cuenta='$_POST[tesoreria_cheques_manual_orden_db_n_cuenta]' and id_banco='$_POST[tesoreria_cheques_manual_orden_db_banco_id_banco]' AND chequeras.id_organismo=".$_SESSION["id_organismo"]."
					";
					...
					if($_POST[tesoreria_cheques_manual_orden_pr_ret_islr]!="")
					{
						$islr=str_replace(".","",$_POST[tesoreria_cheques_manual_orden_pr_ret_islr]);
					...
					if(!$row->EOF)
						...
						$opcion=$_POST[tesoreria_cheque_manual_ord_db_otro_beneficiario_oc];
										...
										$sql = "	
														INSERT INTO 
															...
															(
																...
																'$n_precheque',
																'2',
																'$_POST[tesoreria_manual_nombre_ord]',											
																'".str_replace(",",".",$monto)."',
																'$_POST[tesoreria_cheques_manual_orden_db_concepto]',
																'1',
																'$_POST[tesoreria_cheques_manual_orden_db_comentario]',
