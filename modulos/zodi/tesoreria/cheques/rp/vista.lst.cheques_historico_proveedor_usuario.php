...
class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN CHEQUES HISTÓRICO/PREPARADOR/BENEFICIARIO/',0,0,'C');
			$this->ln();
			$this->Cell(0,5,"PREPARADOR:".strtoupper($nombre_usuario),0,0,'C');	
			$this->Ln();
