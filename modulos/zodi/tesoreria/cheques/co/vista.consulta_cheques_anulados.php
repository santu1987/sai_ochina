...
({ 
	...
	url:'modulos/tesoreria/cheques/co/sql.consulta_cheques_anulados.php?nd='+new Date().getTime(),
	datatype: "json",
   	colNames:['Usuario','Beneficiario','Id_Banco','Banco','Cuenta','Chequera','Cheque','Ordenes','Monto'],
   	colModel:[
...
{ 
 ...
 jQuery("#list_anular_cheques").setGridParam({url:"modulos/tesoreria/cheques/co/sql.consulta_cheques_anulados.php?usu_cheanu="+usu_cheanu+"&banco_cheanu="+banco_cheanu+"&cuenta_cheanu="+cuenta_cheanu+"&prov_cheanu="+prov_cheanu+"&tesoreria_busqueda_proveedor_anulado="+tesoreria_busqueda_proveedor_anulado+"&tesoreria_busqueda_beneficiario_anulado="+tesoreria_busqueda_beneficiario_anulado,page:1}).trigger("reloadGrid"); 
	url="modulos/tesoreria/cheques/co/sql.consulta_cheques_anulados.php?usu_cheanu="+usu_cheanu+"&banco_cheanu="+banco_cheanu+"&cuenta_cheanu="+cuenta_cheanu+"&prov_cheanu="+prov_cheanu+"&tesoreria_busqueda_proveedor_anulado="+tesoreria_busqueda_proveedor_anulado+"&tesoreria_busqueda_beneficiario_anulado="+tesoreria_busqueda_beneficiario_anulado;
	//alert(url);
