...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		$this->Image("../../../../imagenes/logos/logo_ochina_295x260.jpg",10,10,25);
			...
			$this->SetTextColor(0);
			$this->Cell(50,6,		     'CUENTA CONTABLE',			0,0,'L',1);
			$this->Cell(40,6,			 'SALDO CUENTA',		0,0,'L',1);
			$this->Cell(50,6,		     'CUENTA PRESUPUESTARIA',			0,0,'L',1);
			$this->Cell(40,6,			 'SALDO CUENTA',		0,0,'L',1);
			$this->Ln(6);
		}
		//Pie de página
...
////////////////////////////////////////////////////
	...
	{*/	
		$pdf->Cell(50,6,				$row->fields("cuenta_contable"),					0,0,'L',1);
		$pdf->Cell(40,6,				$saldo_mes,					0,0,'L',1);
		$pdf->Cell(50,6,				$partida.".".$generica.".".$especifica.".".$sub_especifica,	0,0,'L',1);
	    $pdf->Cell(40,6,				$saldo_pres,	0,0,'L',1);
