	...
	if((getObj('valor_tipo_doc').value=='anticipo')&&(getObj('valor_anticipo').value!='1'))
		{
			...
			porcent=getObj('valor_porcentaje_compromiso').value.float();
							...
							$.ajax (
							{
								...
								success: function(html)
								{
									...
									if (html=="Actualizado")
									{
										...
										jQuery("#list_compro").setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+getObj('fecha_oculta').value+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value,page:1}).trigger("reloadGrid"); 
	url="modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+getObj('cuentas_por_pagar_db_fecha_f').value+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value;
	//alert(url);
									}
									else if (html=="NoActualizo")
									{//GIANNI
...
function actualizar_opcion1()
{
		var rest=getObj('cuentas_por_pagar_db_monto_bruto').value;
						...
						setTimeout(restar,10); restar();
						/*guardar*/
						jQuery("#list_compro").setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+getObj('cuentas_por_pagar_db_fecha_f').value+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value,page:1}).trigger("reloadGrid"); 
						url="modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+getObj('cuentas_por_pagar_db_fecha_f').value+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value;
						//alert(url);
...
{
		if((getObj('monto_causar_comp').value=="")||(getObj('monto_causar_comp').value=="0,00"))
				{
					actualizar_cxp();
				}else
				{//alert("entro1");	
...
{			//si no es 
			if(getObj('cuentas_por_pagar_db_tipo_documento').value!=getObj('cuentas_por_pagar_db_anticipos').value)	
			{	
				if(getObj('monto_causar_comp').value=="0,00")
				{
					guardar_factura();
				}else
				{
...
//	getObj('cuentas_por_pagar_db_op_comprometido_oculto').value="1";
	...
	/**/
	jQuery("#list_compro").setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php",page:1}).trigger("reloadGrid"); 
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?busq_fecha_v="+busq_fecha_v+"&benef="+benef+"&prove="+prove,page:1}).trigger("reloadGrid"); 
		    }	
				crear_grid();
				var timeoutHnd; 
				var flAuto = true;
				...
				$("#cuentas_por_pagar_db_fecha_vencimiento_consulta").focus(function()
				{
						...
						/*function consulta_doc_dosearch()
					{
						...
						{
							var busq_fecha_v= jQuery("#cuentas_por_pagar_db_fecha_vencimiento_consulta").val(); 
							jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?busq_fecha_v="+busq_fecha_v,page:1}).trigger("reloadGrid"); 
							url="modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?busq_fecha_v="+busq_fecha_v;
						}*/
						function consulta_benef_gridReload()
						{
							var benef=jQuery("#cuentas_por_pagra_db_benef").val();
							jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?benef="+benef,page:1}).trigger("reloadGrid"); 
						...
						{
							var prove=jQuery("#cuentas_por_pagra_db_prove").val();
							jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?prove="+prove,page:1}).trigger("reloadGrid"); 
							url="modulos/cuentas_por_pagar/documentos/db/cmb.sql.documentos.php?prove="+prove;
							//alert(url);
							setBarraEstado(url);
						}
			}
				...
				function crear_grid()
						{
							...
							({
								...
								colModel:[
									...
									{name:'tipo_documento_cxp1',index:'tipo_documento_cxp1', width:40,sortable:false,resizable:false},
									...
									{name:'contador',index:'contador', width:60,sortable:false,resizable:false},
									{name:'fecha_comp',index:'fecha_comp', width:60,sortable:false,resizable:false,hidden:true},
{name:'fecha_ord',index:'fecha_comp', width:60,sortable:false,resizable:false,hidden:true}
...
*/
							...
							if((ret.contador!=0) &&((ret.tipo_documento_cxp1!=getObj('cuentas_por_pagar_db_anticipos').value))
								...
								jQuery("#list_compro").setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+ret.fecha_ord+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value,page:1}).trigger("reloadGrid"); 
								url="modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+ret.fecha_ord+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value;
								//alert(url)
								getObj('partida_celdas').style.display='';
								getObj('celdas_2').style.display='';
								getObj('cuentas_por_pagar_db_monto_bruto').disabled='true';	
	...
	{	
								if(recordset[16]!=0)
								{
										...
										//cargando tabla de partidas
											...
											{
											fecha=fds3;
											jQuery("#list_compro").setGridParam({url:"modulos/cuentas_por_pagar/documentos/db/sql.partidas_comp.php?compromiso="+getObj('cuentas_por_pagar_db_compromiso_n').value+"&fecha="+fecha+"&cuentas_por_pagar_db_id="+getObj('cuentas_por_pagar_db_id').value,page:1}).trigger("reloadGrid"); 
...
comprobante=getObj('cuentas_por_pagar_integracion_tipo').value+getObj('cuentas_por_pagar_numero_comprobante_integracion').value;
	url="pdf.php?p=modulos/cuentas_por_pagar/documentos/rp/vista.lst.comprobante_cxp_doc.php¿comprobante="+comprobante+"@ano="+getObj('cuentas_por_pagar_numero_comprobante_integracion').value; 
//alert(url);
		...
		//	$.post("/modulos/cuentas_por_pagar/documentos/db/grid_cuentasxpagar.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								url:'modulos/cuentas_por_pagar/documentos/db/cmb.sql.proveedor_compromiso.php?nd='+nd+"&proveedor="+getObj('cuentas_por_pagar_db_proveedor_id').value,
								datatype: "json",
								colNames:['Nombre','Compromiso','N Orden','Fecha Orden','Monto_Orden','Monto_fact','tipo','Disponible','Monto Ant','Porcentaje_Ant','iva','id_prove','codigo_prove','partida'],
								colModel:[
									{name:'nombre',index:'nombre', width:100,sortable:false,resizable:false},
									...
									{name:'fecha_orden',index:'fecha_orden', width:100,sortable:false,resizable:false},
...
function restar_anticipo()
{
		...
		p_iva2=p_iva.currency(2,',','.');
		getObj('cuentas_por_pagar_db_monto_iva').value=p_iva2;
		getObj('cuentas_por_pagar_integracion_monto').value=getObj('cuentas_por_pagar_db_sub_total').value;
							...
							jQuery("#list_grid_"+nd).jqGrid
	 						({
								...
								colModel:[
									...
									{name:'nombre',index:'nombre', width:200,sortable:false,resizable:false},
									{name:'comen',index:'comen', width:100,sortable:false,resizable:false}
								],
								pager: $('#pager_grid_'+nd),
								rowNum:20,
								rowList:[20,50,100],
...
$("#list_compro").jqGrid({ 
	...
	datatype: "json",
   	colNames:['Id','Partida','Monto Comp','Monto Causado','Monto a Causar','Monto BI'],
								colModel:[
	...
	onSelectRow: function(id){ //alert(id);
		...
		if(idd && idd!==lastsel){
		$.ajax({
			url:'modulos/cuentas_por_pagar/documentos/db/sql.partidas_compromiso.php?id='+idd+'&fecha='+fecha+'&compromiso='+compromiso,
            data:dataForm('form_cuentas_por_pagar_db_documentos'), 
			type:'GET',
			cache: false,
			 success:function(html)
			...
			//	getObj('comprometido').value=;
				getObj('monto_causar_comp2').value=recordset[5];
			//	alert(recordset[4]);
				getObj('monto_causar_comp').value=recordset[4];
...
<div id="botonera"><img id="cuentas_por_pagar_documentos_db_btn_cancelar" class="btn_cancelar"src="imagenes/null.gif"  /><img id="cuentas_por_pagar_documentos_db_btn_eliminar" class="btn_anular"src="imagenes/null.gif"  style="display:none"/>
...
<div id="pestana_doc">
			<div>
			  <ul class="tabs-nav">
				...
				<li><a href="#pestana2_doc" name="cargar_debe" id="cargar_debe"><span>Elaborar Comprobante</span></a></li>
			    <li></li>
			  </ul> 
			</div>
<div>			
...
-->						<input type="hidden"  id="cuentas_por_pagar_db_numero_control_oculto" name="cuentas_por_pagar_db_numero_control_oculto"/>					</td>
		...
		<th>Fecha Factura:</th>
				  <td><label>
				  <input   alt="date" type="text" name="cuentas_por_pagar_db_fecha_f" id="cuentas_por_pagar_db_fecha_f" size="7"  onchange="valFecha();" onblur="valFecha();"  value="<? $year=date("Y"); echo date("d/m")."/".$year;?>" jval="{valid:/^[0-9/-]{1,60}$/, message:'Fecha Invalida', styleType:'cover'}"
					/>
				  ...
				  <script type="text/javascript">
					...
					<input type="text" name="fecha_oculta" id="fecha_oculta">
				  </label>		        </td>
			</tr>	
		<tr>		
		<th>Fecha Vencimiento:</th>
				  <td><label>
				  <input   alt="date" type="text" name="cuentas_por_pagar_db_fecha_v" id="cuentas_por_pagar_db_fecha_v" size="7"  onchange="valFecha();" onblur="valFecha();" value="<? echo $fecha; ?>" jval="{valid:/^[0-9/-]{1,60}$/, message:'Fecha Invalida', styleType:'cover'}"
					/>
			...
			<th>N&uacute;mero Compromiso:</th>
			  ...
			  <ul class="input_con_emergente">
			  <li>
					 <input type="text" name="cuentas_por_pagar_db_compromiso_n" id="cuentas_por_pagar_db_compromiso_n" size="8" maxlength="8" onblur="compromiso_cons()" message="Ingrese el n&uacute;mero de compromiso." />
			 ...
			 <tr>
				...
				<td><textarea  name="cuentas_por_pagar_db_comentarios" cols="60" id="cuentas_por_pagar_db_comentarios" message="Introduzca un comentario."></textarea>		</td>
			</tr>
    ...
    <th colspan="2">
    	<table  class="clear" width="100%" border="0">
			<tr>
                  ...
                  <input type="text" id="cuentas_por_pagar_activo_varios" name="cuentas_por_pagar_activo_varios">
	    </td>
							<td width="20%" rowspan="3" align="center">
								<img style="vertical-align:middle" id="cuentas_por_pagar_documentos_db_btn_guardar" src="imagenes/actuliza40.png"   />
								<img style="display:none" id="cuentas_por_pagar_documentos_db_btn_actualizar" src="imagenes/actuliza40.png" />	
							</td>
			</tr>	
</table></th>
</tr>
...
<tr id="tr_cxp_monto_anticipo" style="display:none">
				...
				<td>
				 ...
				 <input type="hidden"	 id="monto_ant_oculto" name="monto_ant_oculto">
			...
			<tr id="tr_cxp_monto_bruto">
				...
				<td>
				 ...
				 <label id="mas">Base Imponible</label><input type="hidden" id="valor_bi1" name="valor_bi1"  value="0"/>	
				<input type="hidden" name="monto_bruto_oculto" id="monto_bruto_oculto">
			  </td>
			</tr>	
			...
			<tr id="tr_cxp_iva">
			  <th> IVA2:</th>
				<td><input type="text" name="cuentas_por_pagar_db_iva2" id="cuentas_por_pagar_db_iva2" style="text-align:right"  onKeyPress="reais(this,event)" onKeyDown="backspace(this,event)" onBlur="restar();" value="<?php echo($porcentajexx); ?>" size="6" maxlength="6"  readonly=""
			  message="Ingrese el valor del IVA. "  
			  />
			...
			<tr id="tr_cxp_retislr">
				...
				/>
				<input align="right"  name="cuentas_por_pagar_db_monto_ret_islr" type="text" id="cuentas_por_pagar_db_monto_ret_islr"  onkeypress="reais(this,event)" onkeydown="backspace(this,event);" value="0,00" size="16" maxlength="16" readonly="" style="text-align:right"  onblur="restar()"message="Ingrese el valor de la base imponible."  />				</td>
			</tr>
			  ...
			  <input type="hidden" id="valor_ret_ex2" name="valor_ret_ex2"  value="0"/></td>
				...
				<input align="right"  name="cuentas_por_pagar_db_ret_extra2" type="text" id="cuentas_por_pagar_db_ret_extra2"  onkeypress="reais(this,event)" onkeydown="backspace(this,event);" value="0,00" size="16" maxlength="16" readonly="" style="text-align:right"  onblur="restar()"message="Ingrese el valor de la base imponible." />
					...
					<input id="cuentas_por_pagar_db_ret_extra_dsc2" name="cuentas_por_pagar_db_ret_extra_dsc2" type="text" />		
					  <label>
					  <input  type="checkbox"  name="cuentas_por_pagar_check_bie2"  disabled="disabled"id="cuentas_por_pagar_check_bie2" value="checkbox" onclick="proceso_biex2();restar();" />
					  </label>
