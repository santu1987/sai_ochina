...
-->			 </li>
	...
	<table  cols="4" class="cuerpo_formulario" width="100%" border="0">
				...
				<tr>
					...
					<ul class="input_con_emergente">
					 <li>	
					<input name="contabilidad_comp_pr_auxiliar" type="text" id="contabilidad_comp_pr_auxiliar"   value="" size="12" maxlength="12" message="Introduzca el c&oacute;digo del auxiliar' "   onblur="auxiliares_consulta_mov()" readonly="readonly"
					/> 
