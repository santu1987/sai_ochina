...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $banco;	
			...
			$this->SetTextColor(0);
			$this->Cell(45,6,		     'Nº DE CUENTA',			1,0,'L',1);
			$this->Cell(30,6,		     'Nº DE CHEQUERA',			1,0,'L',1);
			$this->Cell(25,6,		     'Nº DE CHEQUE',			1,0,'L',1);
			$this->Cell(40,6,		     'PROVEEDOR',			1,0,'L',1);
			$this->Cell(50,6,		     'FECHA',			1,0,'L',1);
			$this->Cell(25,6,		     'MONTO',			1,0,'L',1);
			$this->Cell(30,6,		     'ORDENES DE PAGO',			1,0,'L',1);
			$this->Cell(30,6,		     'PREPARADOR',			1,0,'L',1);
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
					{
						...
						$pdf->Cell(30,6,$orden_df,0,0,'R',1);						
						$coordenada++;
					...
					{
					$pdf->Cell(30,6,"Sin orden",0,0,'C',1);
					
					}
				$pdf->Cell(30,6,$nombre_usuario,	0,0,'R',1);
