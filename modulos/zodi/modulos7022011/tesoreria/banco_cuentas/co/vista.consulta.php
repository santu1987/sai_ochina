...
({ 
	...
	url:'modulos/tesoreria/banco_cuentas/co/sql.consulta.php?nd='+new Date().getTime(),
	datatype: "json",
   	colNames:['Id','Nº Cuenta','Banco', 'Sucursal','Persona Contacto','Tel&eacute;fono'],
   	colModel:[
...
{ 
	...
	jQuery("#list_consulta_proveedor").setGridParam({url:"modulos/adquisiones/proveedor/co/sql.consulta.php?busq_nombre="+busq_nombre,page:1}).trigger("reloadGrid"); 
} 
