...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
            ...
            $this->ln(5);
			$this->Cell(0,10,strtoupper($beneficiario)." ".strtoupper($banco),0,0,'C');
			$this->Ln(5);
			...
			$this->Cell(40,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(45,6,		     'FECHA',			0,0,'L',1);
			$this->Cell(30,6,		     'MONTO',			0,0,'L',1);
			$this->Cell(35,6,		     'ORDENES DE PAGO',			0,0,'R',1);
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
				{
						$pdf->Cell(35,6,$row->fields("ordenes"),0,0,'R',1);
						$coordenada++;
				}
				else
				{
