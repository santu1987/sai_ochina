...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN PREPARADOR/BENEFICIARIOS/BANCO CHEQUES ANULADOS',0,0,'C');
            $this->ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(60,6,		     'Nº DE CUENTA',			0,0,'L',1);
			$this->Cell(70,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(70,6,		     'Nº DE CHEQUE',			0,0,'L',1);
	...
	{		
			...
			//$n_cheque=$row->fields("numero_cheque");
				...
				$cuenta=$row->fields("cuenta_banco");
					...
					$pdf->Cell(70,6,$n_chequera,0,0,'L',1);
