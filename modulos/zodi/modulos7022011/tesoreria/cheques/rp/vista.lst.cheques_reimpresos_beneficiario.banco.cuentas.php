...
{ 
	...
	class PDF extends FPDF
	{
		...
		{	global $banco_nombre;
			global $fecha;	
			global $desde;	global $hasta;global $proveedor;global $cuenta;
            ...
            $this->ln(5);
			$this->Cell(0,10,$banco_nombre.":".$cuenta,0,0,'C');
            $this->ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(50,6,		     'USUARIO',			0,0,'L',1);
	...
	while (!$row->EOF) 
	{
		...
		$total_general=$total_general+$row->fields("monto_cheque");	
			...
			$pdf->Cell(50,6,		   	 $nombre_usuario ,			0,0,'L',0);
