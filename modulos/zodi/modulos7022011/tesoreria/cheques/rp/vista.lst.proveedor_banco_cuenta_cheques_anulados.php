...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
			$this->Cell(0,10,'RELACIÓN PROVEEDOR/BANCO/CUENTAS CHEQUES ANULADOS',0,0,'C');
            $this->ln(5);
			$this->Cell(0,10,strtoupper($proveedor)." ".$banco_nombre.":".$n_cuenta,0,0,'C');
			$this->Ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(80,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(80,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(80,6,		     'FECHA',			0,0,'L',1);
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			$pdf->Cell(80,6,		     $n_chequera,			0,0,'L',1);
			$pdf->Cell(80,6,		     $n_cheque,			        0,0,'L',1);
			$pdf->Cell(80,6,$fecha_emitido,	0,0,'L',1);
