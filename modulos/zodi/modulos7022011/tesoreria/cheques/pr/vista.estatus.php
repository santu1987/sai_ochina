...
if(getObj('tesoreria_estatus_db_id_cheque_oculto').value!="")
{
	...
	alert("No puede guardar el registro sin haber elegido por lo menos un cheque");	
});
////////////////////////////////////////////
...
({ 
	...
	url:urls,
	datatype: "json",
   	colNames:['&ordm;Id Cheque','Banco','Cuenta','Id_Banco','Cheque','Beneficiario','Monto','Usuario','Ordenes','Chequera','tipo','Estatus'],
   	colModel:[
...
$('#tesoreria_estatus_banco_nombre_usuario').alpha({allow:' ·ÈÌÛ˙ƒ…Õ”⁄.- '});
...
<form method="POST" id="form_tesoreria_estatus_db_cheques" name="form_tesoreria_estatus_db_cheques">
  <table class="cuerpo_formulario">
    ...
    <tr>
      <td class="celda_consulta"><div class="div_busqueda">&nbsp;Unidad:<?php echo($unidad_nombre); ?>
          <input type="hidden" name="tesoreria_nombre_unidad" id="tesoreria_nombre_unidad" value="<?php echo ($id_unidad_ejecutora);?>" onselect="" />
          <label>
