...
//alert(urls);
	...
	$.post("modulos/tesoreria/cheques/pr/grid_cheques.php", { },
						...
						//jQuery("#list_orden_pago").setGridParam({url:'modulos/tesoreria/cheques/pr/cmb.sql.orden_pago.php?nd='+nd+'&proveedor='+getObj('tesoreria_cheques_pr_proveedor_id').value+'&ncuenta='+getObj('tesoreria_cheques_db_n_cuenta').value+'&banco='+getObj('tesoreria_cheques_db_banco_id_banco').value,page:1}).trigger("reloadGrid");
									jQuery("#list_orden_pago").setGridParam({url:'modulos/tesoreria/cheques/pr/cmb.sql.orden_pago.php?nd='+nd+'&proveedor='+getObj('tesoreria_cheques_pr_proveedor_id').value+'&ncuenta='+getObj('tesoreria_cheques_db_n_cuenta').value+'&banco='+getObj('tesoreria_cheques_db_banco_id_banco').value+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&rif='+getObj('tesoreria_cheques_pr_proveedor_rif').value,page:1}).trigger("reloadGrid");
						...
						function consulta_cheque_banc_dosearch()
					{
						...
						function crear_grid()
						{
							...
							({
								...
								dialog.hideAndUnload();
								jQuery("#list_orden_pago").setGridParam({url:'modulos/tesoreria/cheques/pr/cmb.sql.orden_pago.php?nd='+nd+'&proveedor='+getObj('tesoreria_cheques_pr_proveedor_id').value+'&ncuenta='+getObj('tesoreria_cheques_db_n_cuenta').value+'&banco='+getObj('tesoreria_cheques_db_banco_id_banco').value+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&islr='+'&rif='+getObj('tesoreria_cheques_pr_proveedor_rif').value,page:1}).trigger("reloadGrid");
				 			},
								loadComplete:function (id){
									setBarraEstado("");
									dialog.center();
		...
		$.post("modulos/tesoreria/cheques/pr/grid_cheques.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								url:'modulos/tesoreria/cheques/pr/cmb.sql.precheque.php?nd='+nd+"&proveedor="+getObj('tesoreria_cheques_pr_proveedor_id').value,
								datatype: "json",
								colNames:['Id','N precheque','Id Banco','Banco','N Cuenta','id_proveedor','codigo_proveedor','nombre_proveedor2','nombre_proveedor','Base Imp','Concepto','porcentaje','ordenes','islr','sustraendo','Benef'],
								colModel:[
									{name:'id',index:'id', width:50,sortable:false,resizable:false,hidden:true},
								...
								*/	
								...
								/*	getObj('tesoreria_cheques_db_nombre_banco').disabled="disabled";
									...
									if(getObj('tesoreria_cheques_pr_sustraendo_oculto').value=='0')
									{
										...
										jQuery("#list_orden_pago").setGridParam({url:'modulos/tesoreria/cheques/pr/cmb.sql.orden_pago.php?proveedor='+getObj('tesoreria_cheques_pr_proveedor_id').value+'&ncuenta='+getObj('tesoreria_cheques_db_n_cuenta').value+'&banco='+getObj('tesoreria_cheques_db_banco_id_banco').value+'&precheque='+getObj('tesoreria_cheques_db_n_precheque').value+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&sustraendo='+getObj('tesoreria_cheques_pr_sustraendo_oculto').value,page:1}).trigger("reloadGrid");
...
//	+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value
	datatype: "json",
		colNames:['&ordm;Id','Orden','Fecha','SubTotal','Base Imp.','%IVA','%Ret.IVA','Total.IVA','%ISLR','Total.ISLR','RetExtras','Total.Pagar'],
   	colModel:[
	...
	onSelectRow: function(id){
		...
		$.ajax({
			url:"modulos/tesoreria/cheques/pr/sql.consulta_selec.php?id="+idd+"&vector="+s+'&rif='+getObj('tesoreria_cheques_pr_proveedor_rif').value+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&sustraendo='+getObj('tesoreria_cheques_pr_sustraendo_oculto').value,
		    data:dataForm('form_tesoreria_db_cheque'), 
			type:'GET',
			cache: false,
			 success:function(html)
...
onSelectAll:function(id){
		...
		if(id && id!==lastsel){
			getObj('tesoreria_cheques_db_ordenes_pago').value=s;
		$.ajax({
			url:"modulos/tesoreria/cheques/pr/sql.consulta_selec.php?id="+idd+"&vector="+s+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&rif='+getObj('tesoreria_cheques_pr_proveedor_rif').value+'&sustraendo='+getObj('tesoreria_cheques_pr_sustraendo_oculto').value,
		    data:dataForm('form_tesoreria_db_cheque'), 
			type:'GET',
			cache: false,
			 success:function(html)
	...
	$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
	            ...
	            jQuery("#list_orden_pago").setGridParam({url:'modulos/tesoreria/cheques/pr/cmb.sql.orden_pago.php?proveedor='+recordset[0]+'&ncuenta='+getObj('tesoreria_cheques_db_n_cuenta').value+'&banco='+getObj('tesoreria_cheques_db_banco_id_banco').value+'&islr='+getObj('tesoreria_cheques_pr_ret_islr').value+'&rif='+getObj('tesoreria_cheques_pr_proveedor_rif').value,page:1}).trigger("reloadGrid");
   ...
   <tr>
	...
	<tr>
		<th>
			Monto a Pagar		</th>
		<td>
		<input align="right"  name="tesoreria_cheques_db_monto_pagar" type="text" id="tesoreria_cheques_db_monto_pagar"  readonly value="0,00" size="16" maxlength="16"  style="text-align:right" />
		<input  name="tesoreria_cheques_db_ordenes_pago" type="hidden" id="tesoreria_cheques_db_ordenes_pago" size="16" maxlength="16" />		</td>
	</tr>
	<tr>
