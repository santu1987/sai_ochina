...
url='modulos/cuentas_por_pagar/orden_pago/db/cmb.sql.proveedor_orden.php?nd='+nd+"&busq_ano="+getObj('cuentas_por_pagar_db_reporte_ayo_orden_pago').value;				
//alert(url);
				...
				$("#cuentas_por_pagar_db_orden_fecha_consulta").focus(function()
				{
						...
						function consulta_orden_dosearch()
					{
						...
						function consulta_orden_gridReload()
						{
							...
							var busq_fecha_orden= jQuery("#cuentas_por_pagar_db_orden_fecha_consulta").val(); 
							var busq_opcion= jQuery("#cuentas_por_pagar_orden_db_op_oculto").val(); 
							var busq_ano= jQuery("#cuentas_por_pagar_db_reporte_ayo_orden_pago").val(); 
						...
						function crear_grid()
						{
							...
							({
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									getObj('cuentas_por_pagar_db_reporte_orden_numero_control_oculto').value=ret.id_orden;
...
<form method="post" id="form_cuentas_por_pagar_db_reporte_orden_pago" name="form_cuentas_por_pagar_db_reporte_orden_pago">
  <table   class="cuerpo_formulario">
	<tr>
	<th class="titulo_frame" colspan="4"><img src="imagenes/iconos/desktop24x24.png" style=" padding-right:5px;" align="absmiddle" />Orden de Pago n </th>
	</tr><tr>
		<th>
		  A&ntilde;o :	  </th>
	  <td>
