...
//////////////////////////////////////////
					if($compromiso!="")
					{
							$sql_doc_det3="select  sum(monto) as monto 
											from 
												doc_cxp_detalle
											inner join
												documentos_cxp
							...
							if(!$row_doc_det3->EOF)
							{
								$a_causar=$row_doc_det3->fields("monto");
							//	die($a_causar);
							}
					}else
					{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			//	echo($total_renglon);
				...
				//die($a_causar);
			//	die($valor_fact);
		  			   $responce=$partida."*".$causado."*".$pagado."*".$xxx."*".number_format($total_bi,2,',','.')."*".number_format($total_renglon,2,',','.')."*".number_format($a_causar,2,',','.')."*".number_format($s_resta,2,',','.')."*".number_format($total_bi,2,',','.')."*".number_format(round($s_resta,2),2,',','.')."*".number_format(round($valor_fact,2),2,',','.');
