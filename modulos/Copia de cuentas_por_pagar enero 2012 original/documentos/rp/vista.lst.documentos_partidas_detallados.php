...
if($dia=="31")
{
 ...
 $fechas=$dia.'/'.$mes.'/'.$ayo;
	...
	$where=" WHERE
				 ...
				 AND documentos_cxp.fecha_documento>='$desde' AND documentos_cxp.fecha_documento<='$hasta'
		 ";
//				
...
///////////////////////////////////////// caso reporte vacio///////////////////////		
		if($tipo_de_reporte=="VACIO")
		{
							...
							$pdf->Cell(60,6,$numero_control,1,0,'L',1);
							$pdf->Cell(40,6,strtoupper($tipo),1,0,'L',1);
							$pdf->Cell(40,6,$partidas,1,0,'L',1);
							$pdf->Cell(30,6,number_format($total_partidas,2,',','.'),1,0,'R',1);
							$pdf->Ln();
...
///////////////////////////////////////// caso reporte tipo///////////////////////		
		if($tipo_de_reporte=="tipo")
		{
							...
							$pdf->Cell(5,6,"",0,0,'L',0);
							$pdf->Cell(70,6,$numero_control,1,0,'L',1);
							$pdf->Cell(50,6,$partidas,1,0,'L',1);
							$pdf->Cell(50,6,number_format($total_partidas,2,',','.'),1,0,'R',1);
							$pdf->Ln();
							$total_general=$total_general+$total_partidas;
							$cont_partida=$cont_partida+1;
							$partidas="";
