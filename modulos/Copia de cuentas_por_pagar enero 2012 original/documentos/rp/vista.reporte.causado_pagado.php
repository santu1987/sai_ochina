...
<form method="post" id="form_cxp_rp_movimientos_contables_contable" name="form_cxp_rp_movimientos_contables_contable">
	<table class="cuerpo_formulario">
		...
		<td colspan="3"><input type="text" name="causado_pagado_partida" id="causado_pagado_partida" style="text-align:right" message="Ingrese una partida. " jvalkey="{valid:/[,.-_0123456789]/, cFunc:'alert', cArgs:['Año: '+$(this).val()]}"/></td>
		</tr>
		<tr>	
