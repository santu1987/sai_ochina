...
// $porcentaje_ant="0";
	...
	{$id_documento=$row->fields("id_documentos");
	 $ndoc=$row->fields("numero_documento");	
		$sql_integrado="SELECT distinct integracion_contable2.id,
								integracion_contable2.cuenta_contable,
								id_tipo_comprobante,
								integracion_contable2.descripcion as nombre_asiento, 
								referencia,
								monto_debito, 
								...
								tipo_comprobante.nombre as tipo_nombre,
								integracion_contable2.numero_comprobante
								
						 FROM 
							 integracion_contable22 
						 inner join 
						 	organismo 
						 on 
						 	integracion_contable2.id_organismo=organismo.id_organismo 
						 inner join tipo_comprobante 
						 on 
							 integracion_contable2.id_tipo_comprobante=tipo_comprobante.id
						inner join 
						cuenta_contable_contabilidad
						on 
						integracion_contable2.cuenta_contable=cuenta_contable_contabilidad.cuenta_contable
						inner join
							documentos_cxp
						on
							integracion_contable2.numero_comprobante=documentos_cxp.numero_comprobante			
						where
							integracion_contable2.debito_credito=1	
						AND
							documentos_cxp.numero_documento='$ndoc'		
		
		";	//integracion_contable2.id_documento='$id_documento'						 order by integracion_contable2.id asc 
