...
$Sql="SELECT 
				...
				$where
				group by
tipo, id_orden_compra_servicioe ,requisicion_encabezado.id_unidad_ejecutora,requisicion_encabezado.id_accion_centralizada,requisicion_encabezado.id_accion_especifica,requisicion_encabezado.id_proyecto,partida, generica, especifica, subespecifica
...
/////////////////////////////////////////////////////////////////////////////////////////	
	$sql2="SELECT    \"presupuesto_ejecutadoR\".id_presupuesto_ejecutador,
					...
					\"presupuesto_ejecutadoR\".monto_causado[".$mes."] as causa, 
