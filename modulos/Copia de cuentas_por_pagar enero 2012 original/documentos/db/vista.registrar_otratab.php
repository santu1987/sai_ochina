...
$("#list_compro").jqGrid({ 
	...
	datatype: "json",
   	colNames:['Id','Partida','Monto Comp','Monto Causado','Monto a Causar','Monto BI','Facturado por partida','partidas'],
								colModel:[
									{name:'id',index:'id', width:20,sortable:false,resizable:false,hidden:true},	
									...
									{name:'monto5',index:'monto5', width:20,sortable:false,resizable:false},
