...
//************************************************************************
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->Cell(30,6,$partida,			0,0,'R',0);
			...
			$this->Cell(30,6,		     'Nº FACTURA',			0,0,'L',1);
			$this->Cell(18,6,		     'FECHA ',			0,0,'L',1);
		//	$this->Cell(20,6,		     'MONTO.BR',			1,0,'L',0);
			$this->Cell(25,6,		     'BASE.Imp',			0,0,'L',1);
			$this->Cell(20,6,		     'ALICUOTA',			0,0,'L',1);
			$this->Cell(20,6,		     'IVA'.$iva_rep1,			0,0,'L',1);
			if($exnto=="exnto")
			{
			
						$this->Cell(20,6,		     'Comp.Exenta'.$iva_rep1,			0,0,'L',1);
	
			}

			$this->Cell(30,6,		     'TOTAL FACTURA',			0,0,'L',1);
			/*if($titulo_ant=='10')
			{
				$this->Cell(30,6,		     'AMORT.ANTICIPO',			0,0,'L',1);
			}*/
			$this->Cell(25,6,		     'RET IVA'."  ".$retencion."%",			0,0,'L',1);
			$this->Cell(35,6,		     'SUB TOTAL',			0,0,'L',1);
			if($islr_opcion=="islr")
			{
				$this->Cell(20,6,		     'RET ISLR'." ".$retencion2."%",			0,0,'L',1);
			}
			if($alpha=="ret")
			{
				$this->Cell(28,6,		     'RET EXTRAS',			0,0,'L',1);
			}
			$this->Cell(25,6,		     'TOTAL A PAGAR',			0,0,'L',1);
