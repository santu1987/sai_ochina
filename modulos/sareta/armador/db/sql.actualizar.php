...
$sqlb = "SELECT id_armador FROM sareta.armador WHERE id_armador <> $_POST[vista_id_armador] AND upper(nombre) ='".strtoupper($_POST['sareta_armador_db_vista_nombre'])."'";
