...
$sql = "SELECT id FROM sareta.planilla WHERE id= $_POST[vista_id_avisos_recalada]";
...
$sql="DELETE FROM sareta.planilla WHERE planilla.id=$_POST[vista_id_avisos_recalada]";
if (!$conn->Execute($sql)) {
