...
while (!$row->EOF) 
{
	...
	$responce->rows[$i]['cell']=array(	
															...
															substr($row->fields("nombre"),0,18),
															utf8_encode($row->fields("nombre")),
															$row->fields("rif"),
															$row->fields("nit"),
															utf8_encode($row->fields("direccion")),
															$row->fields("id_estado"),
															...
															substr($row->fields("pag_web"),0,20),
															utf8_encode($row->fields("pag_web")),
															utf8_encode($row->fields("correo_electronico")),
															substr($row->fields("contacto"),0,15),
															utf8_encode($row->fields("contacto")),
															$row->fields("cedula"),
