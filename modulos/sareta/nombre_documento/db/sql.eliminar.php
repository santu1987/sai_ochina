...
$sql = "SELECT id FROM sareta.nombre_documento WHERE id = $_POST[vista_id_nombre_documento]";
if (!$conn->Execute($sql)) die ('Error al Eliminar: '.$conn->ErrorMsg());
$row= $conn->Execute($sql);
			
$sql="DELETE FROM sareta.nombre_documento WHERE id=$_POST[vista_id_nombre_documento]";
if (!$conn->Execute($sql)) {
