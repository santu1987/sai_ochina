...
$sql = "SELECT id FROM sareta.tipo_documento WHERE id = $_POST[vista_id_tipo_documento]";
if (!$conn->Execute($sql)) die ('Error al Eliminar: '.$conn->ErrorMsg());
$row= $conn->Execute($sql);
			
$sql="DELETE FROM sareta.tipo_documento WHERE id=$_POST[vista_id_tipo_documento]";
if (!$conn->Execute($sql)) {
