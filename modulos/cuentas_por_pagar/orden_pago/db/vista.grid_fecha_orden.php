...
<td align="center">&nbsp;</td>
<td align="center" ><label >Orden:</label> </td>                  
	           <input  type="text" id="cuentas_por_pagar_db_orden_pago" maxlength="10"  
			   jVal="{valid:/^[a-zA-Z áéíóúÁÉÍÓÚñ.]{1,60}$/}"
				jValKey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚñ.]/}"/>	 

<td align="center" ><label >Proveedor:</label> </td>                  
	           <input  type="text" id="cuentas_por_pagar_db_orden_proveedor_consulta" maxlength="30"  
			   jVal="{valid:/^[a-zA-Z áéíóúÁÉÍÓÚñ.]{1,60}$/}"
				jValKey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚñ.]/}"/>	 
...
<td align="center">&nbsp;</td>
<td align="center" ><label >Estatus:</label> </td>                  
	           <select id="cuentas_por_pagar_db_estatus" name="cuentas_por_pagar_db_estatus" >
