	...
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
		$.ajax ({
			...
			success: function(data)
			{
				...
				var timeoutHnd; 
				var flAuto = true;
				$("#cuentas_por_pagar_db_estatus").change(function(){
				...
				$("#cuentas_por_pagar_db_orden_fecha_consulta").focus(function()
				{
						...
						function consulta_orden_dosearch()
					{
						...
						function consulta_orden_gridReload()
						{
							...
							var busq_estatus= jQuery("#cuentas_por_pagar_db_estatus").val(); 
							jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/orden_pago/db/cmb.sql.proveedor_orden.php?busq_proveedor_orden="+busq_proveedor_orden+"&busq_fecha_orden="+busq_fecha_orden+"&opcion="+busq_opcion+"&busq_ano="+busq_ano+"&busq_orden="+busq_orden+"&busq_estatus="+busq_estatus,page:1}).trigger("reloadGrid"); 
		//					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/cuentas_por_pagar/orden_pago/db/cmb.sql.proveedor_orden.php?busq_proveedor_orden="+busq_proveedor_orden+"&busq_fecha_orden="+busq_fecha_orden,page:1}).trigger("reloadGrid"); 
							url="modulos/cuentas_por_pagar/orden_pago/db/cmb.sql.proveedor_orden.php?busq_proveedor_orden="+busq_proveedor_orden+"&busq_fecha_orden="+busq_fecha_orden+"&opcion="+busq_opcion+"&busq_ano="+busq_ano+"&busq_orden="+busq_orden+"&busq_estatus="+busq_estatus;
						alert(url);
						}
...
/*////////////////////////////////////////////////////////////////////////////////////////////////////		
						function crear_grid()
						{
							...
							({
								...
								datatype: "json",
								colNames:['id_orden','Orden','Facturas','id_proveedor','Codigo','Proveedor','rif','ano','fecha_1','comentarios','Fecha','estatus','opcion','tipo','nombre','benef2'],
								colModel:[
									...
									{name:'fecha1',index:'fecha1', width:200,sortable:false,resizable:false},
									...
									{name:'benef2',index:'benef2', width:300,sortable:false,resizable:false,hidden:true}
...
//									getObj('cuentas_por_pagar_db_orden_proveedor_rif').value=rif2[0];
									...
									if(ret.opcion=='1')
									{
										...
										getObj('cuentas_por_pagar_db_benef').value = ret.benef2;
				...
				{      var recordset=html;
						 ...
						 if(recordset)
						{
									recordset = recordset.split("*");
										...
										documentos1=documentos.replace("{","");
										getObj('cuentas_por_pagar_db_facturas_oculto').value=documentos1.replace("}","");
										getObj('cuentas_por_pagar_db_benef').value=recordset[14];
...
<tr>
	<th>Beneficiario:</th>
	<td>
			<input type="text" id="cuentas_por_pagar_db_benef" name="cuentas_por_pagar_db_benef">	
	</td>
</tr>		
<tr>		
<th>Fecha :</th>
