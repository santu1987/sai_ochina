...
$sql_orden="SELECT 
											fecha_orden_pago,comentarios,beneficiario
										FROM 
											orden_pago
										WHERE
...
//************************************************************************
				...
				}else
				{
									...
									$beneficiario=strtoupper($row_orden_fecha->fields("beneficiario"));
									$opcion='1';
				}
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->Cell(0,10,'REPORTE DOCUMENTOS CUENTAS POR PAGAR',0,0,'C');
	        ...
	        $this->SetFont('Times','B',11);
			$this->Cell(30,6,strtoupper($nombre)."-".$beneficiario,0,0,'L',0);
			$this->SetFont('Times','B',11);
