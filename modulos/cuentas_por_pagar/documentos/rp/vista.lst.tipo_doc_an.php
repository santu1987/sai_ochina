...
$where="WHERE documentos_cxp.ano='$ano_actual'";
	...
	//************************************************************************
				class PDF extends PDF_Code128
				{
					...
					{	
						...
						$this->Cell(45,6,		     'NÚMERO DE DOCUMENTO',			0,0,'L',1);
						$this->Cell(15,6,			 'FECHA',		0,0,'L',1);
						$this->Cell(15,6,		     'REF',	0,0,'C',1);
						$this->Cell(30,6,		     'MONTO ORIGINAL',	0,0,'R',1);
						$this->Cell(35,6,		     'SALDO_DOCUMENTO',	0,0,'R',1);
						$this->Cell(20,6,		     'DIAS-VCTO',	0,0,'R',1);
...
if($id_proveedor!='')
{
		...
		$sql_cuenta="
						SELECT DISTINCT
									 ...
									 (substr(doc_cxp_detalle.partida,1,3))::integer AS partida,
								...
								$where_fecha		
								ORDER BY
									 partida,documentos_cxp.id_documentos	
		";
		...
		/***calculando dias vencidos*/
						$valor_fecha1=mktime(0,0,0,$mes2,$dia2,$ano2);
						$valor_fecha2=mktime(0,0,0,date("m"),date("d"),date("Y"));
						$valor_fecha_d=round(($valor_fecha1-$valor_fecha2)/ (60 * 60 * 24));
		/***/		
				
				$pdf->Cell(25,6,				$row_doc->fields("siglas").":".$row_doc->fields("partida"),					0,0,'L',1);
				$pdf->Cell(45,6,				$row_doc->fields("numero_documento"),					0,0,'L',1);
				...
				$pdf->Cell(35,6,				number_format($row_doc->fields("total_retenciones"),2,',','.'),					0,0,'R',1);
				$pdf->cell(20,6,                $valor_fecha_d,0,0,'R',1);
		...
		$pdf->Cell(145,6,				"TOTAL PROVEEDOR",					0,0,'R',1);
