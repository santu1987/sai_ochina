...
if(($proveedor=="")and ($tipo=="0") and  ($desde!="") and ($hasta!=""))
{
...
///////////////////////////////////////////////////////////////////////////////////////////		
					...
					$this->Cell(40,6,		     'Nº DOCUMENTO',			0,0,'L',1);
					$this->Cell(25,6,		     'TIPO',			0,0,'L',1);
					$this->Cell(15,6,		     'FECHA V.',			0,0,'L',1);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$this->Cell(30,6,		     'MONTO BRUTO',			0,0,'L',1);
					$this->Cell(30,6,		     '30 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     '60 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     '90 DIAS',			0,0,'C',1);
					$this->Cell(40,6,		     'MAS 90 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     'POR VENCERSE',			0,0,'C',1);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////							
			}
			else
...
///////////////////////////////////////////////////////////////////////////////////////////		
					...
					$this->Cell(10,6,		     '',			0,0,'R',1);
					$this->Cell(40,6,		     'Nº DOCUMENTO',			0,0,'L',1);
					$this->Cell(30,6,		     'FECHA V.',			0,0,'L',1);
					$this->Cell(30,6,		     'MONTO BRUTO',			0,0,'C',1);
					$this->Cell(30,6,		     '30 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     '60 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     '90 DIAS',			0,0,'C',1);
					$this->Cell(35,6,		     'MAS 90 DIAS',			0,0,'C',1);
					$this->Cell(30,6,		     'POR VENCERSE',			0,0,'C',1);
///////////////////////////////////////////////////////////////////////////////////////////////////////
			}	
					$this->Ln(6);
...
//$pdf->Ln();
		if($tipo_de_reporte=="VACIO")
			{					
						...
						$pdf->Cell(25,6,"Beneficiaio:"." ".strtoupper($proveedor),0,0,'L',1);
						$pdf->Ln();
						$pdf->SetFont('Arial','',9);
						$pdf->Cell(10,6,		     '',			0,0,'R',1);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////						
			...
			{	
						...
						$pdf->Cell(30,6,number_format($row->fields("monto_bruto"),2,',','.'),0,0,'C',1);
						
						$pdf->Cell(30,6,$uno_venc,0,0,'C',1);
						$pdf->Cell(30,6,$tre_venc,0,0,'C',1);
						$pdf->Cell(30,6,$sese_venc,0,0,'C',1);
						$pdf->Cell(40,6,$noventa_venc,0,0,'C',1);
						$pdf->Cell(30,6,$por_vencer,0,0,'C',1);
						$monto_total=$row->fields("monto_bruto");
						$total_general=$total_general+$monto_total;
...
if($tipo_de_reporte=="TODOS")
			{
						...
						$pdf->Cell(30,6,$tre_venc,0,0,'C',1);
						$pdf->Cell(30,6,$sese_venc,0,0,'C',1);
						$pdf->Cell(35,6,$noventa_venc,0,0,'C',1);
						$pdf->Cell(30,6,$por_vencer,0,0,'C',1);
						$monto_total=$row->fields("monto_bruto");
						$total_general=$total_general+$monto_total;
			}
