...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			if($tipo_de_reporte=="proveedor")
			{
					...
					$this->Cell(23,6,		     'COMPROMISO',			0,0,'L',1);
					$this->Cell(20,6,		     'ORD PAGO',			0,0,'L',1);
					$this->Cell(25,6,		     'M.BRUTO.',			0,0,'L',1);
					$this->Cell(20,6,		     'BASE IMP.',			0,0,'L',1);
					$this->Cell(20,6,		     '% IVA',			0,0,'L',1);
					$this->Cell(20,6,		     'RET IVA',			0,0,'L',1);
					$this->Cell(20,6,		     'RET ISLR',			0,0,'L',1);
					$this->Cell(20,6,		     'RET EXT',			0,0,'L',1);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			...
			{			$pdf->SetFont('Times','B',10);
						...
						$pdf->Cell(20,6,number_format($row->fields("monto_base_imponible"),2,',','.'),0,0,'L',1);
						$pdf->Cell(20,6,number_format($row->fields("porcentaje_iva"),2,',','.'),0,0,'L',1);
						$pdf->Cell(20,6,number_format($monto_restar,2,',','.'),0,0,'L',1);
						$pdf->Cell(20,6,number_format($islr,2,',','.'),0,0,'L',1);
						$pdf->Cell(20,6,number_format($retenciones,2,',','.'),0,0,'L',1);
