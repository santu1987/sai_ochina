				...
				*///************************************************************************
				...
				//////////////////////////////////////////////////////////////////////////////////////////////////////////			
									...
									{*/	$this->Cell(0,10,'RETENCIONES'." ".$ret_tipo,0,0,'C');
										...
										$this->Cell(40,6,		     'DOCUMENTO',			0,0,'L',1);
										$this->Cell(40,6,		     'BASE.I.',			0,0,'C',1);
										$this->Cell(40,6,		     '% RETENIDO',			0,0,'C',1);
										$this->Cell(40,6,		     ' VALOR RETENIDO',			0,0,'C',1);
								//	}
				/////////////////////////////////////////////////////////////////////////////////////////////////////////
							}else
				...
				//////////////////////////////////////////////////////////////////////////////////////////////////////////			
							...
							$this->Cell(55,6,		     'BASE.I.',			0,0,'C',1);
							$this->Cell(55,6,		     '% RETENIDO',			0,0,'C',1);
							$this->Cell(55,6,		     'VALOR RETENIDO',			0,0,'C',1);
				/////////////////////////////////////////////////////////////////////////////////////////////////////////
							}
							$this->Ln(6);
						}
				...
				//////////////////////////////////////////////////////////////////////////////////////////////////////		
							...
							{*/
								...
								$pdf->Cell(50,6,strtoupper($row->fields("proveedor")),0,0,'L',1);
								$pdf->Cell(35,6,$fecha,0,0,'L',1);
								$pdf->Cell(40,6,$row->fields("numero_documento"),0,0,'C',1);
								$pdf->Cell(40,6,number_format($row->fields("monto_base_imponible"),2,',','.'),0,0,'C',1);
								$pdf->Cell(40,6,number_format($porc,2,',','.'),0,0,'C',1);
								$pdf->Cell(40,6,number_format($monto_retener,2,',','.'),0,0,'C',1);
							//	}
				//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
							}
				if($tipo_de_reporte=="proveedor")
				...
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								...
								$pdf->Cell(55,6,number_format($row->fields("monto_base_imponible"),2,',','.'),0,0,'C',1);
								$pdf->Cell(55,6,number_format($porc,2,',','.'),0,0,'C',1);
								$pdf->Cell(55,6,number_format($monto_retener,2,',','.'),0,0,'C',1);
				/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
							}		
											$pdf->Ln();
											$row->MoveNext();
