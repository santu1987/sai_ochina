 ...
 if(isset($_GET['usua']))
{
	...
	if($usua!="")
	{
		$where.=" AND documentos_cxp.ultimo_usuario='$usua'";
	}
}
...
if(($proveedor=="")and($beneficiario=="")and($usua=="") and ($tipo=="0") and  ($desde!="") and ($hasta!=""))
{
	$tipo_de_reporte="VACIO";
}else
if(($usua!="")and($proveedor=="")and($beneficiario=="") and ($tipo=="0") and  ($desde!="") and ($hasta!=""))
{
...
if((($proveedor!="")or($beneficiario!=""))and ($usua=="")and ($tipo=="0") and  ($desde!="") and ($hasta!=""))
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////		
						...
						$pdf->Cell(35,6,substr(strtoupper($proveedor),0,25),0,0,'L',1);
