...
$where = " WHERE 1=1  ";
$numero_comprobante=$_POST[cxp_integracion_numero_rp_desde];
$ano=$_POST[cxp_integracion_numero_rp_ayo];
if($ano!="")
{
...
$Sql="
		select 
				distinct (integracion_contable.numero_comprobante::varchar) as numero_comprobante
			from 
				integracion_contable
		$where
