...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						function crear_grid()
						{
							...
							({
								...
								url:'modulos/cuentas_por_pagar/documentos/db/cmb.sql.proveedor_compromiso.php?nd='+nd+"&proveedor="+getObj('cuentas_por_pagar_db_proveedor_id').value,
								datatype: "json",
								colNames:['Nombre','Nombre','Compromiso','N Orden','Fecha Orden','Monto_Orden','Monto_fact','tipo','Disponible','Monto Ant','Porcentaje_Ant','iva','id_prove','codigo_prove','partida','concepto','cuenta_orden'],
								colModel:[
    ...
    <th colspan="2">
    	<table  class="clear" width="100%" border="0">
			<tr>
				  ...
				  <input type="text" name="monto_causar_comp_v" id="monto_causar_comp_v"  readonly="readonly" value="0,00" style="display:none;text-align:right" align="right"  >				   
