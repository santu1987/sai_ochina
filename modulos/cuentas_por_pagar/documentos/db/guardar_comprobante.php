...
$haber=0;
$resta=0;
$comprobante_text=$_POST[cuentas_por_pagar_numero_pr_numero_comprobante2];
...
//				echo($comprobante);die("!");
	...
	$sql_comp_prueba="SELECT * FROM movimientos_contables where numero_comprobante='$comprobante' and secuencia='$secuencia' and estatus!='3'";
	//die($sql_comp_prueba);
...
$vector=$_POST['cuentas_por_pagar_db_facturas_lista'];
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
												...
												INSERT INTO 
																		...
																		(
																			...
																			'$_POST[cuentas_por_pagar_integracion_cuenta]',
																			'$_POST[cuentas_por_pagar_integracion_desc_asiento]',
																			'$_POST[cuentas_por_pagar_integracion_ref]',
																			'$_POST[cuentas_por_pagar_debe_haber_integracion_estatus]',
																			$monto_debito,
																			$monto_credito,
