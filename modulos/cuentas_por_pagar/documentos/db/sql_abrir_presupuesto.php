...
//$vector=$_POST['cuentas_por_pagar_db_facturas_lista'];
						...
						sort($facturas);*/
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//aqui consulto los id de los documentos relacionados a el numero de compromiso y a esos id son los q voy a causar...
$sql_facturas_com="
					SELECT
							id_documentos
					FROM
...
{
//
	$facturas[$contador]=$rs_factura_com->fields("id_documentos");
	//
	if($contador=="0")
	{
		$facturas_vec=$rs_factura_com->fields("id_documentos");
	}else
	if($contador!="0")
	{
		$facturas_vec=$facturas_vec.";".$rs_factura_com->fields("id_documentos");
	}
	//
	$contador=$contador+1;	
