	...
	if(isset($_GET[compromiso]))
		{
			...
			$where.="AND 
				...
				//modificacion  12/09/2012:hay casos en q deben unirse facturas de distintos compromisos... eso no se especifico y por ello ahora comente estas lineas..	
...
//datos
		...
		$straendo=$row->fields("sustraendo");
...
//-/si es factura con anticipo
 if(($row->fields("tipo_documentocxp")==$tipos_fact)&&($row->fields("amortizacion")!='0'))
 {
		...
		//$base=$monto;
		$p_islr=($base*($ret_islr/100))-$straendo;
 ...
 //otro documento
 else
	{
		...
		$p_islr=($monto*($ret_islr/100))-$straendo;
	}
