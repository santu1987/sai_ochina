...
// el deber ser es que la fecha de cmprobante sea la del dia e q se crea la factura, per no es asi para esta prueba..asi que cambio la fecha del comprobante con la fecha de la factura...
