						...
						//////////paso2:consultar si existe
								...
								cache: false,
								 success:function(html)
								 {
									...
									valor2=parseFloat(getObj('valor_maximo').value);
									//alert(rest);
									//alert(valor2 );
										if(rest>valor2)
										{
										alert("   excede   el monto comprometido por partida  ");
									...
									if(getObj('partida_comp').value!="")
									{
										...
										comprometido=getObj('comprometido').value;
												...
												{	
													...
													/*valor2=parseFloat(getObj('valor_maximo').value);
													valor_causar_comp=parseFloat(getObj('monto_causar_comp').value);
													otrovalor=parseFloat(getObj('valor_fact').value);
													suma=valor_causar_comp+otrovalor;
...
$("#list_compro").jqGrid({ 
	...
	datatype: "json",
   	colNames:['Id','Partida','Monto Comp','Monto Causado','Monto a Causar','Monto BI','Facturado por partida'],
								colModel:[
									...
									{name:'monto5',index:'monto4', width:20,sortable:false,resizable:false}
								],
   	rowNum:10,
   	rowList:[10,20,30],
   	imgpath: 'utilidades/jqgrid_demo/themes/basic/images',
	...
	onSelectRow: function(id){ //alert(id);
		...
		if(idd && idd!==lastsel){
		$.ajax({
			url:'modulos/cuentas_por_pagar/documentos/db/sql.partidas_compromiso.php?id='+idd+'&fecha='+fecha+'&compromiso='+compromiso+'&iva='+getObj('cuentas_por_pagar_db_iva').value,
            data:dataForm('form_cuentas_por_pagar_db_documentos'), 
			type:'GET',
			cache: false,
			 success:function(html)
...
alert(html);
			...
			//	alert(recordset[4]);
				...
				getObj('valor_fact').value=recordset[9];
...
-->						<input type="hidden"  id="cuentas_por_pagar_db_numero_control_oculto" name="cuentas_por_pagar_db_numero_control_oculto"/>					</td>
		...
		<th>Fecha Vencimiento:</th>
			...
			<tr style="display:none">
			  ...
			  <input type="hidden" name="cuentas_por_pagar_db_op_oculto" id="cuentas_por_pagar_db_op_oculto" value="1" />
