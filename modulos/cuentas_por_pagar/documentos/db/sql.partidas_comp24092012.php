...
/*aqui saco el total renglon y base imponible de todas las partidas q entre la partida/genericasean las mismas*/
$sql="SELECT 
...
///////////////////////////////////////////////////////////////////////////////////	
	...
	$rowx=& $conn->Execute($sql2);echo($sql2);
...
while(!$rowx->EOF)		
{
	...
	if($i=="0")
	{/*este ciclo acumula  por partida/generica los id/partidas que forman parte de dicha agrupacion slo la prmera vez se realizara esta agrupacion*/
	/*******************************************************************/
		if($acum_id=="")
...
//$acum_compromiso=1000;
	...
	$a_causar="0,00";
			...
			$partida=$row->fields("partida").$row->fields("generica");
/*cambien row2 por row*/
			/*if($idss!="")
				{*/
					//////////////////////////////////////////
					if($compromiso!="")
