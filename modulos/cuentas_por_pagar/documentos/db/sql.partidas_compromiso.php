...
$id_presu2=$vector[$i];
		$sql="SELECT	    \"presupuesto_ejecutadoR\".id_presupuesto_ejecutador,
							...
							\"presupuesto_ejecutadoR\".monto_causado[".$mes_orden."] as causado,  
					...
					id_presupuesto_ejecutador
							...
							";
		//nota cambiar luego mes_orden por mes en la linea del causado 11/09/2012					
						//	die($sql);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			//	echo($total_renglon);
				...
				//die($a_causar);
			//	die($valor_fact);
		  			   $responce=$partida."*".$causado."*".number_format($pagado,2,',','.')."*".$xxx."*".number_format($total_bi,2,',','.')."*".number_format($total_renglon,2,',','.')."*".number_format($a_causar,2,',','.')."*".number_format($s_resta,2,',','.')."*".number_format($total_bi,2,',','.')."*".number_format(round($s_resta,2),2,',','.')."*".number_format(round($valor_fact,2),2,',','.')."*".$partida_v;
