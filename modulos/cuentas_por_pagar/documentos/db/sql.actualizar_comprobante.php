...
$tipo_saldo=$_POST[cuentas_por_pagar_integracion_tipo];
//
$debe=0;
$haber=0;
$resta=0;
$cerrado="";
//////////////////////////////////-PROCESO EN CASO DE QUE EL USUARIO MODIFIQE LA FECHA O TIPO DE COMPROBANTE
$comprobante=$_POST[cuentas_por_pagar_numero_pr_numero_comprobante2];
$tipo=$_POST[cuentas_por_pagar_integracion_tipo];
$comprobante_ant=$_POST[cuentas_por_pagar_numero_pr_numero_comprobante2];
...
if($longitud=='14')
{
	$mes_ant_v=substr($comprobante,10,1);	
}
		...
		//	die("h");
			...
			$sql_update="UPDATE movimientos_contables
						   SET 
							   ...
							   referencia='$_POST[cuentas_por_pagar_integracion_ref]',
...
$monto = str_replace(".","",$_POST[cuentas_por_pagar_debe_haber_integracion_monto_p]);
$monto2 = str_replace(",",".",$monto);
$debe_haber=$_POST[cuentas_por_pagar_debe_haber_integracion_estatus];
if($debe_haber==1)
{
	$monto_debito=$monto2 ;
	$monto_credito=0;
...
$debe_haber_op=$_POST[cuentas_por_pagar_debe_haber_integracion_estatus];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			$sql_comprobante="select 
							...
							movimientos_contables.id_organismo = $_SESSION[id_organismo]
							and
							movimientos_contables.id_movimientos_contables=$_POST[cxp_id_comprobante]								
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$id_cc_g=$_POST[cuentas_por_pagar_integracion_cuenta];
$id_aux_g=$_POST[cuentas_por_pagar_integracion_id_aux];
/////////			
...
$fecha_comprobante_pagina=$_POST[cuentas_por_pagar_db_fecha_f];
		...
		////////////////////////////////LA MODIFICACION A LA TABLA DE MOVIMIENTOS CNTABLES
								$sql_up="UPDATE	
														...
														set
															...
															ultimo_usuario= ".$_SESSION['id_usuario'].",
															ultima_modificacion= '".date("Y-m-d H:i:s")."',
															descripcion='$_POST[cuentas_por_pagar_integracion_desc_asiento]',
