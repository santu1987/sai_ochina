...
$where = "WHERE 1=1";
if($busq_nombre!='')
	$where.= " AND  (lower(tipo_desincorporaciones.nombre) LIKE '%$busq_nombre%')";
////////////////////
...
$Sql="
			SELECT 
				tipo_desincorporaciones.id_tipo_desincorporaciones,
...
while (!$row->EOF) 
{
	$responce->rows[$i]['id']=$row->fields("id_tipo_desincorporaciones");

	$responce->rows[$i]['cell']=array(	
															$row->fields("id_tipo_desincorporaciones"),
															$row->fields("nombre"),
