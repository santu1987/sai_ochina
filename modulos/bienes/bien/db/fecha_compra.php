...
<script language="javascript">
	if(parent.document.form_bien_compra.bienes_db_fecha_comp.value!='')
		document.form1.fecha.value=parent.document.form_bien_compra.bienes_db_fecha_comp.value;
	document.form1.fecha.style.display='none';	
	displayCalendar(document.form1.fecha,'dd-mm-yyyy',this);
	//document.form1.fecha.style.display = 'none';
	function enviar(){
		parent.document.form_bien_compra.bienes_db_fecha_comp.value = document.form1.fecha.value;
		parent.document.getElementById('fecha_compra').style.visibility = 'hidden';
		parent.document.form_bien_compra.bienes_db_fecha_comp.focus();
	}
</script>