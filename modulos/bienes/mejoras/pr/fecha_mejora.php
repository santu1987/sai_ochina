...
<script language="javascript">
	if(parent.document.form_mejoras_bien.mejoras_bien_pr_fecha_mejora.value!='')
		document.form1.fecha.value=parent.document.form_mejoras_bien.mejoras_bien_pr_fecha_mejora.value;
	document.form1.fecha.style.display='none';	
	displayCalendar(document.form1.fecha,'dd-mm-yyyy',this);
	//document.form1.fecha.style.display = 'none';
	function enviar(){
		parent.document.form_mejoras_bien.mejoras_bien_pr_fecha_mejora.value = document.form1.fecha.value;
		parent.document.getElementById('fecha_mejoras').style.visibility = 'hidden';
		parent.document.form_mejoras_bien.mejoras_bien_pr_fecha_mejora.focus();
	}
</script>