...
$Sql="
			SELECT 
				count(\"orden_compra_servicioE\".numero_orden_compra_servicio)
			FROM 
...
$Sql = "	
			...
			WHERE 
				(\"orden_compra_servicioE\".id_organismo=$_SESSION[id_organismo] )
			AND
				(\"orden_compra_servicioE\".numero_orden_compra_servicio<>'' OR \"orden_compra_servicioE\".numero_orden_compra_servicio<>'0') 
			AND
				unidad_ejecutora.id_unidad_ejecutora  = $unidad
			AND 
				numero_orden_compra_servicio != '0'
