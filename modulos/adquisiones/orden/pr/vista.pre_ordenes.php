...
//					alert('El articulo del renglon '+recordset[1]+' no tiene disponibilidad presupuestaria');
					setBarraEstado("<div id='mensaje'><p><img align='absmiddle' src='imagenes/iconos/folder_important.png />EL ARTICULO DEL RENGL&Oacute;N "+recordset[1]+" NO TIENE DISPONIBILIDAD PRESUPUESTARIA<br>FALTAN "+recordset[2]+" PARA PODER REALIZAR LA OPERACION</p></div>",true,true);
				}
				if (recordset[0] > 1){
				getObj("ordenes_pr_reglon_pendiente").value = recordset[1];
					//alert('Los articulos de los renglones '+recordset[1]+' no tienen disponibilidad presupuestaria');
					setBarraEstado("<div id='mensaje'><p><img align='absmiddle' src='imagenes/iconos/folder_important.png />LOS ARTICULOS DE LOS RENGLONES "+recordset[1]+" NO TIENEN DISPONIBILIDAD PRESUPUESTARIA<br>FALTAN "+recordset[2]+" PARA PODER REALIZAR LA OPERACION</p></div>",true,true);
				}
				//setBarraEstado(html);
...
<input type="hidden" name="ordenes_pr_reglon_pendiente" id="ordenes_pr_reglon_pendiente"  />
	...
	<table class="cuerpo_formulario">
		<tr>
			<th class="titulo_frame" colspan="2"><img src="imagenes/iconos/desktop24x24.png" style="padding-right:8px;" align="absmiddle" /><!--Convertir Cotizaci&oacute;n a -->Convertir Orden de Compra/Servicios</th>
		</tr>
		<tr>
		...
		<tr>
			<th>Concepto</th>
			<td><label>
			  <textarea name="ordenes_pr_concepto" cols="97" id="ordenes_pr_concepto"></textarea>
			</label></td>
		</tr>
		<tr>
			<th>Comentarios</th>
