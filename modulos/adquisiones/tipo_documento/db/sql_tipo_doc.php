...
$where = " WHERE 1 = 1 ";
if ($busq_nombre!='')
$where.= " AND lower(tipo_documento.nombre) like '%$busq_nombre%' ";
$limit = 15;
if(!$sidx) $sidx =1;
...
$Sql="
			...
			INNER JOIN 
				organismo 
			ON 
				tipo_documento.id_organismo = organismo.id_organismo ".$where."
			AND
				(tipo_documento.id_organismo = ".$_SESSION['id_organismo'].")";
