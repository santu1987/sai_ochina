...
$Sql="
			...
			ON
				...
				WHERE 
					...
					AND 
					(\"solicitud_cotizacionE\".numero_cotizacion='$nro' )
...
if (!$row->EOF) 
{
	...
	$responce =$row->fields("numero_cotizacion").".". $row->fields("id_proveedor").".". $row->fields("proveedor").".". $row->fields("id_unidad_ejecutora").".".$row->fields("unidad_ejecutora").".".$row->fields("id_solicitud_cotizacione").".".$row->fields("titulo").".";
