...
$("#requisiones_pr_btn_anadir").click(function(){
	if($('#form_pr_requisiones').jVal())
	{
		...
		$.ajax (
		{
		url: "modulos/adquisiones/requisiciones/db/sql.requisiciones_rec.php",
			...
			//alert("modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+resultado[1]+'&id_unidadd='+getObj('requisiones_pr_unidad_id').value);
				if (resultado[0]=="Ok")
				{
					//setBarraEstado(mensaje[registro_exitoso],true,true);
					//clearForm('form_pr_requisiones');
					jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+resultado[1]+'&id_unidadd='+getObj('requisiones_pr_unidad_id').value,page:1}).trigger("reloadGrid");
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/adquisiones/requisiciones/db/sql_busqueda_requisicion_ad.php?busq_requi="+busq_requi+"&busq_asunt="+busq_asunt,page:1}).trigger("reloadGrid"); 
			}	
				crear_grid();
		...
		function crear_grid()
						{
							...
							({
								...
								url:'modulos/adquisiones/requisiciones/db/sql_busqueda_requisicion_ad.php?nd='+nd,
								datatype: "json",
								colNames:['Nº Requisicion','Año','id_proyecto','id_accion_centralizada','id_accion_especifica','Asunto','Codigo','Proyecto/Accion Central','Prioridad','Comentario','ano_csc','id_tipo_documento','Observacion','Accion Especifica','Codigo','id_unidad','Unidad','Codigo_unidad'],
								colModel:[
								...
								getObj('requisiones_pr_numero_requision').value = ret.numero_requisicion;
									...
									getObj('requisiones_pr_unidad_id').value = ret.id_unidadd;
									getObj('requisiones_pr_unidad').value = ret.unidadd;
									getObj('requisiciones_pr_codigo_unidad').value = ret.codigo_unidadd;
									 
									getObj('requisiones_pr_obesrvacion').value = ret.observacion;
									getObj('requisiones_pr_numero').value = ret.numero_requisicion;
									dialog.hideAndUnload();
									
									jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+ret.numero_requisicion+"&id_unidadd="+ret.id_unidadd,page:1}).trigger("reloadGrid");
					 			},
						...
						function crear_grid()
						{
							...
							({
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									dialog.hideAndUnload();
									jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+ret.nro_requision,page:1}).trigger("reloadGrid");
...
$("#requisiones_pr_btn_consultar_unidad").click(function() {
	...
	$.post("modulos/adquisiones/requisiciones/db/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/adquisiones/requisiciones/db/cmb.sql.unidad.php?nd='+nd+'&anio='+getObj('requisiones_pr_ano').value,
								datatype: "json",
								...
								onSelectRow: function(id){
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('requisiones_pr_unidad_id').value = ret.id;
									getObj('requisiciones_pr_codigo_unidad').value = ret.codigo
									getObj('requisiones_pr_unidad').value = ret.denominacion;
									getObj('requisiones_pr_accion_central_id').value = ""
									...
									getObj('requisiones_pr_accion_central').disabled="";
	...
	$.post("modulos/adquisiones/requisiciones/db/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/adquisiones/requisiciones/db/cmb.sql.proyecto_re.php?nd='+nd+'&anio='+getObj('requisiones_pr_ano').value+'&unidad='+getObj('requisiones_pr_unidad_id').value,
								datatype: "json",
...
{
//alert('modulos/adquisiones/requisiciones/db/cmb.sql.accion_central.php?nd='+nd+'&anio='+getObj('requisiones_pr_ano').value+'&unidad='+getObj('requisiones_pr_unidad_id').value);
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/adquisiones/requisiciones/db/grid_requisiciones.php", { },
                        function(data)
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/adquisiones/requisiciones/db/cmb.sql.accion_central_rec.php?nd='+nd+'&anio='+getObj('requisiones_pr_ano').value+'&unidad='+getObj('requisiones_pr_unidad_id').value,
								datatype: "json",
	...
	$.post("modulos/adquisiones/requisiciones/db/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								loadtext: "Recuperando Información del Servidor",		
								//url:urls,
 								url:'modulos/adquisiones/requisiciones/db/cmb.sql.accion_especifica_rec.php?nd='+nd+'&anio='+getObj('requisiones_pr_ano').value+'&unidad='+getObj('requisiones_pr_unidad_id').value+'&accion_central='+getObj('requisiones_pr_accion_central_id').value+'&proyecto='+getObj('requisiones_pr_proyecto_id').value,	
								datatype: "json",
...
{
	urls='modulos/adquisiones/requisiciones/db/cmb.sql.partida_rec.php?nd='+nd+'&unidad='+getObj('requisiones_pr_unidad_id').value+'&unidad_es='+getObj('requisiones_pr_accion_especifica_id').value+'&accion='+getObj('requisiones_pr_accion_central_id').value+'&proyecto='+getObj('requisiones_pr_proyecto_id').value+'&gasto='+getObj('requisiones_pr_tipo_doc').value;
		//alert(urls);  
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/adquisiones/requisiciones/db/grid_requisiciones.php", { },
...
clearForm('form_pr_requisiones');
jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php"}).trigger("reloadGrid");
...
({ 
	...
	loadtext: "Recuperando Información del Servidor",
	url:'modulos/adquisiones/requisiciones/co/sql.consulta23.php?nd='+new Date().getTime(),
	datatype: "json",
...
$("#list_requisiones").jqGrid({
	...
	url:'modulos/adquisiones/requisiciones/co/sql.consulta23.php?nd='+new Date().getTime()+'&id_unidadd='+getObj('requisiones_pr_unidad_id').value,
	datatype: "json",
							...
							$.ajax (
								...
								url: "modulos/adquisiones/requisiciones/db/sql.actualizar.php?id="+id_deta+"&descripcion="+descrip,
									...
									success: function(html)
									{
										...
										{
											setBarraEstado(mensaje[registro_exitoso],true,true);
											jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+getObj('requisiones_pr_numero').value,page:1}).trigger("reloadGrid");
											//clearForm('form_pr_requisiones');
										}
										else
										{
	...
	//cellEdit: true,
	//url:'modulos/adquisiones/requisiciones/co/sql.consulta23.php',
			...
			url: "modulos/adquisiones/requisiciones/db/sql.eliminar.php?id="+gsr+"&requi="+getObj('requisiones_pr_numero').value,
				...
				success: function(html)
				{
					if (html=="Ok")
					{
						...
						jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?numero_requision="+getObj('requisiones_pr_numero').value+'&id_unidadd='+getObj('requisiones_pr_unidad_id').value,page:1}).trigger("reloadGrid");
						//clearForm('form_pr_requisiones');
					}else if (html=="cotizacion_existe")
					{
						setBarraEstado(mensaje[convertirda],true,true);
...
{ 
	jQuery("#list_requisiones").setGridParam({url:"modulos/adquisiones/requisiciones/co/sql.consulta23.php?unidad="+getObj('requisiones_pr_unidad_id').value,page:1}).trigger("reloadGrid"); 
} 
...
<table class="cuerpo_formulario">
   ...
   <tr>
	...
	N&ordm; Requisici&oacute;n
          <input name="requisiones_pr_numero"  type="text" id="requisiones_pr_numero"  maxlength="10" 
 ...
 <tr>
	...
	<ul class="input_con_emergente">
		<li>			
				<input name="requisiciones_pr_codigo_unidad" type="text" id="requisiciones_pr_codigo_unidad"  maxlength="5" size="5"
				...
				jValKey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚ1234567890]/, cFunc:'alert', cArgs:['Nombre: '+$(this).val()]}"/>
       			 <input type="text" name="requisiones_pr_unidad" id="requisiones_pr_unidad" 
				style="width:62ex;" maxlength="60"  message="Introduzca el Nombre de la Unidad." />
       			 <input type="hidden" name="requisiones_pr_unidad_id" id="requisiones_pr_unidad_id" />
        </li>
		<li id="requisiones_pr_btn_consultar_unidad" class="btn_consulta_emergente"></li>
	</ul>	
	</td>
  </tr>
  <tr>
	...
	<ul class="input_con_emergente">
		<li>			
				<input name="requisiciones_pr_codigo_central" type="text" id="requisiciones_pr_codigo_central"  maxlength="6" size="6"
  ...
  <tr>
	...
	<ul class="input_con_emergente">
		<li>
				<input name="requisiones_pr_codigo_proyecto" type="text" id="requisiones_pr_codigo_proyecto"  maxlength="6" 
  ...
  <tr>
    ...
    <td>
	 <ul class="input_con_emergente">
		<li>	
		<input name="requisiciones_pr_accion_especifica_codigo" type="text" id="requisiciones_pr_accion_especifica_codigo"  maxlength="6" size="6"
