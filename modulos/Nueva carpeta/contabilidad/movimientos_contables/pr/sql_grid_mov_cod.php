...
$where = " WHERE 1=1 ";
$numero_comprobante=$_POST[contabilidad_recuve_pr_numero_comprobante];
if($numero_comprobante!="")
{
	$where.="and numero_comprobante='$numero_comprobante'";
}else
die("vacio");
...
$Sql="
		select 
				distinct movimientos_contables.numero_comprobante
			from 
				movimientos_contables
		$where
