...
function(val)
 {
	...
	{	*/
					...
					$.ajax (
								{
									url: "modulos/tesoreria/cheques/pr/cmb.sql.precheque.anular2.php",
									data:dataForm('form_tesoreria_pr_cheque_anular'),
									type:'POST',
									cache: false,
									success: function(html)
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas_anular.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_anular_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid"); 
				}	
				...
				{	ano_dosearch();
					...
					function ano_gridReload()
					{
							...
							var busq_cuenta= jQuery("#tesoreria_cheques_chequeras_pr_cuenta").val(); 
jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas_anular.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_anular_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid");
						url="modulos/tesoreria/cheques/pr/sql_grid_cuentas_anular.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_anular_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta;
						//alert(url);
						}
						...
						function crear_grid()
						{
							...
							({
								...
								colModel:[
									...
									{name:'nombre_banco',index:'nombre_banco', width:160,sortable:false,resizable:false,hidden:true},
									{name:'cuentas',index:'cuentas', width:200,sortable:false,resizable:false,hidden:true},
									{name:'secuencia',index:'secuencia', width:100,sortable:false,resizable:false,hidden:true},
									...
									{name:'id2',index:'id2', width:100,sortable:false,resizable:false,hidden:true},
