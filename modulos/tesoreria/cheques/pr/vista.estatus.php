...
urls='modulos/tesoreria/cheques/pr/sql.estatus.php?combo='+getObj('tesoreria_estatus_db_unidad').value+"&fecha="+getObj('fecha_proceso').value;
//setBarraEstado(urls);
$("#list_estatus").jqGrid
({ 
	height:270,
...
{ 
	...
	//alert("petrobon sansone jaaja");
	  jQuery("#list_estatus").setGridParam({url:"modulos/tesoreria/cheques/pr/sql.estatus.php?tesoreria_busqueda_banco_estatus="+tesoreria_busqueda_banco_estatus+"&tesoreria_busqueda_cuenta_estatus="+tesoreria_busqueda_cuenta_estatus+"&tesoreria_busqueda_proveedor_estatus="+tesoreria_busqueda_proveedor_estatus+"&tesoreria_busqueda_beneficiario_estatus="+tesoreria_busqueda_beneficiario_estatus+"&combo="+getObj('tesoreria_estatus_db_unidad').value+"&fecha="+getObj('fecha_proceso').value,page:1}).trigger("reloadGrid");
url="modulos/tesoreria/cheques/pr/sql.estatus.php?tesoreria_busqueda_usuario_estatus="+tesoreria_busqueda_usuario_estatus+"&tesoreria_busqueda_banco_estatus="+tesoreria_busqueda_banco_estatus+"&tesoreria_busqueda_cuenta_estatus="+tesoreria_busqueda_cuenta_estatus+"&tesoreria_busqueda_proveedor_estatus="+tesoreria_busqueda_proveedor_estatus+"&tesoreria_busqueda_beneficiario_estatus="+tesoreria_busqueda_beneficiario_estatus+"&combo="+getObj('tesoreria_estatus_db_unidad').value+"&fecha="+getObj('fecha_proceso').value;
//alert(url);
...
{	  
 	jQuery("#list_estatus").setGridParam({url:"modulos/tesoreria/cheques/pr/sql.estatus.php?tesoreria_busqueda_usuario_estatus="+getObj('tesoreria_estatus_banco_nombre_usuario').value+"&tesoreria_busqueda_banco_estatus="+getObj('tesoreria_estatus_banco_nombre_banco').value+"&tesoreria_busqueda_cuenta_estatus="+getObj('tesoreria_estatus_banco_numero_cuenta').value+"&tesoreria_busqueda_proveedor_estatus="+getObj('tesoreria_estatus_banco_nombre_proveedor').value+"&tesoreria_busqueda_beneficiario_estatus="+getObj('tesoreria_estatus_banco_busqueda_beneficiario').value+"&combo="+getObj('tesoreria_estatus_db_unidad').value+"&fecha="+getObj('fecha_proceso').value,page:1}).trigger("reloadGrid");
	url="modulos/tesoreria/cheques/pr/sql.estatus.php?tesoreria_busqueda_usuario_estatus="+getObj('tesoreria_estatus_banco_nombre_usuario').value+"&tesoreria_busqueda_banco_estatus="+getObj('tesoreria_estatus_banco_nombre_banco').value+"&tesoreria_busqueda_cuenta_estatus="+getObj('tesoreria_estatus_banco_numero_cuenta').value+"&tesoreria_busqueda_proveedor_estatus="+getObj('tesoreria_estatus_banco_nombre_proveedor').value+"&tesoreria_busqueda_beneficiario_estatus="+getObj('tesoreria_estatus_banco_busqueda_beneficiario').value+"&combo="+getObj('tesoreria_estatus_db_unidad').value+"&fecha="+getObj('fecha_proceso').value;
	alert(url);
setBarraEstado('');
}
      ...
      <td class="celda_consulta"><div class="div_busqueda">&nbsp;Unidad:TESORERIA</div>
          ...
          <table  class="cuerpo_formulario" width="658" border="0">
			...
			<input type="text" name="tesoreria_estatus_banco_busqueda_beneficiario" id="tesoreria_estatus_banco_busqueda_beneficiario"  maxlength="25" size="25" />
			 ...
			 <input name="fecha_proceso" type="text" id="fecha_proceso" value="<?php echo date("d-m-Y"); ?>" size="7" readonly="true" jval="{valid:/^[0-9/-]{1,60}$/, message:'Fecha Invalida', styleType:'cover'}"
			/>
