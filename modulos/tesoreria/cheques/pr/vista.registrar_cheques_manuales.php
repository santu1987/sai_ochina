...
function nombre_beneficiario()
{
	if(getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value=="0")
	{
		getObj('tr_empleado2').style.display='';
		getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value="1";
	}else
	if(getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value=="1")
	{
		getObj('tr_empleado2').style.display='none';
		getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value="0";
	}
...
$.ajax (
		{
			...
			{//alert(html);
				if((html!='Error_impresion' )&&(html!='chequera_agotada')&&(html!='firma_inactiva')&&(html!='no_disponible_saldo')&&(html!="cerrado"))
				{
					...
					url="pdf.php?p=modulos/tesoreria/cheques/rp/vista.lst.cheque_manual.php¿id_banco="+getObj('tesoreria_cheque_manual_db_banco_id_banco').value+"@opcion="+getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value+"@ncheque="+recordset[0]+"@ncuenta="+getObj('tesoreria_cheque_manual_db_n_cuenta').value+"@proveedor="+getObj('tesoreria_cheque_manual_pr_proveedor_id').value+"@caducidad="+getObj('tesoreria_cheque_manual_pr_caducidad').value+"@endosable="+getObj('tesoreria_cheque_manual_db_endosable_oculto').value+"@secuencia="+recordset[1]; 
				//alert(url);
					openTab("cheques",url);
			 		modificar_inactivo_manual();
					limpiar_manual();
...
setBarraEstado("");
	...
	getObj('tr_empleado2').style.display="none";
	getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value='0';
	getObj('tesoreria_cheque_manual_db_otro_beneficiario').checked="";	
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_manual_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid"); 
				}	
				...
				{	ano_dosearch();
					...
					function ano_gridReload()
					{
							...
							var busq_cuenta= jQuery("#tesoreria_cheques_chequeras_pr_cuenta").val(); 
jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_manual_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid");
						url="modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_manual_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta;
						//alert(url);
						}
...
{	
*/		var nd=new Date().getTime();
url='modulos/tesoreria/cheques/pr/cmb.sql.precheque_manual.php?nd='+nd+"&opcion="+getObj('tesoreria_cheque_manual_pr_op_oculto').value+"&proveedor="+getObj('tesoreria_cheque_manual_pr_proveedor_id').value;
//alert(url);
//+"&proveedor="+getObj('tesoreria_cheque_manual_pr_proveedor_id').value+"&beneficiario="+getObj('tesoreria_cheque_manual_pr_empleado_codigo').value;
		setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
		$.post("modulos/tesoreria/cheques/pr/grid_cheques.php", { },
							function(data)
                        {								
						...
						function crear_grid()
						{
							...
							({
								...
								url:'modulos/tesoreria/cheques/pr/cmb.sql.precheque_manual.php?nd='+nd+"&opcion="+getObj('tesoreria_cheque_manual_pr_op_oculto').value+"&proveedor="+getObj('tesoreria_cheque_manual_pr_proveedor_id').value,
								datatype: "json",
								colNames:['Id','N Precheque','Id Banco','Banco','N Cuenta','id_proveedor','codigo_proveedor','Proveedor','Monto','Concepto','porcentaje','opcion','','','Beneficiario','Monto'],
								colModel:[
									{name:'id',index:'id', width:50,sortable:false,resizable:false,hidden:true},
									...
									{name:'monto',index:'monto', width:100,sortable:false,resizable:false,hidde:true},
									...
									{name:'beneficiario',index:'beneficiario', width:100,sortable:false,resizable:false,hidden:true},
									{name:'monto2',index:'monto2', width:100,sortable:false,resizable:false,hidden:true}
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									if(ret.beneficiario!="")
									{
											...
											getObj('tesoreria_cheque_manual_db_baseimp').value = ret.base_imponible;
											getObj('tesoreria_cheque_manual_db_islr').value = ret.porcentaje_islr;
											getObj('tesoreria_manual_nombre').value=ret.beneficiario;
											getObj('tr_empleado2').style.display="";
											getObj('tesoreria_cheque_manual_db_otro_beneficiario_oc').value='1';
											getObj('tesoreria_cheque_manual_db_otro_beneficiario').checked="checked";					}
									if(ret.opcion=='2')
  ...
  <table   class="cuerpo_formulario">
   ...
   <tr>
	...
	<tr>
      ...
      Otro Beneficiario </label>
	    </br>
	    <label>
	    <input type="checkbox" name="tesoreria_cheque_manual_db_otro_beneficiario" id="tesoreria_cheque_manual_db_otro_beneficiario" value="checkbox" onclick="nombre_beneficiario();" />
		<input type="hidden" id="tesoreria_cheque_manual_db_otro_beneficiario_oc" name="tesoreria_cheque_manual_db_otro_beneficiario_oc"  value="0" />
	...
	<tr id="tr_empleado2" style="display:none">
		<th >Beneficiario:</th>
		<td><input type="text" name="tesoreria_manual_nombre" id="tesoreria_manual_nombre" size="70" maxlength="70" /></td>
	</tr>
   ...
   <tr>
	...
	<tr>
		...
		<input   name="tesoreria_cheque_manual_db_ordenes_pago" type="hidden" id="tesoreria_cheque_manual_db_ordenes_pago" size="16" maxlength="16" />		</td>
			      <input type="hidden" name="tesoreria_cheque_manual_pr_op_oculto" id="tesoreria_cheque_manual_pr_op_oculto" value="1" /></th>
