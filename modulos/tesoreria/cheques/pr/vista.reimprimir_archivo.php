...
if(getObj('tesoreria_cheque_reimpresion2_pr_monto_pagar').value!='0,00')
{
...
}//fin if(getObj('tesoreria_cheque_reimpresion2_pr_monto_pagar').value!='0,00')
});
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuenta_cheque.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid"); 
				}	
				...
				{	ano_dosearch();
					...
					function ano_gridReload()
					{
							...
							var busq_cuenta= jQuery("#tesoreria_cheques_chequeras_pr_cuenta").val(); 
jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuenta_cheque.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid");
						    url="modulos/tesoreria/cheques/pr/sql_grid_cuenta_cheque.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+'&busq_cuenta='+busq_cuenta;
						   // alert(url);
						}
				}
		});			
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					 ...
					 jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/cmb.sql.cheque_consulta.php?banco="+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+"&cuenta="+getObj('tesoreria_cheque_reimpresion2_pr_n_cuenta').value+"&busq_cheques="+busq_cheques,page:1}).trigger("reloadGrid"); 
	 		}	
				crear_grid();
				var timeoutHnd; 
				var flAuto = true;
					...
					function consulta_doc_dosearch()
					{
						...
						function consulta_doc_gridReload()
						{
								...
								var proveedor= jQuery("#tesoreria_cheques_pr_proveedor_id").val(); 
								 jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/cmb.sql.cheque_consulta.php?banco="+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+"&cuenta="+getObj('tesoreria_cheque_reimpresion2_pr_n_cuenta').value+"&busq_cheques="+busq_cheques,page:1}).trigger("reloadGrid"); 
								 url="modulos/tesoreria/cheques/pr/cmb.sql.cheque_consulta.php?banco="+getObj('tesoreria_cheque_reimpresion2_pr_banco_id_banco').value+"&cuenta="+getObj('tesoreria_cheque_reimpresion2_pr_n_cuenta').value+"&busq_cheques="+busq_cheques;
								//alert(url);
								// setBarraEstado(url);
						}
   ...
   <tr>
	...
	<tr>
		<th>
			Monto a Pagar:		</th>
	    <td>
		<input align="right"  name="tesoreria_cheque_reimpresion2_pr_monto_pagar" type="text" id="tesoreria_cheque_reimpresion2_pr_monto_pagar"  onKeyPress="reais(this,event)" onKeyDown="backspace(this,event)" value="0,00" size="16" maxlength="16"  style="text-align:right" readonly="readonly"/>
