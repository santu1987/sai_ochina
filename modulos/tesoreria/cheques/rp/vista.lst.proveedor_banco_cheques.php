...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
            ...
            $this->ln(5);
			$this->Cell(0,10,strtoupper($proveedor)."  ".$banco_nombre,0,0,'C');
			$this->Ln(5);
			...
			$this->Cell(30,6,		     'ORDENES DE PAGO',			0,0,'R',1);
			$this->Ln(6);
		...
		function Footer()
		{
			...
			$this->Cell(122,3,'Impreso por: '.str_replace('<br />',' ',$_SESSION[usuario]),0,0,'C');
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}')&&($row->fields("ordenes")!=''))
					{
						$pdf->Cell(30,6,$row->fields("ordenes"),0,0,'R',1);
//						$pdf->Ln();
						$coordenada++;
			/*if($row->fields("tipo_cheque")=='1')
			{
				...
				{
				$pdf->Cell(30,6,"Sin orden",0,0,'R',1);
				$coordenadas++;
				}	
				$pdf->Ln();						
