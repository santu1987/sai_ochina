		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_archivados_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid"); 
				}	
				...
				{	ano_dosearch();
					...
					function ano_gridReload()
					{
							...
							var busq_cuenta= jQuery("#tesoreria_cheques_chequeras_pr_cuenta").val(); 
jQuery("#list_grid_"+nd).setGridParam({url:"modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_archivados_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta,page:1}).trigger("reloadGrid");
						    url="modulos/tesoreria/cheques/pr/sql_grid_cuentas.php?busq_ano="+busq_ano+'&banco='+getObj('tesoreria_archivados_db_banco_id_banco').value+'&busq_cuenta='+busq_cuenta;
						  // alert(url);
						}
				}
		});			
