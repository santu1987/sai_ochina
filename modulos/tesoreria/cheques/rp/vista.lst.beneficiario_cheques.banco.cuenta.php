...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
			$this->Cell(0,10,'RELACIÓN BENEFICIARIOS/BANCOS CHEQUES REGISTRADOS',0,0,'C');
            $this->ln(5);
			$this->Cell(0,10,strtoupper($beneficiario)." ".strtoupper($banco)." ".$cuenta,0,0,'C');
			$this->Ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(45,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(45,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(45,6,		     'FECHA',			0,0,'L',1);
			$this->Cell(35,6,		     'MONTO',			0,0,'L',1);
			$this->Cell(40,6,		     'ORDENES DE PAGO',			0,0,'R',1);
			$this->Cell(40,6,		     'USUARIO EMISOR',			0,0,'R',1);			
			$this->Ln(6);
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			$pdf->Cell(45,6,		     $n_chequera,			0,0,'L',1);
			$pdf->Cell(45,6,		     $n_cheque,			        0,0,'L',1);
			$pdf->Cell(45,6,$fecha_emitido,0,0,'L',1);
			$pdf->Cell(35,6,number_format($row->fields("monto_cheque"),2,',','.'),0,0,'L',1);
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
				...
				$pdf->Cell(40,6,strtoupper($nombre_usuario),	0,0,'R',1);
				$pdf->Ln();		
				$coordenadas++;				
