...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $banco;	
			global $row;
			global $desde;
			global $hasta;global $nombre_usuario;
            ...
            $this->ln(5);
			$this->Cell(0,10,strtoupper($nombre_usuario)." ".strtoupper($banco),0,0,'C');
			$this->Ln(5);
			...
			$this->Cell(30,6,		     'ORDENES DE PAGO',			0,0,'L',1);
			...
			if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
					{
						...
						$pdf->Cell(25,6,$orden_df,0,0,'R',1);						$coordenada++;
