...
if ($mes=="12") $mes36="Diciembre";
	...
	//////////////////////////////////////////////////////////////////////////////////////////
		$sql_ejec="SELECT id_unidad_ejecutora, nombre FROM unidad_ejecutora WHERE id_unidad_ejecutora='$ejecutora'";
	...
	///////////////////////////////////////////////////////////////////////////////////////////				
		class PDF extends FPDF
		{
			...
			function Footer()
		{
			global  $bancoss,$nombre_administrador,$nombre_director,$nombre_preparado,$nombre_jefe,$cuenta_b,$montos,$proyecto,$partida,$ejecutora,$unidad_ejec;
	...
	$this->SetFont('arial','B',12);
		...
		//$this->Cell(100,4,utf8_decode($unidad_ejec),0,0,'R');
...
//		set_locale(LC_ALL,"es_ES@euro","es_ES","esp");
	...
	//	$pdf->Cell(50,4,substr($monto_escrito,112,50),0,0,'L');
		...
		$con=strlen($row->fields("concepto"));
				$pdf->SetFont('arial','B',11);
			//$pdf->MultiCell(180,25,$con,0,'LBR','L');
...
if(isset($_GET['id_banco']))
{
	...
	$where.=" AND cheques.id_banco=$id_banco AND cheques.numero_cheque=$ncheque";
...
function RotatedText($x, $y, $txt, $angle)
			...
			{		
    			...
    			$this->RotatedText(35,190,'PRECHEQUE Nº'.$ncheque,45);
				//
				$this->Ln();
				$this->Ln();	
