...
<table class="cuerpo_formulario">
	...
	<tr>	
		...
		<label id="" for="tesoreria_banco_nombre_proveedor">Proveedor:</label>
		 ...
		 <label id="" for="tesoreria_busqueda_ano_precheque">A&ntilde;o&nbsp; &nbsp; :</label>&nbsp;&nbsp;
		 <input type="text"  id="tesoreria_busqueda_ano_precheque" size="10" name="tesoreria_busqueda_ano_precheque" value="<? echo(date("Y")); ?>" onkeydown="tesoreria_banco_usuario_precheque_doSearch(arguments[0]||event)"/>
