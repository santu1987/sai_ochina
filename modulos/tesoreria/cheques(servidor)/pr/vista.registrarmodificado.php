...
$("#list_orden_pago").jqGrid({
	...
	datatype: "json",
   	...
   	colModel:[
			...
			{name:'islr1',index:'islr1', width:40,editable:true},
	...
	if(id && id!==lastsel)
	{ 
	jQuery('#list_orden_pago').restoreRow(lastsel); 
	jQuery('#list_orden_pago').editRow(id,true);
	lastsel=id; 
	} }, 
	onSelectRow: function(id){
...
<input type="hidden" name="orden_pago_pr_cot_select" id="orden_pago_pr_cot_select"  />
  <table   class="cuerpo_formulario">
   ...
   <tr>
	...
	<th>% Ret Islr</th>
	  <td>
			<input name="tesoreria_cheques_pr_ret_islr" type="text"  id="tesoreria_cheques_pr_ret_islr"  onblur="" onKeyPress="reais(this,event)" onKeyDown="backspace(this,event)"   value="0,00" size="16" maxlength="16"  style="text-align:right" readonly ,page:1}).trigger("reloadGrid");/>
			%	
