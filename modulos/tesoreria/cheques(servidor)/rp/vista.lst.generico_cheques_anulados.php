...
{  
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN CHEQUES ANULADOS',0,0,'C');
           	$this->Ln(5);
			...
			$this->Cell(30,6,		     'BENEFICIARIO',			0,0,'L',1);
			//$this->Cell(25,6,		     'MONTO',			1,0,'L',1);
			//$this->Cell(25,6,		     'ORDENES DE PAGO',			1,0,'R',1);
			$this->Cell(30,6,		     'PREPARADOR',			0,0,'R',1);
			$this->Ln(6);
		}
		//Pie de página
		function Footer()
	...
	///////////////////////////////////////////////////////////////////////////
			...
			//$n_cheque=$row->fields("numero_cheque");
				...
				$cuenta=$row->fields("cuenta_banco");
					...
					$pdf->Cell(70,6,substr(strtoupper($banco_nombre),0,25),			0,0,'L',1);
				...
				/*	if(($row->fields("ordenes")!='{0}')&&($row->fields("ordenes")!='{}'))
					{
						$pdf->Cell(20,6,$row->fields("ordenes"),0,0,'R',1);
						$pdf->Ln();
						$coordenada++;
					
					}else
						{
						$pdf->Cell(20,6,"Sin orden",0,0,'R',1);
						$pdf->Ln();
						$coordenada++;
