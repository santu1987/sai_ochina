...
if(($cerrado!="ano")||($cerrado!="mes"))
{
			...
			$sql = "
						...
						INNER JOIN
							 \"orden_pagoE\"
						ON
						cheques.numero_cheque=\"orden_pagoE\".numero_cheque
						WHERE
			...
			if(!$row->EOF)
			{
				$sql = "DELETE FROM cheques WHERE cheques.numero_cheque='$_POST[tesoreria_cheque_manual_db_n_precheque]' AND id_organismo=".$_SESSION["id_organismo"]."";
