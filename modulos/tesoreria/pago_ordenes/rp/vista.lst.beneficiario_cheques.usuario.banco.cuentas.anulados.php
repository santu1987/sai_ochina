...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $nombre_usuario;	
			...
			$this->Cell(0,10,'RELACIÓN USUARIOS/BENEFICIARIOS/BANCOS CHEQUES ANULADOS',0,0,'C');
            $this->ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(90,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(90,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(90,6,		     'FECHA',			0,0,'L',1);
			$this->Ln(6);
	...
	$fecha_emitido = substr($fecha_emitido,8,2)."".substr($fecha_emitido,4,4)."".substr($fecha_emitido,0,4);
			...
			$primer=strlen($n_cheque);
				...
				$cuenta=$row->fields("cuenta_banco");
					...
					$pdf->Cell(90,6,		     $n_chequera,			0,0,'L',1);
					$pdf->Cell(90,6,		     $n_cheque,			        0,0,'L',1);
					$pdf->Cell(90,6,$fecha_emitido,0,0,'L',1);
					$cheque=$row->fields("numero_cheque");
