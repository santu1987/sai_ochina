...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		//	$this->SetFont('Arial','B',16);
			$this->Cell(0,10,'RELACIÓN BENEFICIARIOS/BANCOS CHEQUES ANULADOS',0,0,'C');
            $this->ln(5);
			...
			$this->Cell(50,6,		     'PREPARADOR',			0,0,'R',1);			
			$this->Ln(6);
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			$pdf->Cell(45,6,number_format($row->fields("monto_cheque"),2,',','.'),0,0,'L',1);
			$cheque=$row->fields("numero_cheque");
			
				$pdf->Cell(50,6,strtoupper($nombre_usuario),	0,0,'R',1);
				$pdf->Ln();		
				$coordenadas++;				
