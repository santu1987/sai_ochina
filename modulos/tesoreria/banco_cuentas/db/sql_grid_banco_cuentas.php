...
if($busq_ano!="")
{
	$where2.= " AND  banco_cuentas.ayo = '$busq_ano'";
}else
	$where2.= " AND  banco_cuentas.ayo = '$ano2'";
...
while (!$row->EOF) 
{
	...
	$fecha_apertura = substr($fecha_apertura,8,2)."/".substr($fecha_apertura,5,2)."/".substr($fecha_apertura,0,4);
