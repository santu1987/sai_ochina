...
$where = " WHERE 1 = 1 ";
if ($busq_codigo!='')
$where.= " AND lower(proyecto.codigo_proyecto) like '%$busq_codigo%' ";
if ($busq_nombre!='')
...
$Sql="
			...
			INNER JOIN 
				organismo 
			ON 
				proyecto.id_organismo = organismo.id_organismo ".$where;
...
$Sql="
			...
			INNER JOIN 
				jefe_proyecto 
			ON 
				proyecto.id_jefe_proyecto = jefe_proyecto.id_jefe_proyecto ".$where."
			AND
