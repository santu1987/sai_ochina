...
$limit = 15;
if(!$sidx) $sidx =1;
$codigo = $_POST['ordenes_pr_nro_orden'];
...
$Sql="
			...
			ON
				...
				AND
					(\"orden_compra_servicioE\".numero_orden_compra_servicio= '".$codigo."')
...
if (!$row->EOF) 
{
	...
	$responce =$row->fields("numero_compromiso")."*".  $row->fields("id_proveedor")."*".  $row->fields("proveedor")."*".  $row->fields("id_unidad_ejecutora")."*".  $row->fields("unidad_ejecutora")."*".  $row->fields("numero_precompromiso");
echo ($responce);
