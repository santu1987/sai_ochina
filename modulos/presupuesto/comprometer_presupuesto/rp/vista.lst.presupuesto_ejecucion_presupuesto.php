...
//*************************************************************************************************************
	...
	while (!$row->EOF)
	{
		...
		$unidad_ejecutora = utf8_decode($row->fields('unidad_ejecutora')); 
		...
		if($proyectos == 1){
			if ($proyecto_anetrior <> $id_proyecto){
				...
				$pdf->SetFont('Arial','B',10);
				//echo ("<br>".$codigo_unidad."&nbsp;".$unidad_ejecutora."<br>");
				$pdf->Cell(282,	6,	"Proyecto: ".$proyecto_accion_codigo ." ".$proyecto_accion_nombre,								'TB',0,'L',1);
				$pdf->Ln(7);	
				$pdf->SetFont('Arial','B',10);
			}
		}
		if($acciones == 1){
			if ($accion_central_anetrior <> $id_accion_central){
				...
				$pdf->Cell(282,	6,	"Accion Centralizada: ".$proyecto_accion_codigo ." ".$proyecto_accion_nombre,								'TB',0,'L',1);
				$pdf->Ln(7);	
				$pdf->SetFont('Arial','B',10);
			}
		}
