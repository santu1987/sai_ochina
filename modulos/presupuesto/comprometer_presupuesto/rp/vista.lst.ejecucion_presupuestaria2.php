...
<table border="1">
	<tr>
		<td><b>CUENTA</b></td>
		<td><b>PRESUPUESTO LEY</b></td>
		<td><b>TRASPASO</b></td>
		<td><b>MODIFICADO</b></td>
		<td><b>PRESUPUESTO</b></td>
		<td><b>PRECOMPROMISO</b></td>
		<td><b>COMPROMISO</b></td>
		<td><b>CAUSADO</b></td>
		<td><b>PAGADO</b></td>
		<td><b>DISPONIBILIDAD COMPROMISO</b></td>
		<td><b>DISPONIBILIDAD PRECOMPROMISO</b> </td>
	</tr>
<?
	$ff = 0;
	$mest = $mesxx;
...
$dispo_totalxx = $correjido_monto -( $rowprecomprometido_todo->fields('numero_precompromiso') + $rowcomprometido_todo->fields('numero_compromiso'));
			/*	$pdf->SetFont('arial','B',10);
				...
				$pdf->Cell(30,	5,			number_format($row_todo->fields("presupuesto"),2,',','.'),				'TRL',0,'C',1);
				$pdf->Cell(30,	5,			number_format($row_todo->fields("monto_traspasado"),2,',','.'),		'TRL',0,'C',1);
				...
				$pdf->Cell(24,	5,			number_format($rowcomprometido_todo->fields('numero_compromiso'),2,',','.'),			'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')/,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')/,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_presuxx ,2,',','.'),												'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_totalxx,2,',','.'),												'TRL',0,'R',1);
				$pdf->Ln(5);
				$pdf->SetFont('arial','',10);*/
	?>
	
	<tr>
		<td><b>400.00.00.00</b></td>
		<td><b><?=number_format($row_todo->fields("presupuesto"),2,',','.')?> </b></td>
		<td><b><?=number_format($row_todo->fields("monto_traspasado"),2,',','.')?></b> </td>
		<td><b><?=number_format($row_todo->fields("monto_modificado"),2,',','.')?> </b></td>
		<td><b><?=number_format($correjido_monto,2,',','.')?></b> </td>
		<td><b><?=number_format($rowprecomprometido_todo->fields("numero_precompromiso"),2,',','.')?></b> </td>
		<td><b><?=number_format($rowcomprometido_todo->fields("numero_compromiso"),2,',','.')?></b> </td>
		<td></td>
		<td> </td>
		<td><b><?=number_format($dispo_presuxx,2,',','.')?> </b></td>
		<td><b><?=number_format($dispo_totalxx,2,',','.')?> </b></td>
	</tr>
...
$dispo_totalxx = $correjido_monto -( $rowprecomprometido_par->fields('numero_precompromiso') + $rowcomprometido_par->fields('numero_compromiso'));
			/*	$pdf->SetFont('arial','B',10);
				...
				$pdf->Cell(30,	5,			number_format($rowpartid->fields("presupuesto"),2,',','.'),				'TRL',0,'C',1);
				$pdf->Cell(30,	5,			number_format($rowpartid->fields("monto_traspasado"),2,',','.'),		'TRL',0,'C',1);
				...
				$pdf->Cell(24,	5,			number_format($rowcomprometido_par->fields('numero_compromiso'),2,',','.'),			'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')*//*,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')*,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_presuxx ,2,',','.'),												'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_totalxx,2,',','.'),												'TRL',0,'R',1);
	...
	<tr>
		<td><b><?=$rowpartid->fields("partida")?>.00.00.00</b></td>
		<td><b><?=number_format($rowpartid->fields("presupuesto"),2,',','.')?> </b></td>
		<td><b><?=number_format($rowpartid->fields("monto_traspasado"),2,',','.')?></b> </td>
		<td><b><?=number_format($rowpartid->fields("monto_modificado"),2,',','.')?> </b></td>
		<td><b><?=number_format($correjido_monto,2,',','.')?> </b></td>
		<td><b><?=number_format($rowprecomprometido_par->fields("numero_precompromiso"),2,',','.')?> </b></td>
		<td><b><?=number_format($rowcomprometido_par->fields("numero_compromiso"),2,',','.')?> </b></td>
		<td></td>
		<td> </td>
		<td><b><?=number_format($dispo_presuxx,2,',','.')?> </b></td>
		<td><b><?=number_format($dispo_totalxx,2,',','.')?> </b></td>
...
$dispo_presuxxl = $correjido_montoxl -( $rowprecomprometido_gene->fields('numero_precompromiso') + $rowcomprometido_gene->fields('numero_compromiso'));
				...
				$pdf->Cell(30,	5,			number_format($rowgene->fields("presupuesto"),2,',','.'),							'TRL',0,'C',1);
				$pdf->Cell(30,	5,			number_format($rowgene->fields("monto_traspasado"),2,',','.'),					'TRL',0,'C',1);
				...
				$pdf->Cell(24,	5,			number_format($rowcomprometido_gene->fields('numero_compromiso'),2,',','.'),			'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')*,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.'/,		'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_presuxxly ,2,',','.'),												'TRL',0,'R',1);
				$pdf->Cell(24,	5,			number_format($dispo_presuxxl,2,',','.'),												'TRL',0,'R',1);
				$pdf->Ln(5);
				$pdf->SetFont('arial','',10);*/
			$genericas_antes = $rowgene->fields("generica"); ?>
	<tr>
		<td><b><?=$rowgene->fields("partida").'.'.$rowgene->fields("generica")?>00.00</b></td>
		<td><b><?=number_format($rowgene->fields("presupuesto"),2,',','.')?></b> </td>
		<td><b><?=number_format($rowgene->fields("monto_traspasado"),2,',','.')?> </b></td>
		<td><b><?=number_format($rowgene->fields("monto_modificado"),2,',','.')?></b> </td>
		<td><b><?=number_format($correjido_montoxl,2,',','.')?> </b></td>
		<td><b><?=number_format($rowprecomprometido_gene->fields("numero_precompromiso"),2,',','.')?> </b></td>
		<td><b><?=number_format($rowcomprometido_gene->fields("numero_compromiso"),2,',','.')?> </b></td>
		<td></td>
		<td> </td>
		<td><b><?=number_format($dispo_presuxxly,2,',','.')?></b> </td>
		<td><b><?=number_format($dispo_presuxxl,2,',','.')?></b> </td>
	</tr>
	<?
	}
		...
		$suma_total = 0;
			...
			$pdf->Cell(30,	5,			number_format($rowoo->fields('presupuesto'),2,',','.'),								'TRL',0,'R',1);
			$pdf->Cell(30,	5,			number_format($rowoo->fields('monto_traspasado'),2,',','.'),						'TRL',0,'R',1);
			...
			$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')/,		'TRL',0,'R',1);
			$pdf->Cell(24,	5,			''/*number_format($rowcomprometido->fields('numero_compromiso'),2,',','.')/,		'TRL',0,'R',1);
			$pdf->Cell(24,	5,			number_format($dispo_presu ,2,',','.'),												'TRL',0,'R',1);
			$pdf->Cell(24,	5,			number_format($dispo_total,2,',','.'),												'TRL',0,'R',1);
			*/
	?>		
	<tr>
		<td><?=$row->fields("partida").'.'.$row->fields("generica").".".$row->fields('especifica').".".$row->fields('sub_especifica')?></td>
		<td><?=number_format($rowoo->fields("presupuesto"),2,',','.')?> </td>
		<td><?=number_format($rowoo->fields("monto_traspasado"),2,',','.')?> </td>
		<td><?=number_format($rowoo->fields("monto_modificado"),2,',','.')?> </td>
		<td><?=number_format($presu_correj,2,',','.')?> </td>
		<td><?=number_format($rowprecomprometido->fields("numero_precompromiso"),2,',','.')?> </td>
		<td><?=number_format($rowcomprometido->fields("numero_compromiso"),2,',','.')?> </td>
		<td></td>
		<td> </td>
		<td><?=number_format($dispo_presu,2,',','.')?> </td>
		<td><?=number_format($dispo_total,2,',','.')?> </td>
	</tr>
	<?
