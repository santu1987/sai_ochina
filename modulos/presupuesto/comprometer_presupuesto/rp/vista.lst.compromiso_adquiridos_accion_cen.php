...
$accion_centralizada = $row->fields('accion_centralizada');
...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{		
			global $unidad_ejecutora,  $ano, $codigo_unidad,  $texto, $codigo_accion_central, $accion_centralizada;
			...
			$this->Cell(135,10, $codigo_accion_central.' '.utf8_decode($accion_centralizada),0,0,'R');
			$this->Ln();
			...
			$this->Cell(17,				6,		'ACC. CEN',							0,0,'C',1);
