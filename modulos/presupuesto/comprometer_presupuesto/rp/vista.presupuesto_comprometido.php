	...
	$.post("modulos/presupuesto/comprometer_presupuesto/pr/grid_compromiso.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/comprometer_presupuesto/rp/cmb.sql.partida.php?nd='+nd+'&unidad='+getObj('compromiso_rp_id_unidad_ejecutora').value+'&ano='+getObj('compromiso_rp_cmb_ano').value+'&accion_cen='+getObj('compromiso_rp_id_accion_cen').value,//compromiso_rp_id_unidad_ejecutora
								datatype: "json",
