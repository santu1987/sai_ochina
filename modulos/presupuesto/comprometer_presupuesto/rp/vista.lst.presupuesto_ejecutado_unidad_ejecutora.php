...
AND
	\"unidad_ejecutora\".id_unidad_ejecutora = ".$id_unidad."
ORDER BY 
...
$unidad_anetrior =0;
if (!$row->EOF){
$unidad = $row->fields('codigo_unidad_ejecutora')." ".$row->fields('unidad_ejecutora');
...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{		
			global $unidad_ejecutora,  $ano, $unidad, $partida;
			...
			$this->Cell(150,10,'Unidad Ejecutora: '.$unidad,0,0,'L');
			/*$this->Ln(5);
