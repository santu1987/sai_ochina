...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{		
			global $unidad_ejecutora,  $ano, $codigo_unidad, $partida, $generica, $accion_especifica;
			...
			$this->Cell(0,10,'RESUMEN DE EJECUCIÓN DE PRESUPUESTO POR PARTIDA/GENERICA',0,0,'C');
			$this->Ln(11);	
			...
			$this->Cell(90,10,'Partida: '.$partida.".".$generica,0,0,'L');
			$this->Ln(8);
			$this->SetFont('Arial','B',9);
