		...
		function crear_grid()
						{
							...
							({
								...
								datatype: "json",
								colNames:['id_cotizacion','Requisicion','Cotizacion', 'AÒo','Asunto','id_proyecto','Codigo','Nombre','id_accion_centralizada','prioridad','comentario','id_accion_especifica','codigo_accion_especifica','accion_especifica','observacion','id_proveedor','codigo_proveedor','proveedor1','Proveedor','Fecha'],
								colModel:[
									{name:'id_solicitud_cotizacione',index:'id_solicitud_cotizacione', width:20,sortable:false,resizable:false,hidden:true},
									{name:'numero_requisicion',index:'numero_requisicion', width:15,sortable:false,resizable:false},
									{name:'numero_cotizacion',index:'numero_cotizacion', width:13,sortable:false,resizable:false},
									...
									{name:'proveedor',index:'proveedor', width:50,sortable:false,resizable:false,hidden:true},
									{name:'proveedor2',index:'proveedor2', width:50,sortable:false,resizable:false},
								...
								getObj('cotizacones_pr_numero').value = ret.numero_requisicion;
									...
									if (ret.id_proyecto != 0){
										...
										getObj('cotizacones_pr_codigo_central').value="0000";
										getObj('cotizacones_pr_codigo_central').disabled="disabled"; 
									...
									if (ret.id_accion_centralizada != 0){
										...
										getObj('cotizacones_pr_codigo_central').value = ret.codigo;
									...
									getObj('cotizacones_pr_accion_especifica_codigo').value = ret.codigo_accion_especifica;
...
{
	urls='modulos/adquisiones/cotizacion/pr/cmb.sql.partida.php?nd='+nd+'&unidad_es='+getObj('cotizacones_pr_accion_especifica_id').value+'&accion='+getObj('cotizacones_pr_accion_central_id').value+'&proyecto='+getObj('cotizacones_pr_proyecto_id').value;
		//alert(urls);
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
						...
						function crear_grid()
						{
							...
							({
								...
								colModel:[
									...
									{name:'diponible',index:'diponible', width:70,sortable:false,resizable:false}
								],
								pager: $('#pager_grid_'+nd),
								rowNum:20,
								rowList:[20,50,100],
			...
			cache: false,
			 success:function(html)
			 {
				...
				recordset = recordset.split("*");
					...
					getObj("cotizacones_pr_accion_especifica_codigo").value=recordset[9];
					...
					if (recordset[3] != 0){
						...
						getObj('cotizacones_pr_codigo_central').value = recordset[13];
...
$("#cotizacones_pr_btn_cancelar").click(function() {
	getObj('cotizacones_pr_codigo_central').disabled=""; 
	...
	getObj('cotizacones_pr_codigo_central').value ="";
	getObj('cotizacones_pr_accion_central').value ="";
	getObj('cotizacones_pr_accion_central_id').value ="";
	getObj('cotizacones_pr_accion_especifica').value ="";
	getObj('cotizacones_pr_accion_especifica_codigo').value ="";
	...
	getObj('cotizacones_pr_numero').value="";
	 getObj('cotizaciones_pr_garantia').value="";
...
getObj('cotizacones_pr_accion_especifica_codigo').disabled="disabled";
*/
 	} );
//---------------------------------------------------------------------------------------------------------------------------------
...
$('#cotizaciones_pr_tiempo_entrega').numeric({allow:''});
$('#cotizaciones_pr_validez_oferta').numeric({allow:''});
$('#cotizaciones_pr_condiciones_pago').numeric({allow:''});
$('#cotizaciones_pr_garantia').numeric({allow:''});
		...
		$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
				...
				if (getObj('cotizaciones_pr_garantia').value =="")    getObj('cotizaciones_pr_garantia').value=recordset[13];
				//}
			 }
		});	 
			/*$.ajax (
...
<table class="cuerpo_formulario">
  <tr>
    <th class="titulo_frame" colspan="4"><img src="imagenes/iconos/desktop24x24.png" style="padding-right:5px;" align="absmiddle" />Orden Especial 
	...
	<ul class="input_con_emergente">
		<li>			
				<input name="cotizacones_pr_codigo_unidad" type="text" id="cotizacones_pr_codigo_unidad"  maxlength="4" size="5"
				onchange="consulta_automatica_unidad" onclick="consulta_automatica_unidad"
       			message="Introduzca codigo de la Unidad." 
				jVal="{valid:/^[a-zA-Z ·ÈÌÛ˙¡…Õ”⁄1234567890]{4,5}$/, message:'Nombre Invalido', styleType:'cover'}"
				jValKey="{valid:/[a-zA-Z ·ÈÌÛ˙¡…Õ”⁄1234567890]/, cFunc:'alert', cArgs:['Nombre: '+$(this).val()]}"/>
       			 <input type="text" name="cotizacones_pr_unidad" id="cotizacones_pr_unidad" 
				style="width:62ex;" maxlength="60"  message="Introduzca el Nombre de la Unidad." />
       			 <input type="hidden" name="cotizacones_pr_unidad_id" id="cotizacones_pr_unidad_id" />
        </li>
		<li id="cotizacones_pr_btn_consultar_unidad" class="btn_consulta_emergente"></li>
	</ul>	
	</td>
  </tr>-->
   <tr>
  ...
  <tr>
	...
	<ul class="input_con_emergente">
		<li>
				<input name="cotizacones_pr_codigo_proyecto" type="text" id="cotizacones_pr_codigo_proyecto"  maxlength="6" 
				onchange="consulta_automatica_proyecto" onclick="consulta_automatica_proyecto"
       			message="Introduzca un Codigo para el Proyecto."  size="6" readonly="readonly"
  ...
  <tr>
	...
	<ul class="input_con_emergente">
		<li>			
				<input name="cotizacones_pr_codigo_central" type="text" id="cotizacones_pr_codigo_central"  maxlength="6" size="6"
  ...
  <tr>
    ...
    <td>
	 <ul class="input_con_emergente">
		<li>	
		<input name="cotizacones_pr_accion_especifica_codigo" type="text" id="cotizacones_pr_accion_especifica_codigo"  maxlength="6" size="6"
		...
		<input type="text" name="cotizacones_pr_accion_especifica" id="cotizacones_pr_accion_especifica"  readonly="readonly"
				...
				jval="{valid:/^[a-zA-Z ·ÈÌÛ˙¡…Õ”⁄.,1234567890]{1,200}$/, message:'Acci&oacute;n Espec&iacute;fica Invalida', styleType:'cover'}"
				jvalkey="{valid:/[a-zA-Z ·ÈÌÛ˙¡…Õ”⁄.,1234567890]/, cFunc:'alert', cArgs:['Acci&oacute;n Espec&iacute;fica: '+$(this).val()]}"	/>
  ...
  <tr>
	...
	<tr>
			...
			<th colspan="4">
				<!--<select name="cotizaciones_pr_tiempo_entrega" id="cotizaciones_pr_tiempo_entrega" style="min-width:100px; width:100px;">
					<option value="6" selected="selected">1 dia</option>
					<option value="5">3 dias</option>
					<option value="4">1 semana</option>
					<option value="3">2 semanas</option>
					<option value="2">1 mes</option>
					<option value="1">2 mes</option>
				</select>-->
				<input type="text" name="cotizaciones_pr_tiempo_entrega" id="cotizaciones_pr_tiempo_entrega" size="5" 
				message="Introduzca la cantidad del producto." maxlength="5" style="text-align:right"
		...
		<tr>
			...
			<th colspan="4">
				<input name="cotizaciones_pr_validez_oferta" type="text" id="cotizaciones_pr_validez_oferta" size="5" maxlength="5" style="text-align:right"/>
			dia(s)</th>
		</tr>
		<tr>
			...
			<th colspan="4">
				...
				<input name="cotizaciones_pr_condiciones_pago" type="text" id="cotizaciones_pr_condiciones_pago" size="5" maxlength="5" style="text-align:right"/>
			<img class="btn_consulta_emergente" id="cotizacones_pr_btn_condiciones" src="imagenes/null.gif" /></th>
			</tr>
			<tr>
			<th >GARANTIA</th>
			<th colspan="4">
			
				<input name="cotizaciones_pr_garantia" type="text" id="cotizaciones_pr_garantia" size="5" maxlength="5" style="text-align:right"/>
			dia(s)</th>
			...
			<th colspan="3">
				<select name="cotizaciones_pr_lugar_entrega" id="cotizaciones_pr_lugar_entrega" style="min-width:180px; width:180px;">
					<option value="3" selected="selected">Donde se Necesita el Bien</option>
					<option value="2">En Ochina</option>
					<option value="1">Oficina del Proveedor</option>
				</select>
<!--
			<input type="text" name="cotizaciones_pr_lugar_entrega" id="cotizaciones_pr_lugar_entrega" size="68" />--></th>
			<td width="4%" rowspan="3"><img id="cotizacones_pr_btn_anadir" src="imagenes/cargar.png"   /> </td>
      ...
      <tr>
        <td width="20%"align="center"><input type="text" name="cotizacones_pr_partida" id="cotizacones_pr_partida"
							...
							<img class="btn_consulta_emergente" id="cotizacones_pr_btn_partida" src="imagenes/null.gif" />
							</td>
        <td width="20%" align="center"><input type="text" name="cotizacones_pr_cantidad" id="cotizacones_pr_cantidad"
							...
							jval="{valid:/^[0123456789]{1,10}$/, message:'Producto Invalido', styleType:'cover'}"
							jvalkey="{valid:/[0123456789]/, cFunc:'alert', cArgs:['Producto: '+$(this).val()]}" />       
							 </td>
