...
$unidad_id = $_POST['asignacion_rrhh_pr_unidad_id'];
...
$montos = str_replace(".","",$_POST['asignacion_rrhh_pr_monto']);
...
if($_POST['asignacion_rrhh_pr_numero']==""){
...
$pre =  $precompromiso->fields("numero_precompromiso") + 1 ;
	...
	$numero_requision = substr($_POST['asignacion_rrhh_pr_numero'],2);
	$numero_requision_final = $_POST['asignacion_rrhh_pr_numero'];
}
...
$cuenta = $_POST['asignacion_rrhh_pr_partida'];

if(( $_POST['asignacion_rrhh_pr_tipo_doc'] =='401') or( $_POST['asignacion_rrhh_pr_tipo_doc'] =='402') or ( $_POST['asignacion_rrhh_pr_tipo_doc'] =='404') or ( $_POST['asignacion_rrhh_pr_tipo_doc'] =='407'))
	$tipos_d = 3;
elseif ( $_POST['asignacion_rrhh_pr_tipo_doc'] =='403') 
	$tipos_d = 4;
else	
	$tipos_d = 0;
list( $partidas, $generica, $especifica, $subespecifica ) = split( '[.]', $_POST['asignacion_rrhh_pr_partida']);
$partida = split( ".", $_POST['asignacion_rrhh_pr_partida'] );

if ( $_POST['asignacion_rrhh_pr_unidad_custodio_id'] =="")
	$custodio=0;
else
	$custodio = $_POST['asignacion_rrhh_pr_unidad_custodio_id'];
$proveedor_id = $_POST['asignacion_rrhh_pr_proveedor_id'];
if($_POST['asignacion_rrhh_pr_numero']==""){
	$sqlEn = "
			INSERT INTO \"orden_compra_servicioE\"(
				...
				".$unidad_id.",
				".$poryec_central .",
				".$_POST['asignacion_rrhh_pr_accion_especifica_id'].", 
				...
				'".$fecha."', 
				".$tipo.",
				'".utf8_encode($_POST['asignacion_rrhh_pr_asunto'])."', 
				'".$_POST['asignacion_rrhh_pr_obesrvacion']."', 
				'1',
				".$_SESSION['id_usuario'].",			
				'".$fecha."',
				'".$numero_requision."',
			...
			*/
			$sql = "
					INSERT INTO \"orden_compra_servicioD\"(
						...
						".date('Y').",
						".$tipos_d .",
						".$_POST['asignacion_rrhh_pr_unidad_medida'].",
						'0.00',
						'".$numero_requision."',
						".$Secuencia.",
						".$_POST['asignacion_rrhh_pr_cantidad'].",
						'".$montos."',
						'".utf8_encode($_POST['asignacion_rrhh_pr_producto'])."',
						'".$partidas."',
						'".$generica."',
						'".$especifica."',
						'".$subespecifica."',
...
WHERE (id_organismo = ".$_SESSION['id_organismo'].") AND (id_accion_centralizada = ".$accion_central_id.") AND
		(id_unidad_ejecutora = ".$unidad_id.") AND (id_accion_especifica = ".$_POST['asignacion_rrhh_pr_accion_especifica_id'].") AND
		(id_proyecto = ".$proyecto_id.") AND (ano = '".date("Y")."') AND
		partida = '".$partidas."'  AND	generica = '".$generica."'  
...
$sql = "
					INSERT INTO \"orden_compra_servicioD\"(
						...
						".$_SESSION['id_organismo'].", 
						".date('Y').",
						".$_POST['asignacion_rrhh_pr_tipo_doc'].",
						".$_POST['asignacion_rrhh_pr_unidad_medida'].",
						'0.00',
						'".$numero_requision."',
						".$Secuencia.",
