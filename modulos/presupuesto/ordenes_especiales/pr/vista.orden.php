...
$("#orden_especial_pr_btn_anadir").click(function(){
	//if($('#form_pr_ordenes_especiales').jVal())
	//{
	 if(getObj('orden_especial_pr_numero_reglon').value==""){ 
		//setBarraEstado(mensaje[esperando_respuesta]);
		$.ajax (
		{
		url: "modulos/presupuesto/ordenes_especiales/pr/sql.orden_especial.php",
			data:dataForm('form_pr_ordenes_especiales'),
			type:'POST',
			cache: false,
			...
			//alert("modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+resultado[1]);
				...
				//alert("modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+resultado[1]);
					...
					//clearForm('form_pr_ordenes_especiales');
					jQuery("#list_ordenes").setGridParam({url:"modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+resultado[2],page:1}).trigger("reloadGrid");
		...
		//setBarraEstado(mensaje[esperando_respuesta]);
		urlXX= "modulos/presupuesto/ordenes_especiales/pr/sql.actualizar.php";
		$.ajax (
		{
		url: "modulos/presupuesto/ordenes_especiales/pr/sql.actualizar.php",
			...
			//alert(resultado[0]);
				if (resultado[0]=="Ok")
				{
					//setBarraEstado(mensaje[registro_exitoso],true,true);
					//clearForm('form_pr_ordenes_especiales');
		//	alert("modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+getObj('orden_especial_pr_numero').value);

					jQuery("#list_ordenes").setGridParam({url:"modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+getObj('orden_especial_pr_numero_precompromiso').value,page:1}).trigger("reloadGrid");
						//getObj('orden_especial_pr_numero_requision').value=resultado[1];
						//getObj('orden_especial_pr_numero').value =resultado[1]; ;
		...
		$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ 
					...
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/presupuesto/ordenes_especiales/pr/sql_busqueda_requisicion_ad.php?busq_requi="+busq_requi+"&busq_asunt="+busq_asunt+"&ano="+getObj('orden_especial_pr_ano').value,page:1}).trigger("reloadGrid"); 
			}	
				crear_grid();
		...
		function crear_grid()
						{
							...
							({
								...
								url:'modulos/presupuesto/ordenes_especiales/pr/sql_busqueda_requisicion_ad.php?nd='+nd,
								datatype: "json",
								colNames:['Nº Orden Extraordinaria','Año','id_proyecto','id_accion_especifica','Asunto','Proyecto/Accion Central','Proyecto/Accion Central1','Prioridad','Comentario','id_tipo_documento','Observacion','Accion Especifica1','Accion Especifica','id_unidad','Unidad','Codigo_unidad','tipo','id_proveedor','code_proveedor','proveedor','id_cus','code_cus','custodio','numero_precompromiso'],
								colModel:[
								...
								getObj('orden_especial_pr_numero_requision').value = ret.numero_requisicion;
									...
									//alert("modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+ret.numero_requisicion+"&id_unidadd="+ret.id_unidadd);
									jQuery("#list_ordenes").setGridParam({url:"modulos/presupuesto/ordenes_especiales/co/sql.consulta.php?numero_requision="+ret.numero_precompromiso+"&id_unidadd="+ret.id_unidadd,page:1}).trigger("reloadGrid");
					 			},
...
$("#orden_especial_pr_btn_consultar_unidad_custodio").click(function() {
	...
	$.post("modulos/presupuesto/ordenes_especiales/pr/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								onSelectRow: function(id){
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('orden_especial_pr_unidad_custodio_id').value = ret.id;
									getObj('orden_especial_pr_codigo_unidad_custodio').value = ret.codigo;
									getObj('orden_especial_pr_unidad_custodio').value = ret.denominacion;
	...
	$.post("modulos/presupuesto/ordenes_especiales/pr/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/ordenes_especiales/pr/cmb.sql.accion_central_rec.php?nd='+nd+'&unidad='+getObj('orden_especial_pr_unidad_id').value,
								datatype: "json",
	...
	$.post("modulos/presupuesto/ordenes_especiales/pr/grid_requisiciones.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								loadtext: "Recuperando Información del Servidor",		
								//url:urls,
 								url:'modulos/presupuesto/ordenes_especiales/pr/cmb.sql.accion_especifica_rec.php?nd='+nd+'&unidad='+getObj('orden_especial_pr_unidad_id').value+'&accion_central='+getObj('orden_especial_pr_accion_central_id').value+'&proyecto='+getObj('orden_especial_pr_proyecto_id').value,	
								datatype: "json",
...
{
	urls='modulos/presupuesto/ordenes_especiales/pr/cmb.sql.partida_rec.php?nd='+nd+'&unidad='+getObj('orden_especial_pr_unidad_id').value+'&unidad_es='+getObj('orden_especial_pr_accion_especifica_id').value+'&accion='+getObj('orden_especial_pr_accion_central_id').value+'&proyecto='+getObj('orden_especial_pr_proyecto_id').value+'&gasto='+getObj('orden_especial_pr_tipo_doc').value;
		//alert(urls);  
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/presupuesto/ordenes_especiales/pr/grid_requisiciones.php", { },
...
$("#list_ordenes").jqGrid({
	...
	datatype: "json",
   	...
   	colModel:[
			...
			{name:'orden_especial_pr_cantidad',index:'orden_especial_pr_cantidad', width:80,editable:true, editable:true},
			{name:'orden_especial_pr_unidad_medida',index:'orden_especial_pr_unidad_medida', width:200,hidden:true},
			...
			{name:'orden_especial_pr_monto',index:'orden_especial_pr_monto', width:50,hidden:true},
			{name:'orden_especial_pr_iva',index:'orden_especial_pr_iva', width:50,hidden:true}
   	],
   	rowNum:5,
   	rowList:[5,10,15],
   	imgpath: 'utilidades/jqgrid_demo/themes/basic/images',
...
.navButtonAdd('#pager_ordenes_extra',{caption:"Editar",
	onClickButton:function(){
		...
		if(gsr){
			...
			jQuery("#list_ordenes").GridToForm(gsr,"#form_pr_ordenes_especiales");
		} else {
...
//		alert("modulos/presupuesto/ordenes_especiales/pr/sql.eliminar.php?id="+gsr+"&requi="+getObj('orden_especial_pr_numero').value+"&accionc="+getObj('orden_especial_pr_accion_central_id').value+"&proyecto="+getObj('orden_especial_pr_proyecto_id').value+"&accione="+getObj('orden_especial_pr_accion_especifica_id').value+"&unidad="+getObj('orden_especial_pr_unidad_id').value+"&partida="+getObj('orden_especial_pr_partida').value);
			$.ajax ({
			url: "modulos/presupuesto/ordenes_especiales/pr/sql.eliminar.php?id="+gsr+"&requi="+getObj('orden_especial_pr_numero_precompromiso').value+"&accionc="+getObj('orden_especial_pr_accion_central_id').value+"&proyecto="+getObj('orden_especial_pr_proyecto_id').value+"&accione="+getObj('orden_especial_pr_accion_especifica_id').value+"&unidad="+getObj('orden_especial_pr_unidad_id').value,
				data:dataForm('form_pr_ordenes_especiales'), 
				type:'GET',
				cache: false,
				success: function(html)
...
<form method="post" name="form_pr_ordenes_especiales" id="form_pr_ordenes_especiales">
...
<table class="cuerpo_formulario">
   ...
   <tr>
	...
	N&ordm; Compromiso Cuenta de Orden
