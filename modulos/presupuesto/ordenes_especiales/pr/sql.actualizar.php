...
if($_POST['orden_especial_pr_unidad_custodio_id'] == "")
	...
	$id_custo =$_POST['orden_especial_pr_unidad_custodio_id'] ;	
...
WHERE (id_organismo = ".$_SESSION['id_organismo'].") AND (id_accion_centralizada = ".$accion_central_id.") AND
		(id_unidad_ejecutora = ".$_POST['orden_especial_pr_unidad_id'].") AND (id_accion_especifica = ".$_POST['orden_especial_pr_accion_especifica_id'].") AND
...
///////////////////////////////////////////////////////////////////////////// FIN ////////////////////////////////	
		...
		WHERE 
			...
			SET 
				...
				id_unidad_ejecutora=".$_POST['orden_especial_pr_unidad_id'].", 
				id_proyecto_accion_centralizada=".$pro_acc.", 
				id_accion_especifica=".$_POST['orden_especial_pr_accion_especifica_id'].", 
				concepto='".$_POST['orden_especial_pr_asunto']."', 
				comentarios='".$_POST['orden_especial_pr_obesrvacion']."', 
