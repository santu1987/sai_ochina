...
$sql="
			...
			WHERE 
				...
				".(($_POST[presupuesto_ley_pr_id_unidad_ejecutora])?" id_unidad_ejecutora=$_POST[presupuesto_ley_pr_id_unidad_ejecutora] AND ":"")."
				anio='$_POST[presupuesto_ley_pr_cmb_ano]' AND 
				estatus=1;
			";
