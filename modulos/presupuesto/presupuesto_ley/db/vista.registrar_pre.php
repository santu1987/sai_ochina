...
<script>
var dialog;
$("#pre_antepresupuesto_ley_pr_btn_guardar").click(function() {
	if(($('#form_pr_pre_antepresupuesto').jVal()))
	{
		setBarraEstado(mensaje[esperando_respuesta]);
		$.ajax ({
			url: "modulos/presupuesto/presupuesto_ley/db/sql.antepresupuesto_ley.php",
			data:dataForm('form_pr_pre_antepresupuesto'),
			type:'POST',
			cache: false,
			success: function(html)
			{
				if (html=="Registrado")
				{
					...
					//clearForm('form_pr_pre_antepresupuesto');
					getObj('pre_antepresupuesto_ley_pr_partida_numero').value =   	'';
					getObj('pre_antepresupuesto_ley_pr_partida').value =   			'';
					getObj('presupuesto_ley_db_codigo_especifica').value = 	'';
					getObj('presupuesto_ley_db_nombre_especifica').value =  '';
					getObj('pre_antepresupuesto_ley_pr_accion_especifica').value = 	'';
					getObj('pre_antepresupuesto_ley_pr_monto_enero').value =   		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_febrero').value =		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_marzo').value =  		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_abril').value =   		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_mayo').value =    		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_junio').value =   		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_julio').value =   		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_agosto').value =  		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_septiembre').value =   '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_octubre').value =      '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_noviembre').value =    '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_diciembre').value =    '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_presupuesto').value = 	'0,00';
				}
				else if (html=="Existe")
				{
...
$("#pre_antepresupuesto_ley_pr_btn_actualizar").click(function() {
	setBarraEstado(mensaje[esperando_respuesta]);
	if($('#form_pr_pre_antepresupuesto').jVal())
	{
		$.ajax (
		{
			url: "modulos/presupuesto/presupuesto_ley/db/sql.actualizar_pre.php",
			data:dataForm('form_pr_pre_antepresupuesto'),
			type:'POST',
			cache: false,
			success: function(html)
			{
				if (html=="Actualizado")
				{
					...
					clearForm('form_pr_pre_antepresupuesto');
					getObj('pre_antepresupuesto_ley_pr_btn_actualizar').style.display='none';
					getObj('pre_antepresupuesto_ley_pr_btn_cancelar').style.display='';
					getObj('pre_antepresupuesto_ley_pr_btn_cosultar').style.display='';
					getObj('pre_antepresupuesto_ley_pr_btn_guardar').style.display='';
					getObj('pre_antepresupuesto_ley_pr_monto_enero').value =   		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_febrero').value =		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_marzo').value =  		'0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_abril').value =   		'0,00';
					...
					getObj('pre_antepresupuesto_ley_pr_monto_diciembre').value =    '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_presupuesto').value = 	'0,00';
					getObj('pre_antepresupuesto_ley_pr_accion_central_id').value = 	0;
					getObj('pre_antepresupuesto_ley_pr_proyecto_id').value = 		0;
					getObj('pre_antepresupuesto_ley_pr_accion_especifica').value = 	0;
					getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id').value =0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$("#pre_antepresupuesto_ley_pr_btn_consultar").click(function() {
unidades=getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora').value;
ano=getObj('pre_antepresupuesto_ley_pr_anio').value;
if(unidades!="")
{
var nd=new Date().getTime();
	...
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
		$.ajax ({
			...
			{
				urls="modulos/presupuesto/presupuesto_ley/db/sql_grid_presupuesto_ley.php?unidades="+unidades+"&ano="+ ano ;
					...
					function crear_grid()
						{
							...
							({
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('pre_antepresupuesto_ley_pr_id').value = ret.id_presupuesto_ley;
									
									if (ret.codigo_accion_central == "0000"){
										getObj('pre_antepresupuesto_ley_pr_accion_central_id').value = 0;
										getObj('pre_antepresupuesto_ley_pr_accion_central_id_old').value = 0;
										getObj('pre_antepresupuesto_ley_pr_nombre_central').value = "   NO APLICA";
										getObj('pre_antepresupuesto_ley_pr_codigo_central').value = "0000";
									}else{
										getObj('pre_antepresupuesto_ley_pr_accion_central_id').value = ret.id_accion_central;
										getObj('pre_antepresupuesto_ley_pr_accion_central_id_old').value = ret.id_accion_central;
										getObj('pre_antepresupuesto_ley_pr_nombre_central').value = ret.accion_proyecto;
										getObj('pre_antepresupuesto_ley_pr_codigo_central').value = ret.codigo_accion_central;
									}
									//***********
									if (ret.codigo_proyecto == "0000"){
										getObj('pre_antepresupuesto_ley_pr_proyecto_id').value = 0
										getObj('pre_antepresupuesto_ley_pr_proyecto_id_old').value = 0
										getObj('presupuesto_ley_db_nombre_proyecto').value = "   NO APLICA";
										getObj('presupuesto_ley_db_codigo_proyecto').value = "0000";
									}else{
										getObj('pre_antepresupuesto_ley_pr_proyecto_id').value = ret.id_proyecto;
										getObj('pre_antepresupuesto_ley_pr_proyecto_id_old').value = ret.id_proyecto;
									...
									getObj('pre_antepresupuesto_ley_pr_accion_especifica').value = ret.id_accion_especifica;
									getObj('pre_antepresupuesto_ley_pr_accion_especifica_old').value = ret.id_accion_especifica;
									...
									getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id').value=ret.id_unidad_ejecutora;
									getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id_old').value=ret.id_unidad_ejecutora;
									getObj('pre_antepresupuesto_ley_pr_codigo_unidad_ejecutora').value=ret.codigo_unidad_ejecutora;
									getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora').value = ret.nombre;
									getObj('pre_antepresupuesto_ley_pr_anio').value = ret.anio;
									getObj('pre_antepresupuesto_ley_pr_partida_numero').value = ret.partida;
									getObj('pre_antepresupuesto_ley_pr_partida_numero_old').value = ret.partida;
									getObj('pre_antepresupuesto_ley_pr_partida').value = ret.denominacion;

									getObj('pre_antepresupuesto_ley_pr_monto_enero').value = ret.enero;

									getObj('pre_antepresupuesto_ley_pr_monto_febrero').value = ret.febrero;

									getObj('pre_antepresupuesto_ley_pr_monto_marzo').value = ret.marzo;

									getObj('pre_antepresupuesto_ley_pr_monto_abril').value = ret.abril;

									getObj('pre_antepresupuesto_ley_pr_monto_mayo').value = ret.mayo;

									getObj('pre_antepresupuesto_ley_pr_monto_junio').value = ret.junio;

									getObj('pre_antepresupuesto_ley_pr_monto_julio').value = ret.julio;

									getObj('pre_antepresupuesto_ley_pr_monto_agosto').value = ret.agosto;

									getObj('pre_antepresupuesto_ley_pr_monto_septiembre').value = ret.septiembre;

									getObj('pre_antepresupuesto_ley_pr_monto_octubre').value = ret.octubre;

									getObj('pre_antepresupuesto_ley_pr_monto_noviembre').value = ret.noviembre;

									getObj('pre_antepresupuesto_ley_pr_monto_diciembre').value = ret.diciembre;
									
									getObj('pre_antepresupuesto_ley_pr_monto_presupuesto').value = ret.suma;
									
									getObj('pre_antepresupuesto_ley_pr_comentario').value = ret.comentario;
									getObj('pre_antepresupuesto_ley_pr_btn_cancelar').style.display='';
									getObj('pre_antepresupuesto_ley_pr_btn_actualizar').style.display='';
									getObj('pre_antepresupuesto_ley_pr_btn_guardar').style.display='none';
...
////////////////////////////////
//------------------ partida ---------------------------
$("#pre_antepresupuesto_ley_pr_btn_consultar_partida").click(function() {
	/*var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/presupuesto/presupuesto_ley/db/grid_presupuesto_ley.php", { },
                        function(data)
	...
	$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
				...
				getObj('pre_antepresupuesto_ley_pr_accion_central_id').value = recordset[0];
				getObj('pre_antepresupuesto_ley_pr_nombre_central').value=recordset[1];
				getObj('pre_antepresupuesto_ley_pr_proyecto_id').value="";
			 ...
			 {  
			   	getObj('pre_antepresupuesto_ley_pr_accion_central_id').value ="";
			    getObj('pre_antepresupuesto_ley_pr_nombre_central').value="";
				getObj('pre_antepresupuesto_ley_pr_proyecto_id').value="";
...
// -----
$("#pre_antepresupuesto_ley_pr_btn_consultar_central").click(function() {
if(getObj('pre_antepresupuesto_ley_pr_proyecto_id').value =="")
{
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	//**************
	$.ajax ({
			...
			success: function(data)
			{
				...
				dialog_reload=function gridReload(){ //alert('aqui');
					var busq_nombre= jQuery("#ante_pre_antepresupuesto_ley_pr_accion_nom").val(); 
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/presupuesto/presupuesto_ley/db/cmb.sql.accion_central.php?busq_nombre="+busq_nombre+'&ano='+getObj('pre_antepresupuesto_ley_pr_anio').value,page:1}).trigger("reloadGrid"); 
				}
				crear_grid();
		...
		//	});
				var timeoutHnd; 
				var flAuto = true;
				$("#ante_pre_antepresupuesto_ley_pr_accion_nom").keypress(function(key)
				{
						if(key.keyCode==27){this.close();}
						programa_dosearch();
	...
	/*$.post("modulos/presupuesto/presupuesto_ley/db/grid_presupuesto_ley.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/presupuesto_ley/db/cmb.sql.accion_central.php?nd='+nd+'&ano='+getObj('pre_antepresupuesto_ley_pr_anio').value,
								datatype: "json",
								...
								onSelectRow: function(id){
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('pre_antepresupuesto_ley_pr_accion_central_id').value = ret.id;
									getObj('pre_antepresupuesto_ley_pr_codigo_central').value = ret.codigo;
									getObj('pre_antepresupuesto_ley_pr_nombre_central').value = ret.denominacion;
									getObj('presupuesto_ley_db_nombre_proyecto').value="  NO APLICA ESTA OPCION  ";
									getObj('presupuesto_ley_db_codigo_proyecto').value ="0000" ;
									getObj('presupuesto_ley_db_codigo_proyecto').disabled="disabled" ;
									dialog.hideAndUnload();
	...
	$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
				...
				{
				recordset = recordset.split("*");
				getObj('pre_antepresupuesto_ley_pr_proyecto_id').value = recordset[0];
				getObj('presupuesto_ley_db_nombre_proyecto').value=recordset[1];
				getObj('pre_antepresupuesto_ley_pr_accion_central_id').value="";
				getObj('pre_antepresupuesto_ley_pr_nombre_central').value="  NO APLICA ESTA OPCION  ";
				getObj('pre_antepresupuesto_ley_pr_codigo_central').value ="0000" ;
				getObj('pre_antepresupuesto_ley_pr_codigo_central').disabled="disabled" ;
				}
				else
			 {  
			   	getObj('pre_antepresupuesto_ley_pr_proyecto_id').value ="";
			    getObj('presupuesto_ley_db_nombre_proyecto').value="";
				getObj('pre_antepresupuesto_ley_pr_nombre_central').value="";
				getObj('pre_antepresupuesto_ley_pr_codigo_central').value ="" ;
				getObj('pre_antepresupuesto_ley_pr_accion_central_id').value ="";
				getObj('pre_antepresupuesto_ley_pr_codigo_central').disabled="" ;
				}
			 }
		});	 	 
}
...
$("#pre_antepresupuesto_ley_pr_btn_consultar_proyecto").click(function() {
if(getObj('pre_antepresupuesto_ley_pr_accion_central_id').value =="")
{
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
		$.ajax ({
			...
			success: function(data)
			{
				...
				//dialog=new Boxy('<table id="list_grid_'+nd+'" class="scroll" cellpadding="0" cellspacing="0"></table><div id="pager_grid_'+nd+'" class="scroll" style="text-align:center;"></div>', { title: 'Consulta Emergente de Unidad', modal: true,center:false,x:0,y:0,show:false });								
				dialog_reload=function gridReload(){ //alert('aqui');
					var busq_nombre= jQuery("#ante_pre_antepresupuesto_ley_pr_proyect_nom").val(); 
					jQuery("#list_grid_"+nd).setGridParam({url:"modulos/presupuesto/presupuesto_ley/db/cmb.sql.proyecto.php?busq_nombre="+busq_nombre+'&ano='+getObj('pre_antepresupuesto_ley_pr_anio').value,page:1}).trigger("reloadGrid"); 
				}
				crear_grid();
		//	$("#programa-consultas-busq_nombre").keypress(function(key){
		//		if(key.keyCode==13) $("#programa-consultas-busq_nombre").click();
		//	});
				var timeoutHnd; 
				var flAuto = true;
				$("#ante_pre_antepresupuesto_ley_pr_proyect_nom").keypress(function(key)
				{
						if(key.keyCode==27){this.close();}
						programa_dosearch();
	...
	/*$.post("modulos/presupuesto/presupuesto_ley/db/grid_presupuesto_ley.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/presupuesto_ley/db/cmb.sql.proyecto.php?nd='+nd+'&ano='+getObj('pre_antepresupuesto_ley_pr_anio').value,
								datatype: "json",
								...
								onSelectRow: function(id){
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('pre_antepresupuesto_ley_pr_proyecto_id').value = ret.id;
	...
	$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
				...
				{
				recordset = recordset.split("*");
				getObj('pre_antepresupuesto_ley_pr_accion_especifica').value = recordset[0];
...
// -----
$("#pre_antepresupuesto_ley_pr_btn_consultar_especifica").click(function() {
if(getObj('pre_antepresupuesto_ley_pr_accion_central_id').value !="" || getObj('pre_antepresupuesto_ley_pr_proyecto_id').value !="")
{
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/presupuesto/presupuesto_ley/db/grid_presupuesto_ley.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/presupuesto_ley/db/cmb.sql.accion_especifica.php?nd='+nd+"&proyecto="+getObj('pre_antepresupuesto_ley_pr_proyecto_id').value+"&accion_central="+getObj('pre_antepresupuesto_ley_pr_accion_central_id').value,
								datatype: "json",
								...
								onSelectRow: function(id){
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									getObj('pre_antepresupuesto_ley_pr_accion_especifica').value = ret.id;
...
$("#pre_antepresupuesto_ley_pr_btn_consultar_unidad_ejecutora").click(function() {
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	//**************
	$.ajax ({
			...
			success: function(data)
			{
				...
				//dialog=new Boxy('<table id="list_grid_'+nd+'" class="scroll" cellpadding="0" cellspacing="0"></table><div id="pager_grid_'+nd+'" class="scroll" style="text-align:center;"></div>', { title: 'Consulta Emergente de Unidad', modal: true,center:false,x:0,y:0,show:false });								
				dialog_reload=function gridReload(){ //alert('aqui');
					var busq_nombre= jQuery("#ante_pre_antepresupuesto_ley_pr_unidad").val(); 
		...
		//	});
				var timeoutHnd; 
				var flAuto = true;
				$("#ante_pre_antepresupuesto_ley_pr_unidad").keypress(function(key)
				{
						if(key.keyCode==27){this.close();}
						programa_dosearch();
...
/*	$.post("modulos/presupuesto/presupuesto_ley/db/grid_presupuesto_ley.php", { },
				...
				function crear_grid()
				{
					...
					({
						...
						onSelectRow: function(id){
						var ret = jQuery("#list_grid_"+nd).getRowData(id);
							getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id').value = ret.id;
							getObj('pre_antepresupuesto_ley_pr_codigo_unidad_ejecutora').value = ret.codigo;
							getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora').value = ret.nombre;
							dialog.hideAndUnload();
						},
						loadComplete:function (id){
	...
	$.ajax({
			...
			cache: false,
			 success:function(html)
			 {
				...
				{
				recordset = recordset.split("*");
				getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id').value = recordset[0];
				getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora').value=recordset[1];
				//setBarraEstado(html);
				}
				else
			 	{  
			   	getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora_id').value = "";
...
$('#pre_antepresupuesto_ley_pr_codigo_central').numeric({allow:''});
$('#pre_antepresupuesto_ley_pr_codigo_central').change(consulta_automatica_accion_central);
$('#presupuesto_ley_db_codigo_proyecto').numeric({allow:''});
$('#presupuesto_ley_db_codigo_proyecto').change(consulta_automatica_proyecto);
$('#pre_antepresupuesto_ley_pr_codigo_unidad_ejecutora').change(consulta_automatica_unidad_ejecutora);


/*$("#pre_antepresupuesto_ley_pr_proyecto").change(update_unidad_especifica_proyecto);
$("#pre_antepresupuesto_ley_pr_accion_central").change(update_unidad_especifica_central);*/

function deshabilita_proyecto()
{
				

	if (getObj('pre_antepresupuesto_ley_pr_accion_central').value != 0)
	{
		document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_proyecto.disabled=true;
	}
	if (getObj('pre_antepresupuesto_ley_pr_accion_central').value == 0)
	{
		document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_proyecto.disabled=false;
	}
}
function deshabilita_accion_centralizada()
{
	if (document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_proyecto.value != 0)
	{
		document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_accion_central.disabled=true;
	}
	if (document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_proyecto.value == 0)
	{
		document.form_pr_pre_antepresupuesto.pre_antepresupuesto_ley_pr_accion_central.disabled=false;
	}
}
$("#pre_antepresupuesto_ley_pr_btn_cancelar").click(function() {
	setBarraEstado("");
	getObj('pre_antepresupuesto_ley_pr_btn_cancelar').style.display='';
	getObj('pre_antepresupuesto_ley_pr_btn_actualizar').style.display='none';
	getObj('pre_antepresupuesto_ley_pr_btn_guardar').style.display='';
	clearForm('form_pr_pre_antepresupuesto');
					...
					getObj('pre_antepresupuesto_ley_pr_monto_diciembre').value =    '0,00';
					getObj('pre_antepresupuesto_ley_pr_monto_presupuesto').value =	'0,00';
					getObj('pre_antepresupuesto_ley_pr_accion_central').value =		0;
					getObj('pre_antepresupuesto_ley_pr_proyecto').value =			0;
					getObj('pre_antepresupuesto_ley_pr_accion_especifica').value =	0;
					getObj('pre_antepresupuesto_ley_pr_unidad_ejecutora').value =	0;
...
/*-------------------   Inicio Validaciones  ---------------------------*/
$('#pre_antepresupuesto_ley_pr_anio').numeric({allow:''});
$('#pre_antepresupuesto_ley_pr_monto_enero').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_febrero').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_marzo').numeric({allow:', . '});
$('#pre_antepresupuesto_ley_pr_monto_abril').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_mayo').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_junio').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_julio').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_agosto').numeric({allow:',.'});
$('#pre_antepresupuesto_ley_pr_monto_septiembre').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_octubre').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_noviembre').numeric({allow:', .'});
$('#pre_antepresupuesto_ley_pr_monto_diciembre').numeric({allow:', .'});
...
{ 
	...
	valor=getObj('pre_antepresupuesto_ley_pr_monto_enero').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_febrero').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_marzo').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_abril').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_mayo').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_junio').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_julio').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_agosto').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_septiembre').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_octubre').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_noviembre').value.float() + getObj('pre_antepresupuesto_ley_pr_monto_diciembre').value.float();
	
	//valor='999999.58';
	valor = valor.currency(2,',','.');	
		
	getObj('pre_antepresupuesto_ley_pr_monto_presupuesto').value = valor;
...
<div id="botonera">
	<img id="pre_antepresupuesto_ley_pr_btn_cancelar" class="btn_cancelar"src="imagenes/null.gif" />
	<img id="pre_antepresupuesto_ley_pr_btn_consultar" class="btn_consultar" src="imagenes/null.gif"  />
    <img id="pre_antepresupuesto_ley_pr_btn_actualizar" class="btn_actualizar" src="imagenes/null.gif" style="display:none" />
	<img id="pre_antepresupuesto_ley_pr_btn_guardar" class="btn_guardar" src="imagenes/null.gif"  />
</div>

<form method="post" name="form_pr_pre_antepresupuesto" id="form_pr_pre_antepresupuesto">
  <input name="pre_antepresupuesto_ley_pr_id" id="pre_antepresupuesto_ley_pr_id" type="hidden" />
  <input name="pre_antepresupuesto_ley_pr_accion_central_id_old" id="pre_antepresupuesto_ley_pr_accion_central_id_old" type="hidden" />
  <input name="pre_antepresupuesto_ley_pr_proyecto_id_old" id="pre_antepresupuesto_ley_pr_proyecto_id_old" type="hidden" />
  <input name="pre_antepresupuesto_ley_pr_accion_especifica_old" id="pre_antepresupuesto_ley_pr_accion_especifica_old" type="hidden" />
  <input name="pre_antepresupuesto_ley_pr_unidad_ejecutora_id_old" id="pre_antepresupuesto_ley_pr_unidad_ejecutora_id_old" type="hidden" />
  <input name="pre_antepresupuesto_ley_pr_partida_numero_old" id="pre_antepresupuesto_ley_pr_partida_numero_old" type="hidden" />
  
  <input type="hidden" name="campo" id="campo" />
	<table class="cuerpo_formulario">
  <tr>
			<th class="titulo_frame" colspan="2"><img src="imagenes/iconos/desktop24x24.png" style="padding-right:5px;" align="absmiddle" /> Ante Proyecto de Presupuesto	para	Revisi&oacute;n	</th>
	  </tr>
		<tr>
			<th>A&ntilde;o:</th>
			<td>
				<select  name="pre_antepresupuesto_ley_pr_anio" id="pre_antepresupuesto_ley_pr_anio">
					<?
					$anio_inicio=2010;
					$anio_fin=2011;
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
					<input name="pre_antepresupuesto_ley_pr_codigo_unidad_ejecutora" type="text" id="pre_antepresupuesto_ley_pr_codigo_unidad_ejecutora"  maxlength="6"
					...
					<input name="pre_antepresupuesto_ley_pr_unidad_ejecutora" type="text" id="pre_antepresupuesto_ley_pr_unidad_ejecutora"  style="width:60ex" maxlength="100"
								message="Introduzca la unidad ejecutora." readonly
					>
					
					</li>
					<li id="pre_antepresupuesto_ley_pr_btn_consultar_unidad_ejecutora" class="btn_consulta_emergente"></li>
				</ul>
				<input name="pre_antepresupuesto_ley_pr_unidad_ejecutora_id" type="hidden" id="pre_antepresupuesto_ley_pr_unidad_ejecutora_id" />
			</td>
		</tr>
		<tr>
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="pre_antepresupuesto_ley_pr_codigo_central" type="text" id="pre_antepresupuesto_ley_pr_codigo_central"  maxlength="6"
						...
						<input name="pre_antepresupuesto_ley_pr_nombre_central" type="text" id="pre_antepresupuesto_ley_pr_nombre_central"  style="width:60ex" maxlength="100"
						message="Introduzca una Denominacion para la Accion Central." 
						>
					</li>
					<li id="pre_antepresupuesto_ley_pr_btn_consultar_central" class="btn_consulta_emergente"></li>
				</ul>
		 	  	<input name="pre_antepresupuesto_ley_pr_accion_central_id" type="hidden" id="pre_antepresupuesto_ley_pr_accion_central_id" />
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					...
					<li id="pre_antepresupuesto_ley_pr_btn_consultar_proyecto" class="btn_consulta_emergente"></li>
				</ul>
		 	  	<input name="pre_antepresupuesto_ley_pr_proyecto_id" type="hidden" id="pre_antepresupuesto_ley_pr_proyecto_id" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					...
					<li id="pre_antepresupuesto_ley_pr_btn_consultar_especifica" class="btn_consulta_emergente"></li>
				</ul>
		 	  	<input name="pre_antepresupuesto_ley_pr_accion_especifica" type="hidden" id="pre_antepresupuesto_ley_pr_accion_especifica" />
<!--				<select name="pre_antepresupuesto_ley_pr_accion_especifica" id="pre_antepresupuesto_ley_pr_accion_especifica" style="width:400px; min-width:400px;">
		...
		<tr>
			...
			<ul class="input_con_emergente">
				<li>
					<input name="pre_antepresupuesto_ley_pr_partida_numero" type="text" id="pre_antepresupuesto_ley_pr_partida_numero" size="9" maxlength="12"/>
					<input name="pre_antepresupuesto_ley_pr_partida" type="text" id="pre_antepresupuesto_ley_pr_partida" style="width:57ex" maxlength="100" readonly 
				...
				<li id="pre_antepresupuesto_ley_pr_btn_consultar_partida" class="btn_consulta_emergente"></li>
			</ul>
			...
			<th colspan="2">
				<table class="clear" width="100%" border="0">
					<tr>
						<th>Enero</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_enero" type="text" id="pre_antepresupuesto_ley_pr_monto_enero" onblur="suma()" onKeyPress="reais(this,event)" onKeyDown="backspace(this,event)" value="0,00" size="16" maxlength="16" 
							message="Introduzca el Monto Asignado para Enero" jVal="{valid:/^[0123456789,. ]{1,60}$/, message:'Monto Invalido', styleType:'cover'}"  
							jValKey="{valid:/[0123456789,]/, cFunc:'alert', cArgs:['Año: '+$(this).val()]}" style="text-align:right">
				    </td>
						<th>Febrero</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_febrero" type="text" id="pre_antepresupuesto_ley_pr_monto_febrero" onblur="suma()"
						...
						<th>Marzo</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_marzo" type="text" id="pre_antepresupuesto_ley_pr_monto_marzo" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
					...
					<tr>
						<th>Abril</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_abril" type="text" id="pre_antepresupuesto_ley_pr_monto_abril"  onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Mayo</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_mayo" type="text" id="pre_antepresupuesto_ley_pr_monto_mayo" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Junio</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_junio" type="text" id="pre_antepresupuesto_ley_pr_monto_junio" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
					...
					<tr>
						<th>Julio</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_julio" type="text" id="pre_antepresupuesto_ley_pr_monto_julio" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Agosto</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_agosto" type="text" id="pre_antepresupuesto_ley_pr_monto_agosto" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Septiembre</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_septiembre" type="text" id="pre_antepresupuesto_ley_pr_monto_septiembre" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
					...
					<tr>
						<th>Octubre</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_octubre" type="text" id="pre_antepresupuesto_ley_pr_monto_octubre" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Noviembre</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_noviembre" type="text" id="pre_antepresupuesto_ley_pr_monto_noviembre" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
						...
						<th>Diciembre</th>
						<td>
							<input  name="pre_antepresupuesto_ley_pr_monto_diciembre" type="text" id="pre_antepresupuesto_ley_pr_monto_diciembre" onblur="suma()"
							 value="0,00" size="16" maxlength="16" 
		...
		<tr>
			...
			<td>
				<input  name="pre_antepresupuesto_ley_pr_monto_presupuesto" type="text" id="pre_antepresupuesto_ley_pr_monto_presupuesto" size="20" maxlength="20"  message="Introduzca el Monto Asignado al Presupuesto" jVal="{valid:/^[0123456789,. ]{1,60}$/, message:'Monto Invalido', styleType:'cover'}"  jValKey="{valid:/[0123456789,.]/, cFunc:'alert', cArgs:['Monto: '+$(this).val()]}" readonly="readonly" style="text-align:right">
			</td>
		</tr>
		...
		<tr>
			<th>Comentario:</th>
			<td>
				<textarea name="pre_antepresupuesto_ley_pr_comentario" id="pre_antepresupuesto_ley_pr_comentario" cols="62" rows="3" message="Introduzca un Comentario para el Presupuesto."></textarea>
			</td>
		</tr>
	<tr>
