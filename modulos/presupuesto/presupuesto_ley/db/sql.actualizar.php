...
$partida_todas = $_POST[presupuesto_ley_pr_partida_numero_old];

$partida =explode(".",$partida_toda);
$partidax =explode(".",$partida_todas);
$sqlBus = "SELECT  * FROM anteproyecto_presupuesto WHERE (id_organismo = ".$_SESSION['id_organismo'].") AND ((id_accion_central = ".$_POST[presupuesto_ley_pr_accion_central_id_old].") OR (id_proyecto = ".$_POST[presupuesto_ley_pr_proyecto_id_old].")) AND (id_unidad_ejecutora = ".$_POST[presupuesto_ley_pr_unidad_ejecutora_id_old].") AND (id_accion_especifica = ".$_POST[presupuesto_ley_pr_accion_especifica_old].")  AND (anio = '".$_POST[presupuesto_ley_pr_anio]."')  AND (partida = '".$partidax[0]."') AND (generica = '".$partidax[1]."') AND (especifica = '".$partidax[2]."') AND (sub_especifica = '".$partidax[3]."') AND (estatus <>2)";
...
//***************
if ($_POST[presupuesto_ley_pr_proyecto_id] == "" || $_POST[presupuesto_ley_pr_proyecto_id] == 0)
	$proyecto = 0;
else
	$proyecto = $_POST[presupuesto_ley_pr_proyecto_id];
	
if ($_POST[presupuesto_ley_pr_accion_central_id] == "" || $_POST[presupuesto_ley_pr_accion_central_id] == 0)
	$accion_central = 0;
else
	...
	$sql = "	
			...
			SET  
				...
				id_unidad_ejecutora=".$_POST[presupuesto_ley_pr_unidad_ejecutora_id].", 
		   		id_accion_especifica=".$_POST[presupuesto_ley_pr_accion_especifica].", 
				id_proyecto=".$proyecto.", 
				anio='".$_POST[presupuesto_ley_pr_anio]."', 
				partida='".$partida[0]."', 
				generica='".$partida[1]."', 
				...
				comentario='".$_POST[presupuesto_ley_pr_comentario]."', 
				fecha_modificacion='".$fecha."', 
		   		ultimo_usuario=".$_SESSION['id_usuario']."
			WHERE 
				(id_anteproyecto_presupuesto=".$_POST[presupuesto_ley_pr_id].")
			";
