...
if (!$row->EOF)
{
$codigo_accion_central = $row->fields('codigo_accion_central');
$accion_central = $row->fields('denominacion');
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{	
		global   $anio,$codigo_accion_central, $accion_central, $texto;	
			...
			$this->Cell(0,10,'RESUMEN DE PRESUPUESTO DE LEY POR ACCION CENTRALIZADA',0,0,'C');
			$this->Ln(7);	
			...
			$this->SetFont('Arial','B',12);
			$this->Cell(155,10,$codigo_accion_central." ".$accion_central,0,0,'R');	
			$this->Ln(8);
			$this->SetFont('Arial','B',9);
