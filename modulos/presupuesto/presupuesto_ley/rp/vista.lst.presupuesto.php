...
$Sql="
	SELECT 
		...
		id_accion_especifica, anio, anteproyecto_presupuesto.partida, anteproyecto_presupuesto.generica, anteproyecto_presupuesto.especifica, 	anteproyecto_presupuesto.sub_especifica, clasificador_presupuestario.denominacion AS clasificado,
		 (enero + febrero + marzo + abril + mayo + junio + julio + agosto + septiembre + octubre + noviembre + diciembre) AS total, anteproyecto_presupuesto.comentario 
