...
AND
	\"presupuesto_ejecutadoR\".especifica = '$par_espe'	
";
//die($sql); $par_espe
...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{	
		global   $anio,$partida, $generica, $par_espe, $texto, $nombre_unidad ;	
			...
			$this->Cell(0,10,'RESUMEN DE PRESUPUESTO DE LEY POR PARTIDA, GENERICA Y ESPECIFICA',0,0,'C');
			$this->Ln(7);	
			$this->SetFont('Arial','B',8);
			$this->Cell(0,5,$texto,0,0,'C');
			$this->Ln(5);	
			$this->SetFont('Arial','B',12);
			$this->Cell(50,10,'Año: '.$anio,0,0,'L');
			$this->SetFont('Arial','B',12);
			$this->Cell(215,10, $nombre_unidad .'.  PARTIDA '.$partida.'.'.$generica.'.'.$par_espe ,0,0,'R');	
			$this->Ln(8);
			$this->SetFont('Arial','B',9);
