...
$Sql="
	...
	WHERE (id_accion_central= $accion_central) AND (anio ='$anio')
...
{ 
		...
		class PDF extends FPDF
		{
			...
			function Header()
			{		
				global   $ano,$accion_centraln, $AccionC, $accion_centralncodi;
				...
				$this->Cell(0,10,'ANTEPROYECTO DE PRESUPUESTO POR ACCIÓN CENTRALIZADA',0,0,'C');
				$this->Ln(11);	
				$this->SetFont('Arial','B',12);
				$this->Cell(30,10,'Año: '.$ano,0,0,'L');
				$this->MultiCell(150,		5,		$accion_centralncodi.'-'.$accion_centraln,	0,'L',0);
