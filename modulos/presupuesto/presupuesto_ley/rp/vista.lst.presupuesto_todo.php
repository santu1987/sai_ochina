...
{ 
	...
	$jefe_unidad = $row->fields('jefe_unidad');
		...
		class PDF extends FPDF
		{
			...
			{		
				...
				$this->Cell(120,	6,		'Acción Central/Proyecto',		0,0,'L',1);
				$this->Cell(20,		6,		'401',							'RL',0,'C',1);
				$this->Cell(20,		6,		'402',							'L',0,'C',1);
				$this->Cell(20,		6,		'403',							'L',0,'C',1);
				$this->Cell(20,		6,		'404',							'L',0,'C',1);
				$this->Cell(20,		6,		'Monto',						'L',0,'R',1);
				$this->Ln(6);
			}
			//Pie de página
			function Footer()
	...
	$total=0;
			...
			$sql_par = "
				...
				$xx++;
					...
					AND 
						(id_unidad_ejecutora= ".$row->fields('id_unidad_ejecutora').") 
					AND
						(partida= '401' OR partida= '402' OR partida= '403' OR partida= '404')
					";
					...
					$pdf->Cell(120,	6,	$SqlProyectoAccion,														0,0,'L',1);
					$pdf->Cell(20,	6,	number_format($uno,2,',','.'),																	'RL',0,'R',1);
					$pdf->Cell(20,	6,	number_format($dos,2,',','.'),																	'L',0,'R',1);
					$pdf->Cell(20,	6,	number_format($tres,2,',','.'),																	'L',0,'R',1);
					$pdf->Cell(20,	6,	number_format($cuatro,2,',','.'),																'L',0,'R',1);
					$pdf->Cell(20,	6,	number_format($total_par,2,',','.'),									'L',0,'R',1);
					$pdf->Ln(6);
	   ...
	   FROM presupuesto_ley WHERE (partida= '401' OR partida= '402' OR partida= '403' OR partida= '404')";
