...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{	
		global   $anio,$codigo_proyecto, $proyecto, $texto;	
			...
			$this->Cell(0,10,'RESUMEN DE PRESUPUESTO DE LEY POR PROYECTO',0,0,'C');
			$this->Ln(7);	
			$this->SetFont('Arial','B',8);
			$this->Cell(0,5,$texto,0,0,'C');
			$this->Ln(5);	
			$this->SetFont('Arial','B',12);
			$this->Cell(100,10,'Año: '.$anio,0,0,'L');
			$this->SetFont('Arial','B',12);
			$this->Cell(155,10,$codigo_proyecto." ".$proyecto,0,0,'C');	
			$this->Ln(8);
			$this->SetFont('Arial','B',9);
