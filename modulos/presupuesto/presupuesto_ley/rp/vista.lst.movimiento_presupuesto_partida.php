...
//*************************************************************************************************************
	class PDF extends FPDF
	{
		...
		function Header()
		{	
		global   $anio,$partida, $texto, $nombre_unidad ;	
			...
			$this->Cell(0,10,'RESUMEN DE PRESUPUESTO DE LEY POR PARTIDA',0,0,'C');
			$this->Ln(7);	
			...
			$this->SetFont('Arial','B',12);
			$this->Cell(215,10, $nombre_unidad .'.  PARTIDA '.$partida ,0,0,'R');	
			$this->Ln(8);
			$this->SetFont('Arial','B',9);
