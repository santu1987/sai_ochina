...
$Sql="
	...
	WHERE (id_proyecto= $proyecto) AND (anio ='$anio') AND (id_unidad_ejecutora =$unidad_ejecutora)
...
{ 
		...
		if(!$rowAccionC->EOF){
			...
			$proyecton_codigo = $rowAccionC->fields('codigo_proyecto');
		}
		...
		class PDF extends FPDF
		{
			...
			function Header()
			{		
				global   $ano,$proyecton, $AccionC, $unidad, $codigo_unidad_ejecutora, $proyecton_codigo;
				...
				$this->Ln(8);
				$this->MultiCell(0,6,'Proyecto: '.$proyecton_codigo ." ".$proyecton,0,'L',0);
				//$this->Ln(8);
				$this->MultiCell(0,6,'Unidad Ejecutora: '.$codigo_unidad_ejecutora." ".utf8_decode($unidad),0,'L',0);
	...
	$total=0;
	   ...
	   FROM anteproyecto_presupuesto WHERE (id_proyecto= ".$proyecto.") AND (anio ='$anio') AND (id_unidad_ejecutora =$unidad_ejecutora) ";
...
////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$pdf->Cell(85,		6,	utf8_decode($row->fields("clasificador_presupuestario")) ,		0,0,'L',1);
