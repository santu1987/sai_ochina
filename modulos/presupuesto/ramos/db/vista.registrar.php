...
$("#ramos_db_btn_consultar").click(function() {
	...
	$.post("modulos/presupuesto/ramos/db/grid_ramos.php", { },
                        function(data)
                        {								
								dialog=new Boxy('<table id="list_grid_'+nd+'" class="scroll" cellpadding="0" cellspacing="0"></table><div id="pager_grid_'+nd+'" class="scroll" style="text-align:center;"></div>', { title: 'Consulta Emergente de Ramos',modal: true,center:false,x:0,y:0,show:false});								
