...
$sqlbus ="SELECT id_accion_especifica  FROM accion_especifica_proyecto where accion_especifica_proyecto.id_proyecto=$_GET[id_accion]";
...
$sql = "	
				...
				FROM 
					accion_especifica
				where id_accion_especifica  NOT IN (SELECT id_accion_especifica FROM accion_especifica_proyecto where accion_especifica_proyecto.id_proyecto = $_GET[id_accion]) 
				ORDER BY 
					accion_especifica.denominacion
			";
}else
