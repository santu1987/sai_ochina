...
$Sql="
			SELECT 
				count(DISTINCT \"presupuesto_ejecutadoR\".id_accion_especifica)
				FROM 
					accion_especifica
				INNER JOIN 
				...
				AND
					accion_especifica.id_accion_central=\"presupuesto_ejecutadoR\".id_accion_central
				WHERE
				...
				AND
				(\"presupuesto_ejecutadoR\".anio='".$fecha."') 
";
