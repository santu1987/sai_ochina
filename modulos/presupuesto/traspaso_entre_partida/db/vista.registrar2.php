...
$("#traspaso_entre_partida_db_btn_guardar").click(function() {
	if($('#form_db_traspaso_entre_partida').jVal())
	{
		...
		$.ajax (
		{
		url: "modulos/presupuesto/traspaso_entre_partida/db/sql.traspaso_entre_partida.php",
	...
	$.post("modulos/presupuesto/traspaso_entre_partida/db/grid_traspaso_entre_partida.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/traspaso_entre_partida/db/cmb.sql.unidad_ejecutora.php?nd='+nd+'&ano='+getObj('traspaso_entre_partida_db_ano').value,
								datatype: "json",
								...
								var ret = jQuery("#list_grid_"+nd).getRowData(id);
									...
									getObj('traspaso_entre_partida_db_nombre_unidad').value = ret.nombre;
									dialog.hideAndUnload();
					 			},
								loadComplete:function (id){
									setBarraEstado("");
...
{ 
	$.ajax({
			url:"modulos/presupuesto/traspaso_entre_partida/db/sql_grid_unidad.php",
            data:dataForm('form_db_traspaso_entre_partida'), 
			type:'POST',
			cache: false,
			 success:function(html)
			 {
				...
				getObj('traspaso_entre_partida_db_nombre_unidad').value=recordset[1];
				}
				else
			 {  
			   	getObj('traspaso_entre_partida_db_unidad_ejecutora').value ="";
			    getObj('traspaso_entre_partida_db_nombre_unidad').value="";
				}
			 }
		});	 	 
}
...
if(document.form_db_traspaso_entre_partida.traspaso_entre_partida_db_proyecto_id.value !="" || document.form_db_traspaso_entre_partida.traspaso_entre_partida_db_accion_central_id.value !="")
{
	var nd=new Date().getTime();
	setBarraEstado("<img align='absmiddle' src='imagenes/loading.gif' /> Esperando Respuesta del Servidor...");
	$.post("modulos/presupuesto/traspaso_entre_partida/db/grid_traspaso_entre_partida.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/traspaso_entre_partida/db/cmb.sql.partida.php?nd='+nd+'&unidad='+getObj('traspaso_entre_partida_db_unidad_ejecutora').value+'&unidad_es='+getObj('traspaso_entre_partida_db_accion_especifica_id_receptor').value+'&patidaa='+getObj('traspaso_entre_partida_db_partida_numero').value, 
								datatype: "json",
								colNames:['Id','Partida', 'Descripci&oacute;n'],
								colModel:[
									{name:'id_clasi_presu',index:'id_clasi_presu', width:50,sortable:false,resizable:false,hidden:true},
...
$("#traspaso_entre_partida_db_btn_cancelar").click(function() {
	...
	getObj('traspaso_entre_partida_db_mes_cendente').value =	0;
	getObj('traspaso_entre_partida_db_mes_receptor').value =	0;
	getObj('traspaso_entre_partida_db_unidad_ejecutora').value =0;
...
$('#traspaso_entre_partida_db_codigo_unidad').numeric({allow:''});
	  ...
	  <th colspan="2" align="center" bgcolor="#83B4D8" style="text-align:center;color:#FFFFFF; font-size:14px">Cedente	</td>	  </tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_unidad" type="text" id="traspaso_entre_partida_db_codigo_unidad"  maxlength="5"
						onchange="consulta_automatica_unidad" onclick="consulta_automatica_unidad"
						message="Introduzca un Codigo para el Accion Central."  size="5"
						jVal="{valid:/^[0-9]{4,5}$/, message:'Codigo Invalido', styleType:'cover'}" >
					
						<input name="traspaso_entre_partida_db_nombre_unidad" type="text" id="traspaso_entre_partida_db_nombre_unidad"  style="width:60ex" maxlength="60"
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_central" type="text" id="traspaso_entre_partida_db_codigo_central"  maxlength="5"
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_proyecto" type="text" id="traspaso_entre_partida_db_codigo_proyecto"  maxlength="5"
						...
						jVal="{valid:/^[a-zA-Z0-9 áéíóúÁÉÍÓÚ ,.1234567890-_]{1,100}$/, message:'Nombre Invalido', styleType:'cover'}"
						jValKey="{valid:/^[a-zA-Z0-9 ,.áéíóúÁÉÍÓÚ 1234567890-_]/, cFunc:'alert', cArgs:['Nombre: '+$(this).val()]}">
					</li>
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_especifica" type="text" id="traspaso_entre_partida_db_codigo_especifica"  maxlength="5"
						onchange="consulta_automatica_especifica" onclick="consulta_automatica_especifica"
						message="Introduzca una Codigo para la Accion Especifica."  size="5"
						jVal="{valid:/^[0-9]{4,5}$/, message:'Codigo Invalido', styleType:'cover'}" >
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						...
						message="Introduzca un Codigo para el Accion Central."  size="5" maxlength="4"
						...
						message="Introduzca una Denominacion para la Accion Central." 
						jVal="{valid:/^[a-zA-Z0-9 áéíóúÁÉÍÓÚ 1234567890-_]{1,60}$/, message:'Denominacion Invalido', styleType:'cover'}"
						jValKey="{valid:/^[a-zA-Z0-9 áéíóúÁÉÍÓÚ 1234567890-_]/, cFunc:'alert', cArgs:['Nombre: '+$(this).val()]}">
					</li>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						...
						message="Introduzca un Codigo para el Proyecto."  size="5" maxlength="4"
						jVal="{valid:/^[0-9]{4}$/, message:'Codigo Invalido', styleType:'cover'}" >
			...
			<td>
				...
				<ul class="input_con_emergente">
					<li>
						...
						message="Introduzca una Codigo para la Accion Especifica."  size="5" maxlength="5"
						jVal="{valid:/^[0-9]{4,5}$/, message:'Codigo Invalido', styleType:'cover'}" >
