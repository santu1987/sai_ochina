	...
	$.post("modulos/presupuesto/traspaso_entre_partida/db/grid_traspaso_entre_partida.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								recordtext:"Registro(s)",
								loadtext: "Recuperando Información del Servidor",		
								url:'modulos/presupuesto/traspaso_entre_partida/db/cmb.sql.partida2.php?nd='+nd+'&unidad='+getObj('traspaso_entre_partida_db_unidad_ejecutora').value+'&unidad_es='+getObj('traspaso_entre_partida_db_accion_especifica_id_receptor').value+'&patidaa='+getObj('traspaso_entre_partida_db_partida_numero').value, 
								datatype: "json",
...
//alert('aqui');
if(getObj('traspaso_entre_partida_db_nombre_unidad').value  !=""  && getObj('traspaso_entre_partida_db_proyecto').value !=""  && getObj('traspaso_entre_partida_db_accion_central').value !=""  && getObj('traspaso_entre_partida_db_partida_numero').value !="")
{
...
{
	$.ajax ({
			url: "modulos/presupuesto/traspaso_entre_partida/db/cmb.sql.monto_mensual2.php",
			data:dataForm('form_db_traspaso_entre_partida'),
			type:'POST',
			cache: false,
			success: function(html)
	  ...
	  <th colspan="2" align="center" bgcolor="#83B4D8" style="text-align:center;color:#FFFFFF; font-size:14px">Cedente	</td>	  </tr>
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_proyecto" type="text" id="traspaso_entre_partida_db_codigo_proyecto"  maxlength="6"
		...
		<tr>
			...
			<td>
				<ul class="input_con_emergente">
					<li>
						<input name="traspaso_entre_partida_db_codigo_especifica" type="text" id="traspaso_entre_partida_db_codigo_especifica"  maxlength="6"
