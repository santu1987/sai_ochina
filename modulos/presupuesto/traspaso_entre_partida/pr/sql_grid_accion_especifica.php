...
$Sql="
			...
			$sqll
			AND	
				(accion_especifica.codigo_accion_especifica ='". $_POST['presupuesto_traspaso_pr_codigo_especifica_cedente']."')
			AND	
...
if (!$row->EOF) 
{
	...
	$responce =$row->fields("id_accion_especifica")."*".  utf8_decode($row->fields("denominacion"))."*".  $row->fields("codigo_accion_especifica");
echo ($responce);
}
