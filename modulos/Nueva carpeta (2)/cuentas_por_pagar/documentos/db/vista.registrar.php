...
$("#list_compro").jqGrid({ 
	...
	onSelectRow: function(id){ //alert(id);
		...
		if(idd && idd!==lastsel){
		$.ajax({
			url:'modulos/cuentas_por_pagar/documentos/db/sql.partidas_compromiso.php?id='+idd+'&fecha='+fecha+'&compromiso='+compromiso+'&iva='+getObj('cuentas_por_pagar_db_iva').value+'&id_factura='+getObj('cuentas_por_pagar_db_id').value,
            data:dataForm('form_cuentas_por_pagar_db_documentos'), 
			type:'GET',
			cache: false,
			 success:function(html)
			 {
       		   url='modulos/cuentas_por_pagar/documentos/db/sql.partidas_compromiso.php?id='+idd+'&fecha='+fecha+'&compromiso='+compromiso+'&id_factura='+getObj('cuentas_por_pagar_db_id').value;
			    var recordset=html;
				//alert(url);
			...
			<tr>-->
			 <th style="border-top: 1px #BADBFC solid">A&ntilde;o</th>
				...
				<td  style="border-top: 1px #BADBFC solid">
				  ...
				  <input type="hidden" name="valor_fact" id="valor_fact">			
							 </td>
			</tr>
			<tr>
			<th>N&uacute;mero:  </th>
