				...
				if($cont==1)
				{
					...
					$row_varias=& $conn->Execute($sql_varias);
													while(!$row_varias->EOF)
													{
														...
														$iva_2=str_replace(",",".",$iva_sec);
														//$mivas=str_replace(",",".",$iva_2);
														//$mnto_iva=(($iva_2)*($row_varias->fields("monto")))/100;
													//	$monto_debito=$row_varias->fields("monto")+$mnto_iva;
														$monto_credito="0";
									...
									$sql_cta="select 
																...
																if(!$row_cta->EOF)
																{
																	...
																	///
																		...
																		if(!$row_comprobante->EOF)
																		{
																			$numero_comprobante_corden1=$row_comprobante->fields("numero_comprobante_integracion");	
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////	
							...
							//die($sql_cuenta_orden);$sql_mod;	$sql_mod_sumas_todas	
...
$fecha_cierre = substr($fecha_cierre,8,2)."".substr($fecha_cierre,4,4)."".substr($fecha_cierre,0,4);

								$responce="integrado"."*".$numero_comprobante3."*".$numero_comprobante_corden."*".$fecha_cierre;
