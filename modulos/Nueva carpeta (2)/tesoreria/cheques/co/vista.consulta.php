...
{ 
	  ...
	  url="modulos/tesoreria/cheques/co/sql.consulta.php?n_cheques="+n_cheques+"&tesoreria_busqueda_banco="+tesoreria_busqueda_banco+"&tesoreria_busqueda_cuenta="+tesoreria_busqueda_cuenta+"&tesoreria_busqueda_proveedor="+tesoreria_busqueda_proveedor+"&tesoreria_busqueda_beneficiario="+tesoreria_busqueda_beneficiario;
	 // alert(url);
	  //setBarraEstado(url);	
