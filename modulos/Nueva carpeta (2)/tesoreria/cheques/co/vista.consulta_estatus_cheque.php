...
setBarraEstado("");
 clearForm('form_tesoreria_pr_cheque_estatus');
	...
	getObj('cheques_estatus_impreso').style.display='none';
	getObj('cheques_estatus_cont').style.display='none';
	getObj('cheques_estatus_finanzas').style.display='none';
	getObj('cheques_estatus_administracion').style.display='none';
	getObj('cheques_estatus_direccion').style.display='none';
	getObj('cheques_estatus_tesoreria').style.display='none';
	...
	//getObj('cheques_estatus_anulado').style.display='none';

	//getObj('tr_reimprimir').style.display='none';
//	getObj('tesoreria_cheques_estatus_che_pr_mismo_numero_oculto').value='0';
		...
		$.post("modulos/tesoreria/cheques/pr/grid_cheques.php", { },
						...
						function crear_grid()
						{
							...
							({
								...
								url:urls,
								datatype: "json",
								colNames:['Id','Id Banco','Banco','Nº Cuenta','Nºchequera','Nºcheque','Beneficiario','Monto','Ordenes','tipo','estatus','estado','codigo','id_proveedor','fecha_estado'],
								colModel:[
									{name:'id',index:'id', width:50,sortable:false,resizable:false,hidden:true},
				...
				function consulta_doc_dosearch()
					{
						...
						function consulta_doc_gridReload()
						{
							...
							url="modulos/tesoreria/cheques/co/cmb.sql.proveedor.php?busq_proveedor="+busq_proveedor;
							//setBarraEstado(url);
						}
		 ...
		 <th>N&ordm; Cheque:</th> 
		  ...
		  <td>
				...
				<li>
         	    ...
         	    <th colspan="2" align="center" bgcolor="#83B4D8" style="text-align:center;color:#FFFFFF; font-size:14px">Tabla de Ubicación de Cheques Según Estatus	</td>	  
         	  </tr>
   ...
   <tr>
    ...
    <th colspan="2" > <table width="517" height="144" class= width="70%" >
	  ...
	  <tr>
		...
		<th width="11%"style="text-align:center;">
				<img id="cheques_estatus_cont" src="imagenes/iconos/check_mark.png" style="display:none" /> 2		</th>
        <th width="11%"style="text-align:center;">
				<img  id="cheques_estatus_finanzas" src="imagenes/iconos/check_mark.png" style="display:none" />3		</th>
        <th width="18%"style="text-align:center;">
				<img id="cheques_estatus_administracion" src="imagenes/iconos/check_mark.png" style="display:none" /> 4		</th>
		<th width="17%"style="text-align:center;">
				<img  id="cheques_estatus_direccion" src="imagenes/iconos/check_mark.png" style="display:none" /> 5		</th>
	</tr>
	  ...
	  <tr>
		...
		<th width="11%"style="text-align:center;"><p><img   src="imagenes/iconos/finanzas.png"  /></br>
          </p>
          <p>Contabilidad</p>
   		  <input type="text" name="cheque_estatus_cont_fecha" id="cheque_estatus_cont_fecha" readonly="readonly" maxlength="10" size="10"/>	
		 </th>
        <th width="11%"style="text-align:center;"><p><img   src="imagenes/iconos/finanzas.png"  /></br>
          </p>
          <p>Finanzas</p>
   		<input type="text" name="cheque_estatus_finanzas_fecha" id="cheque_estatus_finanzas_fecha" readonly="readonly" maxlength="10" size="10"/>	
		 </th>
		 
        <th width="18%"style="text-align:center;">
			<p><img   src="imagenes/iconos/finanzas_cheque.png"  /></br>
		    </p>
			<p>Administraci&oacute;n </p>
	   		<input type="text" name="cheque_estatus_administracion_fecha" id="cheque_estatus_administracion_fecha" readonly="readonly" maxlength="10" size="10"/>	
	
		</th>
		<th width="17%"style="text-align:center;">
			<p><img   src="imagenes/iconos/direccion.png"  /></br>
		    </p>
			<p>Direcci&oacute;n</p>
			<input type="text" name="cheque_estatus_direccion_fecha" id="cheque_estatus_direccion_fecha" readonly="readonly" maxlength="10" size="10"/>	
		</th>
	</tr>
	<tr>				
		<th width="12%"style="text-align:center;">
				<img  id="cheques_estatus_tesoreria"  src="imagenes/iconos/check_mark.png" style="display:none" /> 6		</th>
        <th width="11%"style="text-align:center;">
				<img  id="cheques_estatus_caja" src="imagenes/iconos/check_mark.png" style="display:none" /> 7		</th>
        <th width="20%"style="text-align:center;">
				<img id="cheques_estatus_pagado" src="imagenes/iconos/cheque.png" style="display:none" />8	</th>
 		 <th width="20%"style="text-align:center;">
				<img id="cheques_estatus_archivado" src="imagenes/iconos/check_mark.png" style="display:none" /> 9		</th>
	     </tr>
	<tr>	
		
			<th width="12%"style="text-align:center;">	  	
			  <p><img   src="imagenes/iconos/tesoreria.png"  /></br>
		      Tesoreria</p>
			  <p>		
			    <input type="text" name="cheque_estatus_tesoreria_fecha" id="cheque_estatus_tesoreria_fecha" readonly="readonly"  maxlength="10" size="10"/>	
	        </p></th>
