...
class PDF extends PDF_Code128
	{
		...
		{	
			...
			$this->Cell(0,10,'RELACIÓN CHEQUES HISTÓRICO/BENEFICIARIO/BANCO',0,0,'C');
            $this->ln(10);
			$this->Cell(0,5,"BENEFICIARIO:".strtoupper($n_proveedor),0,0,'C');	
			$this->Ln();
			$this->Cell(0,5,"BANCO:".strtoupper($banco),0,0,'C');	
			$this->Ln();
			...
			$this->SetTextColor(0);
			$this->Cell(55,6,		     'Nº DE CUENTA',			0,0,'L',1);
			$this->Cell(40,6,		     'Nº DE CHEQUERA',			0,0,'L',1);
			$this->Cell(45,6,		     'Nº DE CHEQUE',			0,0,'L',1);
			$this->Cell(60,6,		     'ESTATUS',			0,0,'L',1);
			$this->Cell(35,6,		     'MONTO',			0,0,'L',1);
			$this->Cell(35,6,		     'PREPARADOR',			0,0,'L',1);
			$this->Ln(6);
				...
				//$n_cheque=$row->fields("numero_cheque");
					...
					$cheque=$row->fields("numero_cheque");
							...
							else
							{
								...
								if($coordenada>=16)
								{
								$coordenada=0;$nombre_usuario=$usuario_sig;	
