...
{ 
	...
	class PDF extends PDF_Code128
	{
		...
		{	global $banco_nombre;
			global $fecha;	
			global $desde;	global $hasta;global $proveedor;global $nombre_usuario;global $cuenta;
			...
			$this->Cell(0,10,'Reimpresión de Cheques Usuario/Beneficiario/Banco',0,0,'C');
			$this->ln(5);
			$this->Cell(0,10,"USUARIO:".strtoupper($nombre_usuario),0,0,'C');
			$this->ln(5);
			$this->Cell(0,10,"PROVEEDOR:".strtoupper($proveedor),0,0,'C');
            $this->ln(5);
			$this->Cell(0,10,"BANCO:".$banco_nombre." ".$cuenta,0,0,'C');
            $this->ln(5);
			...
			$this->SetTextColor(0);
			$this->Cell(50,6,		     'CHEQUE REIMPRESO ',	0,0,'L',1);
			$this->Cell(50,6,		     'BANCO ',	0,0,'L',1);
			$this->Cell(50,6,		     'CUENTA ',	0,0,'L',1);
	...
	while (!$row->EOF) 
	{
		...
		$total_general=$total_general+$row->fields("monto_cheque");	
			...
			$pdf->Cell(50,6,		     $n_cheque_reimpreso,0,0,'L',0);
			$pdf->Cell(50,6,		     substr($banco_reimpreso,0,18),0,0,'L',0);
			$pdf->Cell(50,6,		     $row->fields("cuenta_reimpreso"),	0,0,'L',0);
			$pdf->Cell(50,6,		     $n_cheque,	0,0,'L',0);
			$pdf->Cell(60,6,		     number_format($monto,2,',','.'),	0,0,'C',0);
