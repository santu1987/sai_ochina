...
<td align="center"><strong>Beneficiario:</strong>: </td>                  
	           <input type="text" id="tesoreria_pr_proveedor_consulta_cheques_m" maxlength="30"  
			   jVal="{valid:/^[a-zA-Z áéíóúÁÉÍÓÚñ.]{1,60}$/}"
				jValKey="{valid:/[a-zA-Z áéíóúÁÉÍÓÚñ.]/}"/>	
<td align="center"><strong>C&oacute;digo:</strong>: </td>                  
	           <input type="text" id="tesoreria_pr_proveedor_codigo_consulta_cheques_m" maxlength="30"  
