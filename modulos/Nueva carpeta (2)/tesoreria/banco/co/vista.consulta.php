...
({ 
	...
	url:'modulos/tesoreria/banco/co/sql.consulta.php?nd='+new Date().getTime(),
	datatype: "json",
...
{ 
	...
	*/jQuery("#list_consulta_tesoreria_banco").setGridParam({url:"modulos/tesoreria/banco/co/sql.consulta.php?tesoreria_busqueda_banco="+tesoreria_busqueda_banco,page:1}).trigger("reloadGrid"); 
} 
