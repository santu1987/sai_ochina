...
{ 
	...
	class PDF extends FPDF
	{
		...
		{	global $proveedor;	
			...
			$this->Cell(0,10,'RELACIÓN PROVEEDOR PRECHEQUES REGISTRADOS',0,0,'C');
            $this->ln();
			...
			$this->Cell(50,6,		     'USUARIO EMISOR',			0,0,'C',1);
			$this->Ln(6);
...
//-------------------------------------------------------------------------------------------------------------------------
			...
			$pdf->Cell(50,6,substr($row->fields("concepto"),0,50),	0,0,'L',1);
