...
{
	$where.=" AND movimientos_contables.fecha_comprobante between '$desde' AND '$hasta'";
}
if(isset($_GET['aux']))
{
	$aux=$_GET['aux'];
...
$sql_cuenta="
			...
			$where
			order by
									movimientos_contables.fecha_comprobante  desc

		";/*,movimientos_contables.numero_comprobante,cuenta_contable_contabilidad.cuenta_contable	*/
	...
	//************************************************************************
				class PDF extends PDF_Code128
				{
					...
					{	
						...
						$this->Cell(10,6,		     'REFERENCIA',			0,0,'L',1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
	...
	$mes2=$mes2-1;
				...
				$pdf->Cell(80,6,			"SALDO INICIAL"."   ".number_format($saldo_total,2,',','.'),0,0,'L',1);
				$pdf->Ln();
	...
	if(($row->fields("codigo")=='A   ')||($row->fields("codigo")=='G   '))
		...
		$pdf->Cell(13,6,		    $row->fields("fecha_comprobante"),			0,0,'L',1);
