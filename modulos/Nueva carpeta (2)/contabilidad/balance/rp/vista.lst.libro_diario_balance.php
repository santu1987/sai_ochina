...
$acu_debe=$acu_debe+$debe_total;
$acu_haber=$acu_haber+$haber_total;
	...
	$pdf->SetTextColor(0);
	$pdf->Ln(6);
	$pdf->Cell(98,6,"TOTAL MOVIMIENTO DEL MES",				0,0,'L',1);
	$pdf->SetFillColor(255) ;
	$pdf->SetTextColor(0);
	$pdf->Cell(20,6,				number_format($acu_debe,2,',','.'),	0,0,'R',1);
	$pdf->Cell(38,6,				number_format($acu_haber,2,',','.'),				0,0,'R',1);
