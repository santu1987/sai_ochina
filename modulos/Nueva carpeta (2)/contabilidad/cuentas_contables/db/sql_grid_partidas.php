...
$busq_cuenta=$_POST[contabilidad_cuentas_contables_db_cuenta_presupuesto];
if($busq_cuenta!='')
{	
	if($busq_cuenta!='')
	{	
...
if (!$row->EOF) 
{
	$responce=$row->fields("id_clasi_presu")."*".$row->fields("cuenta")."*".$row->fields("denominacion")."*".$row->fields("tipo_cuenta");
}else
$responce="vacio";
