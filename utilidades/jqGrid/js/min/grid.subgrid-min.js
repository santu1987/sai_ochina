...
var td,res,_id,pID;td=document.createElement("td");$(td,t).html("<img src='"+ts.p.imgpath+"plus.gif'/>").toggle(function(e){pID=$("table:first",ts.grid.bDiv).attr("id");res=$(this).parent();var atd=pos==1?'<td></td>':'';_id=$(res).attr("id");var nhc=0;$.each(ts.p.colModel,function(i,v){
...
$(this).html("<img src='"+ts.p.imgpath+"minus.gif'/>");},function(e){
